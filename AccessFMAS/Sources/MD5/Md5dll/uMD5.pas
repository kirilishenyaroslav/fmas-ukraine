...
function GetMD5(Buffer: Pointer; BufSize: Integer): shortstring; stdcall;
function StrMD5(Buffer : shortString): shortstring; stdcall;
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function GetMD5(Buffer: Pointer; BufSize: Integer): shortstring;
var
    I          : Integer;
...
function StrMD5(Buffer : shortString): shortstring;
var l:Integer;
    P:Pointer;
begin
     Result := GetMD5(addr(Buffer[1]),Length(Buffer));
end;
