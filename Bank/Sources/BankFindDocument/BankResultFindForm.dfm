object fmBankResultFindForm: TfmBankResultFindForm
  Left = 614
  Top = 230
  Width = 792
  Height = 616
  Caption = 'fmBankResultFindForm'
  Color = clBtnFace
  ...
  object pFIBDataSet1: TpFIBDataSet
    ...
    SelectSQL.Strings = (
      'SELECT * FROM BANK_SELECT_FIND_ALL(1)')
  ...
  object pFIBDatabase1: TpFIBDatabase
    DBName = 'D:\DB\DONGUET\FULL_DB.IB'
    DBParams.Strings = (
      'lc_ctype=WIN1251'
      'password=masterkey'
      'user_name=SYSDBA'
  ...
  object Report: TfrxReport
    ...
    ReportOptions.LastChange = 41472.637864236110000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'var s_1, s_2: double;'
      ...
      '  begin'
      '     s_1 := s_1 + <frxDBDataset2."SUMMA_PRIH">;'
      '     s_2 := s_2 + <frxDBDataset2."SUMMA_RASH">;'
      '  end'
      'end;'
      ''
      'begin'
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo18: TfrxMemoView
          ...
          HAlign = haRight
          Memo.Strings = (
            '[frxDBDataset2."SUMMA_P"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo21: TfrxMemoView
          Left = 626.677180000000000000
          ...
          HAlign = haRight
          Memo.Strings = (
            '[frxDBDataset2."SUMMA_R"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo28: TfrxMemoView
          Left = 280.440827720000000000
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.Strings = (
            '[frxDBDataset2."SCH_NUMBER"] [frxDBDataset2."TITLE_SCH"]'
            
              #1088#1077#1075'. '#1085#1086#1084#1077#1088' [frxDBDataset2."REG_DOG"] ([frxDBDataset2."SMETA_KOD"' +
              ']/[frxDBDataset2."razd_num"]/[frxDBDataset2."STATE_NUM"]/[frxDBD' +
              'ataset2."KEKV_KOD"])')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo29: TfrxMemoView
          Width = 280.440827720000000000
          Height = 20.000000000000000000
          StretchMode = smMaxHeight
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object Memo25: TfrxMemoView
          ...
          HAlign = haRight
          Memo.Strings = (
            '[SUM(<frxDBDataset2."SUMMA_P">,MasterData1)]')
          ParentFont = False
        end
        object Memo26: TfrxMemoView
          Left = 622.897650000000000000
          Width = 96.000000000000000000
          Height = 20.000000000000000000
          DisplayFormat.DecimalSeparator = ','
          DisplayFormat.FormatStr = '%2.2n'
          ...
          HAlign = haRight
          Memo.Strings = (
            '[SUM(<frxDBDataset2."SUMMA_R">,MasterData1)]')
          ParentFont = False
        end
      end
      object GroupHeader1: TfrxGroupHeader
        ...
        object Memo19: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.Strings = (
            '[frxDBDataset2."NAME_CUST"]('#1056'/'#1089'-[frxDBDataset2."NUM_RAS_CUST"])'
            '[frxDBDataset2."NOTE_DOC"]')
          ParentFont = False
          VAlign = vaCenter
        end
      ...
      object GroupFooter1: TfrxGroupFooter
        ...
        object Memo32: TfrxMemoView
          ...
          HAlign = haRight
          Memo.Strings = (
            #1089#1091#1084#1072' '#1079#1072' '#1076#1086#1082#1091#1084#1077#1085#1090#1086#1084':')
          ParentFont = False
        end
      end
    end
  ...
  object pFIBDataSet2: TpFIBDataSet
    ...
    object pFIBDataSet2SMETA_KOD: TFIBIntegerField
      FieldName = 'SMETA_KOD'
    end
    object pFIBDataSet2RAZD_NUM: TFIBIntegerField
      FieldName = 'RAZD_NUM'
    end
    object pFIBDataSet2STATE_NUM: TFIBIntegerField
      FieldName = 'STATE_NUM'
    end
    object pFIBDataSet2KEKV_KOD: TFIBIntegerField
      FieldName = 'KEKV_KOD'
    end
    object pFIBDataSet2REG_DOG: TFIBStringField
      FieldName = 'REG_DOG'
      Size = 12
      EmptyStrToNull = True
    end
