...
uses
  ...
  cxCurrencyEdit, cxTextEdit, Placemnt;
...
begin
    ...
    T.cxLabel14.Caption := '№ '+ m.RxMemoryDataSaveAll.FieldByName('RxMemoryDataSaveAllFieldNumDog').AsString + ' (рег. номер '+m.RxMemoryDataSaveAll.FieldByName('RxMemoryDataSaveAllFieldRegNum').Value+')'+' від '+m.RxMemoryDataSaveAll.FieldByName('RxMemoryDataSaveAllFielddateDog').AsString;
...
procedure TfrmExpertSchSys.FormCreate(Sender: TObject);
begin
     FormStorage1.RestoreFormPlacement;
end;

procedure TfrmExpertSchSys.FormClose(Sender: TObject;
