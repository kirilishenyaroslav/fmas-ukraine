...
constructor TfmBankNichAdd.Create(Aowner:TComponent; DBHANDLE : TpFIBDatabase; id_us : Integer; date_d : TDateTime; sum_doc, sum_r : string);
begin
...
procedure TfmBankNichAdd.cxOkButtonClick(Sender: TObject);
var
...
procedure TfmBankNichAdd.cxSmEditPropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
var
  Add,Res : Variant;
begin
...
procedure TfmBankNichAdd.cxMonthEditPropertiesChange(Sender: TObject);
begin
...
procedure TfmBankNichAdd.cxRazdEditPropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
var
  Res : Variant;
  ResCount, i : Integer;
...
procedure TfmBankNichAdd.FormShow(Sender: TObject);
begin
...
function TfmBankNichAdd.SelectDogovor(all_summa : double) : boolean;
var
    inputDog : TDogInput;
    res   : TDogResult;
begin
...
procedure TfmBankNichAdd.cxDogEditPropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
      SelectDogovor(0);
end;

procedure TfmBankNichAdd.FormCreate(Sender: TObject);
var
      myDate : TDateTime;
      month, myDay: Word;
      GetNameSP:TPfibStoredProc;
...
procedure TfmBankNichAdd.cxExitButtonClick(Sender: TObject);
begin
