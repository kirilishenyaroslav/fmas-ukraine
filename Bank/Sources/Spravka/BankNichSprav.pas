...
uses
  ...
  cxCalendar, StdCtrls, ExtCtrls, cxMemo, dxBar, dxBarExtItems, BankNichAddSprav, pFIBDatabase,
...
type
  ...
  public
    { Public declarations }
    fltForm1 : TfmBankNichAddSprav;
    fmBankNich: TfmBankNichSprav;
    id_us : Integer;
    id_dog : Int64;
    date_d : TDateTime;
    n_dog, d_dog, reg_dog, name_cust, summa, summa_raz: string;
    constructor Create(AOwner: TComponent; DBHANDLE : TpFIBDatabase; date_doc: TDate; num_doc, sum_doc, note: string; id_user : Integer; name_cust : string; prih : Integer); reintroduce; overload;
  end;
...
constructor TfmBankNichSprav.Create(AOwner: TComponent; DBHANDLE : TpFIBDatabase; date_doc: TDate; num_doc, sum_doc, note: string; id_user : Integer; name_cust : string; prih : Integer);
begin
...
procedure TfmBankNichSprav.FormCreate(Sender: TObject);
begin
   fmBankNich.Caption:='Фінансування НІЧ';
   fmBankNich.BorderStyle:=bsSingle;
end;

procedure TfmBankNichSprav.cxParamGridTableView1FocusedRecordChanged(
  Sender: TcxCustomGridTableView; APrevFocusedRecord,
  AFocusedRecord: TcxCustomGridRecord;
  ANewItemRecordFocusingChanged: Boolean);
var
...
procedure TfmBankNichSprav.cxButtonCancelClick(Sender: TObject);
begin
  ModalResult:=mrCancel;
end;

procedure TfmBankNichSprav.cxButtonOkClick(Sender: TObject);
var
  s : Currency;
  i : Integer;
begin
...
procedure TfmBankNichSprav.cxButtonAddClick(Sender: TObject);
var
  month : Integer;
  month_edit : string;
  year : string;
...
begin
   ...
   fltForm1 := TfmBankNichAddSprav.Create(self, DB, id_us, date_d, summa, summa_raz);
...
procedure TfmBankNichSprav.cxButtonEditClick(Sender: TObject);
var
  month : Integer;
  month_edit : string;
  year : string;
...
procedure TfmBankNichSprav.cxButtonDelClick(Sender: TObject);
var
