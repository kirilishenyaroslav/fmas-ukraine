...
resourcestring
  ...
  PUB_ACTION_ADD_CONST          ='Додати';
  PUB_ACTION_DELETE_CONST       ='Видалити';
  PUB_ACTION_UPDATE_CONST       ='Змінити';
  PUB_ACTION_REFRESH_CONST      ='Обновити';
  PUB_ACTION_CLOSE_CONST        ='Закрити';
  PUB_ACTION_PRINT_CONST        ='Друк';
  PUB_ACTION_HELP_CONST         ='Допомога';
  PUB_ACTION_CHOOSE_CONST       ='Выбрати';
  PUB_ACTION_FILTER_CONST       ='Фільтр';
  PUB_ACTION_ANALIZE_CONST      ='Аналіз';
  PUB_ACTION_SET_CONST          ='Встановити';

  PUB_BUTTON_OK_CONST           ='Прийняти';
  PUB_BUTTON_CANCEL_CONST       ='Відмінити';
  PUB_BUTTON_YES_CONST          ='Так';
  PUB_BUTTON_NO_CONST           ='Ні';
  PUB_BUTTON_CHOOSE_CONST       ='Вибрати';

  PUB_MESSAGE_WARNING           ='Увага!';
  PUB_MESSAGE_ERROR             ='Помилка!';
  PUB_MESSAGE_HINT              ='Зауваження!';
  PUB_UNDER_CONSTRUCTION_CONST  ='На стадії розробки';

  PUB_STATE_ON_DATE_CONST       ='Станом на ';
  PUB_KEKV_SPR                  ='Довідник кодів затрат';
  PUB_GROUP_CONST               ='Панель для группування';

  PUB_COLTITL_PROP_TITLE        ='Назва властивості';
  PUB_COLTITL_DATE_BEG          ='Дата начала';
  PUB_COLTITL_DATE_END          ='Дата закінчення';
  PUB_COLTITL_GROUP             ='Група';
  PUB_COLTITL_SCH_TITLE         ='Рахунок';
  PUB_COLTITL_ID_PROP           ='Ид.властивості';
  PUB_COLTITL_ID_SCH            ='Ид.рахунка.';
  PUB_COLTITL_SCH_END           ='Початок функціонування рахунку';
  PUB_COLTITL_SCH_BEG           ='закінчення функціонування рахунку.';

  PUB_COLTITL_PR_NUM            ='Номер';
  PUB_COLTITL_PR_TIT            ='Властивість';
  PUB_COLTITL_PR_VAL            ='Значення';
  PUB_COLTITL_PR_GRP            ='Група';
  ...
  BU_ErrorCaption               ='Увага помилка!';
  BU_WarningCaption             ='Увага!';
  BU_PingError                  ='Сервер не відповідає на TCP/IP запити. Можливо він виключений або в мережі виникли помилки. Зверніться до системного адміністратора.';
  BU_OpenConfigError            ='Помилка при доступі до файла ініціалізації. Зверніться до системного адміністратора.';
  BU_OpenDBError                ='Помилка при підключенні до БД. Зверніться до системного адміністратора.';
  BU_CountLevelError            ='Рівень аналітики рахунків баллансу перевищено.';
  BU_TitleError                 ='Немає найменування';
  BU_TypeError                  ='Не заданний атрибут рахунку';
  BU_KodError                   ='Не заданний код рахунку';
  BU_DeleteConfirmation         ='Ви дійсно бажаєте видалити цей запис?';
  BU_HasChildError              ='Не можна видалити рахунок, бо є дочірні рахунки';
  BU_DistanceError              ='Помилкова побудова ієрархії рахунків';
  BU_PropError                  ='Помилка при роботі з властивостями';
  BU_OperError                  ='Помилка при роботі з кореспонденцією';
  BU_PropDelError               ='Не можна видалити властивість бо вона ще не встановлено';
  BU_DateError                  ='Помилка при роботі з періодами';
  BU_MinDateError               ='Дата початку періоду не може бути меншою за дату головної книги';
  BU_StError                    ='Стаття не може ссилатися сама на себе';
  BU_ChooseStError              ='Необхідно вибрати статтю';
  BU_ChooseRzError              ='Необхідно вибрати розділ';
  BU_Yes_const                  ='Так';
  BU_No_const                   ='Ні';
  BU_OperPropError              ='Заданні не всі властивості операції';
  BU_HieracChooseError          ='Цей запис не можна вибрати';
  BU_Month_01                   ='січень';
  BU_Month_02                   ='лютий';
  BU_Month_03                   ='березень';
  BU_Month_04                   ='квітень';
  BU_Month_05                   ='травень';
  BU_Month_06                   ='червень';
  BU_Month_07                   ='липень';
  BU_Month_08                   ='серпень';
  BU_Month_09                   ='вересень';
  BU_Month_10                   ='жовтень';
  BU_Month_11                   ='листопад';
  BU_Month_12                   ='грудень';

  BU_CHECK_OPER_ID_EQUALITY_ERROR='Рахунок не може кореспондуватися сам із собою';
  BU_LoadError                  ='Помилка завантажження бібліотеки';
  BU_KEKV_TITLE                 ='Економічний клавифікатор видатків';
  BU_CROSSERROR                 ='Періоди функціонування рахунків не перетинаються';
  BU_OPER_TITLE                 ='Реєстр кореспонденції рахунків';
  BU_CR_TITLE                   ='Рахунки, які кореспондуються в кредиті';
  BU_DB_TITLE                   ='Рахунки, які кореспондуються в дебеті';
  BU_SCH_FOR_COR                ='Рахунок для кореспонденції';
  IS_KR_CR_PROV                 ='Створює в кредиті проводку';
  IS_DB_CR_PROV                 ='Створює в дебеті проводку';
  IS_KR_CR_DOC                  ='Створює в кредиті документ';
  IS_DB_CR_DOC                  ='Створює в дебеті документ';
  BU_KEKV_INFO_WORK             ='Робота з інформацією по КЕКВ';
  BU_KEKV_CODE                  ='Код КЕКВ';
  BU_KEKV_TITLE_EDIT            ='Найменування КЕКВ';
  BU_OPER_TITLE_EDIT            ='Робота з інформацією по операції';
  BU_OPER_CRINFO_PROP           ='Властивості операції в кредиті';
  BU_OPER_DBINFO_PROP           ='Властивості операції в дебеті';
  BU_SMSpr_title                ='Довідник кошторісів';
  BU_DelPeriod                  ='Відалити період функціонування кошторису';
  BU_EnableError                ='Кошторис не використовується';
  BU_HASCHILDSTRUERROR          ='Ви не можете змінити структуру кошториса, який вже функціонує';
  BU_DELHASCHILDSTRUERROR       ='Ви не можете змінити період фунціювання кошториса, який вже функціонує';
  BU_SmError                    ='Необхідно вибрати кошторис';
  BU_RzError                    ='Необхідно вибрати розділ';
  BU_StCHooseError              ='Необхідно вибрати статтю';
  BU_PROP_BY_SCH                ='Властивості рахунку';
  BU_PROP_BY_OPER               ='Властивості операції';
  BU_KREDIT                     ='Кредит';
  BU_DEBET                      ='Дебет';
  BU_PROP_BY_RZST               ='Властивості розділів/статей';
  BU_PROP_BY_KEKV               ='Властивості КЕКВ';
  BU_PROP_BY_SMETA              ='Властивоситі кошторисів';
