unit UCardGetFactRasxConfigure;
...
type
  TfrmFactrasxConfigureFrm = class(TForm)
...
{$R *.dfm}
constructor TfrmFactrasxConfigureFrm.Create(AOwner: TComponent);
var i:Integer;
begin
...
procedure TfrmFactrasxConfigureFrm.FormClose(Sender: TObject;
...
procedure TfrmFactrasxConfigureFrm.cxButton2Click(Sender: TObject);
begin
     Close;
end;


procedure TfrmFactrasxConfigureFrm.cxButton1Click(Sender: TObject);
begin
...
procedure TfrmFactrasxConfigureFrm.cxButtonEdit3PropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
var Res:Variant;
    GetInfoDS:TpFibDataSet;
begin
     Res:=GlobalSpr.GetSmPKV(self,
                             TfrmGetFactRsx(Owner).WorkDatabase.Handle,
                             fsNormal,
                             id_user);
     if (Res<>Variant(0))
     then begin
...
procedure TfrmFactrasxConfigureFrm.cxButtonEdit2PropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
var Res:Variant;
    GetInfoDS:TpFibDataSet;
begin
...
procedure TfrmFactrasxConfigureFrm.FormShow(Sender: TObject);
begin
      cxButtonEdit3.Text:=pkv_kod+' "'+pkv_title+'"';
      cxButtonEdit2.Text:=tfin_kod+' "'+tfin_title+'"';
end;
