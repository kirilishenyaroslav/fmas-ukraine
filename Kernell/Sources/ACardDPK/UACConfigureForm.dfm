object frmGetConfInfo: TfrmGetConfInfo
  ...
  object Panel2: TPanel
    ...
    object cbWithDates: TcxCheckBox
      Left = 144
      Top = 162
      Width = 497
      Height = 24
      Properties.DisplayUnchecked = 'False'
      Properties.Caption = #1044#1077#1090#1072#1083#1110#1079#1091#1074#1072#1090#1080' '#1076#1086' '#1076#1072#1090#1080' '#1076#1086#1082#1091#1084#1077#1085#1090#1110#1074
      State = cbsChecked
      TabOrder = 8
    end
    object ThruFR: TcxRadioGroup
      Left = 148
      Top = 212
      Width = 504
      Height = 38
      ...
      Properties.Items = <
        item
          Caption = #1060#1086#1088#1084' '#1086#1073#1083#1110#1082#1091
        end
        item
          Caption = #1056#1077#1075#1110#1089#1090#1088#1110#1074' '#1086#1073#1083#1110#1082#1091
        end>
      Style.BorderStyle = ebs3D
      TabOrder = 9
      Caption = #1060#1072#1082#1090#1080#1095#1085#1110' '#1074#1080#1076#1072#1090#1082#1080' '#1088#1086#1079#1096#1080#1092#1088#1091#1074#1072#1090#1080' '#1091' '#1088#1086#1079#1088#1110#1079#1110
    end
    object Only_ch_period: TcxCheckBox
      Left = 144
      Top = 183
      Width = 505
      Height = 24
      Properties.DisplayUnchecked = 'False'
      Properties.Caption = 
        #1057#1092#1086#1088#1084#1091#1074#1072#1090#1080' '#1090#1110#1083#1100#1082#1080' '#1079#1072' '#1074#1080#1073#1088#1072#1085#1080#1081' '#1087#1077#1088#1110#1086#1076'('#1073#1077#1079' '#1085#1072#1082#1086#1087#1080#1095#1077#1085#1085#1103' '#1079' '#1087#1086#1095#1072#1090#1082#1091' '#1088 +
        #1086#1082#1091')'
      TabOrder = 10
      Visible = False
    end
