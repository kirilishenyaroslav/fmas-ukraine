object frmSprProvs: TfrmSprProvs
  Left = 207
  Top = 166
  Width = 758
  Height = 495
  Caption = #1056#1086#1073#1086#1090#1072' '#1079' '#1076#1086#1082#1091#1084#1077#1085#1090#1072#1084#1080' '#1089#1080#1089#1090#1077#1084#1080' '
  Color = clBtnFace
  ...
  object cxGrid1: TcxGrid
    ...
    object DocsView: TcxGridDBBandedTableView
      ...
      Bands = <
        item
          Caption = #1056#1077#1075#1110#1089#1090#1088#1072#1094#1110#1086#1085#1085#1110' '#1072#1090#1088#1080#1073#1091#1090#1080' '#1076#1086#1082#1091#1084#1077#1085#1090#1072
          FixedKind = fkLeft
          Styles.Header = cxStyle11
          Width = 419
        end
        item
          Caption = #1041#1091#1093#1075#1072#1083#1090#1077#1088#1089#1100#1082#1110' '#1072#1090#1088#1080#1073#1091#1090#1080' '#1076#1086#1082#1091#1084#1077#1085#1090#1072
          Styles.Header = cxStyle11
          Width = 1170
        end>
      object DocsViewDBBandedColumn1: TcxGridDBBandedColumn
      ...
      object DocsViewDBBandedColumn2: TcxGridDBBandedColumn
      ...
      object DocsViewDBBandedColumn3: TcxGridDBBandedColumn
        ...
        Position.ColIndex = 1
        Position.RowIndex = 0
        DataBinding.FieldName = 'TYPE_DOC_TITLE'
      end
      object DocsViewDBBandedColumn4: TcxGridDBBandedColumn
      ...
      object DocsViewDBBandedColumn5: TcxGridDBBandedColumn
      ...
      object DocsViewDBBandedColumn6: TcxGridDBBandedColumn
      ...
      object DocsViewDBBandedColumn7: TcxGridDBBandedColumn
      ...
      object DocsViewDBBandedColumn8: TcxGridDBBandedColumn
      ...
      object DocsViewDBBandedColumn9: TcxGridDBBandedColumn
      ...
      object DocsViewDBBandedColumn10: TcxGridDBBandedColumn
      ...
      object DocsViewDBBandedColumn11: TcxGridDBBandedColumn
      ...
      object DocsViewDBBandedColumn12: TcxGridDBBandedColumn
  ...
  object Panel1: TPanel
    ...
    object CheckGroupPanel: TcxCheckBox
      ...
      Height = 24
      Properties.DisplayUnchecked = 'False'
      Properties.Caption = #1055#1072#1085#1077#1083#1100' '#1076#1083#1103' '#1075#1088#1091#1087#1087#1091#1074#1072#1085#1085#1103
      TabOrder = 0
      OnClick = CheckGroupPanelClick
    end
    object cxCheckBox1: TcxCheckBox
      ...
      Properties.Caption = #1050#1086#1084#1077#1085#1090#1072#1088
      State = cbsChecked
      TabOrder = 1
    end
  end
  object Panel2: TPanel
    ...
    object Panel3: TPanel
      ...
      object Label3: TLabel
        ...
        Width = 84
        Height = 16
        Caption = #1050#1086#1085#1090#1088#1072#1075#1077#1085#1090#1072
      end
      object Label4: TLabel
        ...
        Height = 33
        AutoSize = False
        Caption = #1050#1086#1088#1080#1089#1090#1091#1074#1072#1095', '#1103#1082#1080#1081' '#1086#1089#1090#1072#1085#1085#1110#1081' '#1087#1088#1072#1094#1102#1074#1072#1074' '#1079' '#1076#1086#1082#1091#1084#1077#1085#1090#1086#1084
        Layout = tlCenter
        WordWrap = True
      end
      object cxDBTextEdit1: TcxDBTextEdit
        ...
        Width = 241
        Height = 24
        DataBinding.DataField = 'ACC_NATIVE_TEXT'
        DataBinding.DataSource = DocsDataSource
        Style.Color = clInfoBk
        TabOrder = 0
      end
      object cxDBTextEdit2: TcxDBTextEdit
        ...
        Width = 241
        Height = 24
        DataBinding.DataField = 'ACC_TEXT'
        DataBinding.DataSource = DocsDataSource
        Style.Color = clInfoBk
        TabOrder = 1
      end
      object cxDBMemo2: TcxDBMemo
        ...
        Width = 201
        Height = 35
        DataBinding.DataField = 'USER_FIO'
        DataBinding.DataSource = DocsDataSource
        ParentFont = False
        Style.Color = clInfoBk
        TabOrder = 2
  ...
  object PopupMenu: TPopupMenu
    ...
    object N8: TMenuItem
      Caption = #1047#1072#1074#1077#1088#1096#1080#1090#1100' '#1088#1072#1073#1086#1090#1091' '#1089' '#1088#1077#1077#1089#1090#1088#1086#1084
      ImageIndex = 6
      ShortCut = 16499
      OnClick = N8Click
    end
  ...
  object AddPopupMenu: TPopupMenu
    ...
    Top = 256
    object N9: TMenuItem
      Caption = #1044#1086#1076#1072#1090#1080' '#1076#1086#1082#1091#1084#1077#1085#1090' '#1075#1086#1083#1086#1074#1085#1086#1111' '#1082#1085#1080#1075#1080
      ImageIndex = 1
    end
    object N10: TMenuItem
      Caption = #1044#1086#1076#1072#1090#1080' '#1076#1086#1074#1110#1076#1082#1091' '#1079' '#1110#1085#1096#1086#1111' '#1092#1086#1088#1084#1080' '#1086#1073#1083#1110#1082#1091
      ImageIndex = 1
    end
  end
  ...
  object PopupMenu1: TPopupMenu
    ...
    object N12: TMenuItem
      Caption = #1057#1090#1086#1088#1085#1091#1074#1072#1090#1080' '#1076#1086#1082#1091#1084#1077#1085#1090#1091' '#1091' '#1084#1072#1081#1073#1091#1090#1085#1110#1111#1093' '#1087#1077#1088#1110#1086#1076#1072#1093
      ImageIndex = 2
      OnClick = N12Click
    end
  end
  object PopupMenu2: TPopupMenu
    ...
    object N14: TMenuItem
      Caption = #1050#1083#1086#1085#1091#1074#1072#1090#1080' '#1076#1086#1082#1091#1084#1077#1085#1090' '#1091' '#1087#1077#1088#1110#1086#1076#1110
      ImageIndex = 1
      OnClick = N14Click
    end
  end
