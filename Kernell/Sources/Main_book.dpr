...
uses
  ...
  GlobalSpr,
  Check_User,
  splash_form in '..\..\MainBook\Sources\splash_form.pas' {splash},
  dmMain_Book in '..\..\MainBook\Sources\dmMain_Book.pas' {dmMain: TDataModule},
  MainForm in '..\..\MainBook\Sources\MainForm.pas' {frmMainForm},
  Win2DosImprt in '..\..\MainBook\Sources\Win2DosImprt.pas' {frmDosImport},
  UGetFormUch in '..\..\MainBook\Sources\UGetFormUch.pas' {ffmGetSystem},
  About in '..\..\MainBook\Sources\About.pas' {AboutBox};
