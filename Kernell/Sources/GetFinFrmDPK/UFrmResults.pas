...
begin
     ...
     then begin
               ...
               self.Caption:='Фінансовий звіт ('+TfrmFinForms(Owner).FormsDataSet.FieldByName('FORM_TITLE').AsString+')';
...
begin
     ...
     Memo.Text:=FinanceFormLevel.Caption+' за перiод '+DateToStr(self.DateBeg)+' - '+DateToStr(self.DateEnd);
