...
const MAIN_FORM_SMT_TITLE      :array[1..2] of String = ('Бюджет','Бюджет');
...
const MAIN_FORM_CLOSE_BUTTON   :array[1..2] of String = ('Завершить работу с мастером','Завершити роботу з мастером');
...
const CHOOSE_OBJ_CH_TITLE_SM1  :array[1..2] of String = ('Необходимо выбрать бюджет','Необхідно вибрати бюджет');
const CHOOSE_OBJ_CH_TITLE_SM2  :array[1..2] of String = ('Необходимо выбрать бюджет для дебетовой части проводки','Необхідно вибрати бюджет для дебету');
const CHOOSE_OBJ_CH_TITLE_SM3  :array[1..2] of String = ('Необходимо выбрать бюджет для кредитовой части проводки','Необхідно вибрати бюджет для кредіту');
...
const FACED_FORM_CLOSE_BUTTON  :array[1..2] of String = ('Завершить работу','Завершити роботу');
