...
constructor TFPeopleCards.Create(AOwner:TComponent;Db_Handle:TISC_DB_HANDLE);
var i:byte;
    reg:TRegistry;
    Key:string;
begin
...
procedure TFPeopleCards.ExitBtnClick(Sender: TObject);
begin
  ModalResult:=mrCancel;
end;

procedure TFPeopleCards.GridDBTableView1FocusedRecordChanged(
  Sender: TcxCustomGridTableView; APrevFocusedRecord,
  AFocusedRecord: TcxCustomGridRecord;
  ANewItemRecordFocusingChanged: Boolean);
begin
...
procedure TFPeopleCards.RefreshBtnClick(Sender: TObject);
...
procedure TFPeopleCards.FormResize(Sender: TObject);
var i:byte;
begin
for i:=0 to dxStatusBar1.Panels.Count-1 do
   dxStatusBar1.Panels[i].Width := dxStatusBar1.Width div dxStatusBar1.Panels.Count;
...
procedure TFPeopleCards.GridDBTableView1KeyPress(Sender: TObject;
  var Key: Char);
begin
{If (Key in ['0'..'9']) then
  begin
...
procedure TFPeopleCards.SelectBtnClick(Sender: TObject);
begin
...
procedure TFPeopleCards.cxTextEdit1PropertiesChange(Sender: TObject);
begin
...
procedure TFPeopleCards.SearchEditKeyPress(Sender: TObject;
  var Key: Char);
begin
  if(key in ['0'..'9'])then
    SearchType:=true
...
procedure TFPeopleCards.FormShow(Sender: TObject);
begin
 SearchEdit.SetFocus;
end;

procedure TFPeopleCards.FormClose(Sender: TObject;
