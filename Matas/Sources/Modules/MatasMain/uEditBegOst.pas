...
var
  EditBegOstForm: TEditBegOstForm;
...
procedure TEditBegOstForm.OkButtonClick(Sender: TObject);
begin
...
procedure TEditBegOstForm.FormCreate(Sender: TObject);
begin
...
procedure TEditBegOstForm.cxNamePropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
var
  Res : Variant;
begin
...
procedure TEditBegOstForm.cxNameKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TEditBegOstForm.cxKolMatExit(Sender: TObject);
begin
 cxSumma.EditValue:=cxKolMat.EditValue*cxPrice.EditValue;
end;

procedure TEditBegOstForm.cxKolMatKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
 if Key=VK_RETURN then
  cxSumma.SetFocus;
...
procedure TEditBegOstForm.cxSummaExit(Sender: TObject);
begin
 if cxKolMat.Value<>0 then
  cxPrice.EditValue:=cxSumma.EditValue/cxKolMat.EditValue;
end;

procedure TEditBegOstForm.cxSummaKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
 if Key=VK_RETURN then
  cxNameSch.SetFocus;
...
procedure TEditBegOstForm.cxPriceExit(Sender: TObject);
begin
 cxSumma.EditValue:=cxKolMat.EditValue*cxPrice.EditValue;
end;

procedure TEditBegOstForm.cxPriceKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
 if Key=VK_RETURN then
  OkButton.SetFocus;
...
procedure TEditBegOstForm.cxNameSchPropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
var
  Res : Variant;
begin
...
procedure TEditBegOstForm.cxNameSchExit(Sender: TObject);
var
  Res : Variant;
begin
...
procedure TEditBegOstForm.cxNameSchKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
 if Key=VK_RETURN then
  OkButton.SetFocus;
...
procedure TEditBegOstForm.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
 if Key=VK_RETURN then
  Key:=VK_TAB;
...
procedure TEditBegOstForm.cxByujetKeyDown(Sender: TObject;
...
procedure TEditBegOstForm.cxByujetPropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
var
  id:variant;
begin
...
procedure TEditBegOstForm.cxKEKVPropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
var
  id:variant;
begin
