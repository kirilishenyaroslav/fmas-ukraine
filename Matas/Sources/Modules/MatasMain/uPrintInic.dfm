object fmPrintInic: TfmPrintInic
  Left = 419
  Top = 347
  ...
  object cxPrintInic: TcxButton
    ...
    ParentFont = False
    TabOrder = 0
    OnClick = cxPrintInicClick
    Glyph.Data = {
      760A0000424D760A000000000000360400002800000014000000140000000100
  ...
  object cxLookupComboBox1: TcxLookupComboBox
    ...
    Width = 73
    Height = 21
    Properties.KeyFieldNames = 'ID_SCH'
  ...
  object frReportInic: TfrReport
    Dataset = frDBDataSetInic
  ...
  object pFIBDataSetInic: TpFIBDataSet
    Database = InvDatabase
    Transaction = pFIBTransactionRead
    SelectSQL.Strings = (
      'select * from'
      'mat_sel_mo_ost_base(:PID_MO, :PERIOD)'
      'Where id_sch =:NID_SCH')
    Left = 64
    Top = 32
    poSQLINT64ToBCD = True
  end
  object pFIBTransactionRead: TpFIBTransaction
    DefaultDatabase = InvDatabase
  ...
  object frDBDataSetInic: TfrDBDataSet
    DataSet = pFIBDataSetInic
    Left = 120
    Top = 32
  end
  object pFIBQueryInic: TpFIBQuery
    Database = InvDatabase
    Transaction = pFIBTransactionRead
    Left = 232
    Top = 32
  end
  object InvDatabase: TpFIBDatabase
    DBParams.Strings = (
      'lc_ctype=WIN1251'
      'user_name=SYSDBA'
      'password=masterkey'
  ...
  object SchDataSet: TpFIBDataSet
    ...
    Transaction = pFIBTransactionRead
    SelectSQL.Strings = (
      'select distinct ID_SCH, SCH_NUMBER, NAME_SCH from'
      'mat_sel_mo_ost_base(:PID_MO, :PERIOD)')
    poSQLINT64ToBCD = True
    ...
    object SchDataSetNAME_SCH: TFIBStringField
      FieldName = 'NAME_SCH'
      Size = 150
      EmptyStrToNull = True
    end
