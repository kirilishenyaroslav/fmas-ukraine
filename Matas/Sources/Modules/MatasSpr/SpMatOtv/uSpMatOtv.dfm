object fmSpMatOtv: TfmSpMatOtv
  Left = 371
  Top = 335
  Width = 650
  Height = 550
  Caption = #1044#1086#1074#1110#1076#1085#1080#1082' '#1084#1072#1090#1077#1088#1110#1072#1083#1100#1085#1086'-'#1074#1110#1076#1087#1086#1074#1110#1076#1072#1083#1100#1085#1080#1093
  Color = clBtnFace
  ...
  object TopPanel: TPanel
    ...
    object cxFilter: TcxComboBox
      ...
      Properties.Items.Strings = (
        ''
        #1050#1086#1084#1110#1088#1085#1080#1082#1080
        #1052#1042#1054)
  ...
  object PanelInfo: TPanel
    ...
    object cxDBTextEdit1: TcxDBTextEdit
      ...
      DataBinding.DataSource = MatOtvDataSource
      ParentFont = False
  ...
  object PanelData: TPanel
    ...
    Align = alClient
    TabOrder = 0
    object MatOtvGrid: TcxGrid
      Left = 1
      Top = 1
      Width = 632
      Height = 412
      Align = alClient
      PopupMenu = MoPopupMenu
      TabOrder = 0
      RootLevelOptions.DetailFrameColor = clInfoBk
      object MatOtvGridDBTableView1: TcxGridDBTableView
        OnDblClick = MatOtvGridDBTableView1DblClick
        OnKeyDown = MatOtvGridDBTableView1KeyDown
        DataController.DataSource = MatOtvDataSource
        DataController.Filter.Criteria = {FFFFFFFF0000000000}
        DataController.Summary.DefaultGroupSummaryItems = <>
        DataController.Summary.FooterSummaryItems = <>
        DataController.Summary.SummaryGroups = <>
        NavigatorButtons.ConfirmDelete = False
        OnCellClick = MatOtvGridDBTableView1CellClick
        OnCustomDrawCell = MatOtvGridDBTableView1CustomDrawCell
        OptionsBehavior.IncSearch = True
        OptionsBehavior.IncSearchItem = MatOtvGridDBTableView1FIO
        ...
        object cxgrdbclmnMatOtvGridDBTableView1DBColumn1: TcxGridDBColumn
          Caption = #8470
          Options.Editing = False
          Options.Filtering = False
          Width = 30
          DataBinding.FieldName = 'N_N'
        end
        object MatOtvGridDBTableView1EXPIRED: TcxGridDBColumn
          Visible = False
          DataBinding.FieldName = 'EXPIRED'
        end
        object MatOtvGridDBTableView1CHECK: TcxGridDBColumn
        ...
        object MatOtvGridDBTableView1FIO: TcxGridDBColumn
          Caption = #1060'.'#1048'.'#1054'.'
          Width = 274
          DataBinding.FieldName = 'FIO'
        end
        object MatOtvGridDBTableView1NAME_DEPARTMENT: TcxGridDBColumn
        ...
        object MatOtvGridDBTableView1SKLAD: TcxGridDBColumn
          Width = 36
          DataBinding.FieldName = 'SKLAD'
          IsCaptionAssigned = True
        end
        object MatOtvGridDBTableView1Web: TcxGridDBColumn
          Caption = 'Web'
          PropertiesClassName = 'TcxCheckBoxProperties'
          Properties.DisplayUnchecked = 'False'
          Properties.ValueChecked = 1
          ...
          Options.Editing = False
          Options.Filtering = False
          DataBinding.FieldName = 'IS_GET_WEB_DATA'
        end
      end
      object MatOtvGridLevel1: TcxGridLevel
        GridView = MatOtvGridDBTableView1
      end
    end
  end
  object MatOtvDatabase: TpFIBDatabase
    DBParams.Strings = (
      'user_name=SYSDBA'
      'password=masterkey'
      'lc_ctype=WIN1251')
  ...
  object ReadTransaction: TpFIBTransaction
    DefaultDatabase = MatOtvDatabase
  ...
  object MatOtvDataSet: TpFIBDataSet
    Database = MatOtvDatabase
    Transaction = ReadTransaction
    SelectSQL.Strings = (
      '')
    OnCalcFields = MatOtvDataSetCalcFields
    DefaultFormats.DateTimeDisplayFormat = 'd MMMM yyyy '#39#1075'.'#39
    Left = 96
    Top = 112
    poSQLINT64ToBCD = True
    object MatOtvDataSetID_MO: TFIBIntegerField
      FieldName = 'ID_MO'
    end
    object MatOtvDataSetID_SPODR: TFIBIntegerField
      FieldName = 'ID_SPODR'
    end
    object MatOtvDataSetID_MAN: TFIBIntegerField
      FieldName = 'ID_MAN'
    end
    object MatOtvDataSetFIO: TFIBStringField
      FieldName = 'FIO'
      Size = 62
      EmptyStrToNull = True
    end
    object MatOtvDataSetNAME_DEPARTMENT: TFIBStringField
      FieldName = 'NAME_DEPARTMENT'
      Size = 255
      EmptyStrToNull = True
    end
    object MatOtvDataSetSFIO: TFIBStringField
      FieldName = 'SFIO'
      Size = 50
      EmptyStrToNull = True
    end
    object MatOtvDataSetIS_SKLAD: TFIBSmallIntField
      FieldName = 'IS_SKLAD'
    end
    object MatOtvDataSetDISABLE: TFIBSmallIntField
      FieldName = 'DISABLE'
    end
    object MatOtvDataSetSKLAD: TStringField
      FieldKind = fkCalculated
      FieldName = 'SKLAD'
      Calculated = True
    end
    object MatOtvDataSetCHECKED: TFIBIntegerField
      FieldName = 'CHECKED'
    end
    object MatOtvDataSetDATE_BEG: TFIBDateField
      FieldName = 'DATE_BEG'
    end
    object MatOtvDataSetDATE_END: TFIBDateField
      FieldName = 'DATE_END'
    end
    object MatOtvDataSetCOMMENT: TFIBStringField
      FieldName = 'COMMENT'
      Size = 30
      EmptyStrToNull = True
    end
    object MatOtvDataSetEXPIRED: TFIBIntegerField
      FieldName = 'EXPIRED'
    end
    object MatOtvDataSetN_N: TIntegerField
      FieldKind = fkCalculated
      FieldName = 'N_N'
      Calculated = True
    end
    object MatOtvDataSetIS_GET_WEB_DATA: TFIBIntegerField
      FieldName = 'IS_GET_WEB_DATA'
    end
  end
  object MatOtvDataSource: TDataSource
    AutoEdit = False
    DataSet = MatOtvDataSet
    Left = 136
    Top = 128
  end
  object MoPopupMenu: TPopupMenu
    Images = MainImageList
    OnPopup = MoPopupMenuPopup
    Left = 88
    Top = 256
    object N1: TMenuItem
  ...
  object PrintDataSet: TpFIBDataSet
    ...
    Transaction = ReadTransaction
    SelectSQL.Strings = (
      'SELECT * FROM MAT_SP_MO_SELECT'
      'ORDER BY NAME_DEPARTMENT, FIO')
    Left = 344
    Top = 120
    poSQLINT64ToBCD = True
  end
  ...
  object SpFormStorage: TFormStorage
    ...
    UseRegistry = True
    StoredProps.Strings = (
      'MatOtvGridDBTableView1CHECK.Width'
      'MatOtvGridDBTableView1FIO.Width'
      'MatOtvGridDBTableView1NAME_DEPARTMENT.Width'
      'MatOtvGridDBTableView1SKLAD.Width')
    StoredValues = <>
    Left = 520
    Top = 107
  end
