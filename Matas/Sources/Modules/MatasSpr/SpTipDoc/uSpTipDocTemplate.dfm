object SpTipDocTemplForm: TSpTipDocTemplForm
  Left = 319
  Top = 349
  BorderStyle = bsDialog
  Caption = #1064#1072#1073#1083#1086#1085' '#1076#1083#1103' '#1087#1077#1095#1072#1090#1080' '#1076#1086#1082#1091#1084#1077#1085#1090#1072
  ClientHeight = 112
  ClientWidth = 467
  Color = clBtnFace
  ...
  object cxFile: TcxButtonEdit
    ...
    Properties.OnButtonClick = cxFilePropertiesButtonClick
    TabOrder = 3
  end
  object cxDefTemplate: TcxCheckBox
    Left = 4
    Top = 72
    Width = 141
    Height = 21
    ...
    Properties.Caption = #1047#1072' '#1091#1084#1086#1074#1095#1091#1074#1072#1085#1085#1103#1084
