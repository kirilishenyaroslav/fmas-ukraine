object MatSchFormMulti: TMatSchFormMulti
  Left = 263
  Top = 163
  Width = 570
  Height = 400
  ...
  object TopPanel: TPanel
    ...
    object cxSystem: TcxComboBox
      ...
      Properties.Items.Strings = (
        ...
        #1052#1053#1040
        #1052#1064#1055
        #1052#1072#1090#1077#1088#1110#1072#1083#1080)
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBTableView1: TcxGridDBTableView
      ...
      OptionsBehavior.IncSearchItem = cxGrid1DBTableView1SCH_NUMBER
      ...
      object cxGrid1DBTableView1BAL_SCH_NUMBER: TcxGridDBColumn
        Options.Filtering = False
        Width = 82
        DataBinding.FieldName = 'BAL_SCH'
      end
      object cxGrid1DBTableView1SCH_NUMBER: TcxGridDBColumn
        Options.Filtering = False
        Width = 81
        DataBinding.FieldName = 'SUB_SCH'
      end
      ...
      object cxGrid1DBTableView1TIP_SCH: TcxGridDBColumn
        Visible = False
        Options.Filtering = False
        DataBinding.FieldName = 'TIP_SCH'
      end
    end
  ...
  object MatSchDataSet: TpFIBDataSet
    ...
    SelectSQL.Strings = (
      'SELECT * FROM MAT_SP_SCH_SELECT_FILTER(:DATE, :ID_SESSION)'
      'ORDER BY SCH_NUMBER'
      '')
    OnCalcFields = MatSchDataSetCalcFields
    Left = 96
    Top = 160
    ...
    object MatSchDataSetCHECKED: TFIBIntegerField
      FieldName = 'CHECKED'
    end
    object MatSchDataSetBAL_SCH: TStringField
      FieldKind = fkCalculated
      FieldName = 'BAL_SCH'
      Calculated = True
    end
    object MatSchDataSetSUB_SCH: TStringField
      FieldKind = fkCalculated
      FieldName = 'SUB_SCH'
      Calculated = True
    end
