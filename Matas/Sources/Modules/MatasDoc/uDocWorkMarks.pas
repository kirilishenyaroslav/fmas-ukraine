...
var
  DocPosMarks: TDocPosMarks;

implementation

uses uDocWorkForm, uDocWorkMarksEdit;

{$R *.dfm}

constructor TDocPosMarks.Create(AOwner:TComponent;DBHANDLE : TISC_DB_HANDLE; ID_USER : Int64; ID_MARK: int64);
begin
...
procedure TDocPosMarks.FormCreate(Sender: TObject);
begin
...
procedure TDocPosMarks.OkButtonClick(Sender: TObject);
begin
...
procedure TDocPosMarks.CancelButtonClick(Sender: TObject);
begin
 Result:=false;
 Close;
end;

procedure TDocPosMarks.cxGrid1DBTableView1DblClick(Sender: TObject);
begin
 OkButtonClick(self);
end;

procedure TDocPosMarks.AddButtonClick(Sender: TObject);
var
 f: TDocWorkMarksEdit;
begin
 f:=TDocWorkMarksEdit.Create(self);
...
procedure TDocPosMarks.ModifyButtonClick(Sender: TObject);
var
 f: TDocWorkMarksEdit;
 id_mark: integer;
begin
...
procedure TDocPosMarks.DeleteButtonClick(Sender: TObject);
var
 id_mark: integer;
begin
 id_mark:=MarkDataSetID_MARK.AsInteger;
