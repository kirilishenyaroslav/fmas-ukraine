...
uses
  ...
  Dialogs, uPackageManager, GlobalSPR, cxLookAndFeelPainters,
  ...
  cxCheckBox, Kernel, cxGroupBox;

type
  TProvEditForm = class(TForm)
    OkButton: TcxButton;
  ...
  public
   ...
   DB_KOD_DOG, DB_ID_DOG: integer;
   DB_ID_SCH, KR_ID_SCH: integer;
   KR_KOD_DOG, KR_ID_DOG: integer;
...
var
  ProvEditForm: TProvEditForm;

implementation

{$R *.dfm}

procedure TProvEditForm.OkButtonClick(Sender: TObject);
var
...
procedure TProvEditForm.cxNameDbSchPropertiesButtonClick(
...
procedure TProvEditForm.cxNameDbSchExit(Sender: TObject);
begin
...
procedure TProvEditForm.cxNameDbSchKeyDown(Sender: TObject;
...
procedure TProvEditForm.cxNameKrSchExit(Sender: TObject);
begin
...
procedure TProvEditForm.cxNameKrSchKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
 if Key=VK_RETURN then
  cxSumma.SetFocus;
...
procedure TProvEditForm.cxNameKrSchPropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
var
  Res : Variant;
begin
...
procedure TProvEditForm.cxSummaKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
 if Key=VK_RETURN then
  OkButton.SetFocus;
...
procedure TProvEditForm.FormKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
...
procedure TProvEditForm.cxDbSmetaKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
...
procedure TProvEditForm.cxKRSmetaKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
 if (Key=VK_BACK) or (Key=VK_DELETE) then
 begin
...
procedure TProvEditForm.cxDbSmetaPropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
var
  id:variant;
begin
  id:=GlobalSPR.GetSmets(self, DBHandle, _MATAS_PERIOD, psmRazdSt);
...
procedure TProvEditForm.FormCreate(Sender: TObject);
begin
...
procedure TProvEditForm.cxKRSmetaPropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
var
  id:variant;
begin
...
procedure TProvEditForm.cxDBKEKVPropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
var
  id:variant;
begin
...
procedure TProvEditForm.cxDBKEKVKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
 if (Key=VK_BACK) or (Key=VK_DELETE) then
 begin
...
procedure TProvEditForm.cxKRKEKVKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
 if (Key=VK_BACK) or (Key=VK_DELETE) then
 begin
...
procedure TProvEditForm.cxKRKEKVPropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
var
  id:variant;
begin
...
procedure TProvEditForm.cxCheckKrPropertiesChange(
  Sender: TObject);
begin
