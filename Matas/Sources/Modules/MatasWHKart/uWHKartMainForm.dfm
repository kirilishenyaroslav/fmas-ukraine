object WHKartMainForm: TWHKartMainForm
  Left = 411
  Top = 251
  ...
  object Panel1: TPanel
    ...
    object cxNameFilter: TcxTextEdit
      Left = 296
      Top = 42
      Width = 217
      Height = 21
  ...
  object Panel3: TPanel
    ...
    object cxGrid3: TcxGrid
      ...
      object cxGrid3DBTableView1: TcxGridDBTableView
        ...
        object cxGrid3FIO_MO_IN: TcxGridDBColumn
        ...
        object cxGrid3NAME_DEP_IN: TcxGridDBColumn
          Visible = False
        ...
        object cxGrid3NAME_CUSTOMER: TcxGridDBColumn
          Visible = False
    ...
    object cxGrid2: TcxGrid
      ...
      object cxGridDBTableView1: TcxGridDBTableView
        ...
        object cxGrid2FIO_MO_OUT: TcxGridDBColumn
        ...
        object cxGrid2NAME_DEP_OUT: TcxGridDBColumn
          Visible = False
        ...
        object cxGrid2NAME_CUSTOMER: TcxGridDBColumn
          Visible = False
          DataBinding.FieldName = 'NAME_CUSTOMER'
        end
  ...
  object WorkDataSet: TpFIBDataSet
    Database = WHKartDataBase
    Transaction = WHKartTransaction
    SelectSQL.Strings = (
      'SELECT *'
      'FROM MAT_MAKE_OBOROT_FOR_WH_KART(:PID_MO, :DATE_BEG, :DATE_END)')
    Left = 112
    Top = 152
  ...
  object frReportOborot: TfrReport
    Dataset = frDataSetOborot
  ...
  object frDataSetOborot: TfrDBDataSet
    DataSet = WorkDataSet
  ...
  object PrhDocDataSet: TpFIBDataSet
    ...
    Transaction = WHKartTransaction
    SelectSQL.Strings = (
      'SELECT * FROM MAT_MAKE_OBOROT_GET_PRH_DOC_WHK(:PDATE_BEG,'
      '  :PDATE_END, ?ID_MO, ?ID_SCH, ?ID_NOMN)')
    ...
    object PrhDocDataSetFIO_MO_OUT: TFIBStringField
      FieldName = 'FIO_MO_OUT'
      Size = 100
      EmptyStrToNull = True
    end
    object PrhDocDataSetNAME_DEP_OUT: TFIBStringField
    ...
    object PrhDocDataSetNAME_CUSTOMER: TFIBStringField
  ...
  object RshDocDataSet: TpFIBDataSet
    ...
    Transaction = WHKartTransaction
    SelectSQL.Strings = (
      'SELECT * FROM MAT_MAKE_OBOROT_GET_RSH_DOC_WHK(:PDATE_BEG,'
      '  :PDATE_END, ?ID_MO, ?ID_SCH, ?ID_NOMN)')
    DataSource = WorkDataSource
    Left = 152
    Top = 265
    ...
    object RshDocDataSetFIO_MO_IN: TFIBStringField
      FieldName = 'FIO_MO_IN'
      Size = 100
      EmptyStrToNull = True
    end
    object RshDocDataSetNAME_DEP_IN: TFIBStringField
    ...
    object RshDocDataSetNAME_CUSTOMER: TFIBStringField
      FieldName = 'NAME_CUSTOMER'
      Size = 150
      EmptyStrToNull = True
    end
  ...
  object frDBDataSetPrhDoc: TfrDBDataSet
    DataSet = PrhDocDataSet
    Left = 208
    Top = 177
  end
  object frDBDataSetRshDoc: TfrDBDataSet
    DataSet = RshDocDataSet
    Left = 240
    Top = 177
  end
  object WHKartDataBase: TpFIBDatabase
    DBParams.Strings = (
      'user_name=SYSDBA'
      'password=masterkey'
      'lc_ctype=WIN1251')
    DefaultTransaction = WHKartTransaction
    DefaultUpdateTransaction = WHKartTransaction
    SQLDialect = 3
    Timeout = 0
    DesignDBOptions = []
  ...
  object WHKartTransaction: TpFIBTransaction
    DefaultDatabase = WHKartDataBase
  ...
  object frDBDataSetPrh: TfrDBDataSet
    DataSet = PrhDocDataSet
    Left = 280
    Top = 241
  end
  object frDBDataSetRsh: TfrDBDataSet
    DataSet = RshDocDataSet
    Left = 312
    Top = 241
  end
