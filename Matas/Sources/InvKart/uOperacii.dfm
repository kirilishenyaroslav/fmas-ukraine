object fmOperacion: TfmOperacion
  Left = 443
  Top = 246
  ...
  object LabelOst_price: TLabel
    Left = 337
    Top = 80
    Width = 86
    Height = 13
    Caption = 'LabelOst_price'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clBlack
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  object LabelOst_iznos: TLabel
    Left = 337
    Top = 102
    Width = 87
    Height = 13
    Caption = 'LabelOst_iznos'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clBlack
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  object cxButtonEditMOL_old: TcxButtonEdit
    ...
    Properties.OnButtonClick = cxButtonEditMOL_oldPropertiesButtonClick
    TabOrder = 1
    OnKeyPress = cxButtonEditMOL_oldKeyPress
  end
  object cxButtonEditSch_old: TcxButtonEdit
    Left = 477
    Top = 54
    Width = 155
    Height = 21
    ...
    Properties.OnButtonClick = cxButtonEditSch_oldPropertiesButtonClick
    TabOrder = 2
    OnKeyPress = cxButtonEditSch_oldKeyPress
  end
  object cxTextEditOst_price: TcxTextEdit
    Left = 477
    Top = 75
    Width = 156
    Height = 21
    TabOrder = 4
    OnKeyPress = cxTextEditOst_priceKeyPress
  end
  ...
  object cxTextEditOst_izn: TcxTextEdit
    Left = 477
    Top = 96
    Width = 156
    Height = 21
    TabOrder = 6
    OnKeyPress = cxTextEditOst_iznKeyPress
  end
  ...
  object cxTextEditIznos: TcxTextEdit
    ...
    Text = '0'
    Visible = False
    OnKeyPress = cxTextEditIznosKeyPress
  end
  ...
  object cxTextEditSumma_pr: TcxTextEdit
    ...
    Text = '0,00'
    Visible = False
    OnExit = cxTextEditSumma_prExit
    OnKeyDown = cxTextEditSumma_prKeyDown
    OnKeyPress = cxTextEditSumma_prKeyPress
  end
  object cxTextEditSumma_izn: TcxTextEdit
    ...
    Text = '0,00'
    Visible = False
    OnExit = cxTextEditSumma_iznExit
    OnKeyDown = cxTextEditSumma_iznKeyDown
    OnKeyPress = cxTextEditSumma_iznKeyPress
  end
  object cxTextEditFullInv: TcxTextEdit
    Left = 128
    Top = 8
    Width = 121
    Height = 21
  ...
  object cxTextEditNomnName: TcxTextEdit
    Left = 128
    Top = 30
    Width = 504
    Height = 21
