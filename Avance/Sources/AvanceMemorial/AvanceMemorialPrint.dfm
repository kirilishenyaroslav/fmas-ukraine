object fmAvanceMemorialPrint: TfmAvanceMemorialPrint
  Left = 341
  Top = 240
  Width = 800
  Height = 525
  ...
  object DSDSch: TpFIBDataSet
    ...
    Top = 304
    poSQLINT64ToBCD = True
    object DSDSchKOD_SCH: TFIBStringField
      FieldName = 'KOD_SCH'
      Size = 30
      EmptyStrToNull = True
    end
    object DSDSchTITLE_SCH: TFIBStringField
      FieldName = 'TITLE_SCH'
      Size = 60
      EmptyStrToNull = True
    end
    object DSDSchID_SCH: TFIBBCDField
      FieldName = 'ID_SCH'
      Size = 0
      RoundByScale = True
    end
    object DSDSchSUMMA: TFIBBCDField
      FieldName = 'SUMMA'
      Size = 2
      RoundByScale = True
    end
    object DSDSchPAR_S: TFIBStringField
      FieldName = 'PAR_S'
      Size = 10
      EmptyStrToNull = True
    end
  ...
  object DSKSch: TpFIBDataSet
    ...
    Top = 344
    poSQLINT64ToBCD = True
    object DSKSchKOD_SCH: TFIBStringField
      FieldName = 'KOD_SCH'
      Size = 30
      EmptyStrToNull = True
    end
    object DSKSchTITLE_SCH: TFIBStringField
      FieldName = 'TITLE_SCH'
      Size = 60
      EmptyStrToNull = True
    end
    object DSKSchID_SCH: TFIBBCDField
      FieldName = 'ID_SCH'
      Size = 0
      RoundByScale = True
    end
    object DSKSchSUMMA: TFIBBCDField
      FieldName = 'SUMMA'
      Size = 2
      RoundByScale = True
    end
    object DSKSchPAR_S2: TFIBStringField
      FieldName = 'PAR_S2'
      Size = 10
      EmptyStrToNull = True
    end
