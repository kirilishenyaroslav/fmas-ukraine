object frmMonuReportAccepted: TfrmMonuReportAccepted
  Left = 218
  Top = 92
  Width = 739
  Height = 551
  Caption = #1059#1089#1090#1072#1085#1086#1074#1080' '#1097#1086' '#1085#1072#1076#1072#1083#1080' '#1079#1074#1110#1090#1085#1110#1089#1090#1100
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object cbKvartal: TcxComboBox
      ...
      Properties.Items.Strings = (
        'I - '#1055#1077#1088#1096#1080#1081
        'II - '#1044#1088#1091#1075#1080#1081
        'III - '#1058#1088#1077#1090#1110#1081
        'IV - '#1063#1077#1090#1074#1077#1088#1090#1080#1081)
      Style.Color = clSkyBlue
      TabOrder = 8
    end
  ...
  object frxReport: TfrxReport
    ...
    ReportOptions.LastChange = 39496.895487916700000000
    ...
    ScriptText.Strings = (
      ...
      'begin'
        ...
        ' // if <frxDBDataset."IS_ERROR"> then CheckBox1.Visible := true ' +
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo1: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.Strings = (
            #1042#1053#1047' '#1097#1086' '#1085#1072#1076#1072#1083#1080' '#1079#1074#1110#1090' '#1079#1072' [PERIOD] '#1091' '#1092#1086#1088#1084#1072#1090#1110' [FORMAT]')
          ParentFont = False
        end
      end
      ...
      object Footer1: TfrxFooter
        ...
        object Memo10: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.Strings = (
            #1050#1110#1083#1100#1082#1110#1089#1090#1100' '#1042#1053#1047': [COUNT(MasterData1)]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo15: TfrxMemoView
          Left = 483.779840000000000000
          Width = 83.149415910000000000
          Height = 18.897650000000000000
          Visible = False
          StretchMode = smMaxHeight
          Color = 15790320
          ...
          HAlign = haRight
          Memo.Strings = (
            #1055#1086#1084#1080#1083#1086#1082':')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo16: TfrxMemoView
          Left = 566.929500000000000000
          Width = 151.180955910000000000
          Height = 18.897650000000000000
          Visible = False
          StretchMode = smMaxHeight
          Color = 15790320
  ...
  object pFIBDataSetData: TpFIBDataSet
    ...
    SelectSQL.Strings = (
      'select distinct o.code, o.name_organization'
      ''
      'from mon_import_log l'
      
        'left join mon_organizations o on(l.id_organization = o.id_organi' +
        'zation)'
      'where'
      ' (l.is_kvartal = 0 and :is_kv = 0'
      ' and'
      '  (extract(month from l.date_data)  = :in_month and'
      '  extract(year from l.date_data)  = :in_year))'
      ''
      '  or'
      ' (l.is_kvartal = 1 and :is_kv = 1'
      ' and'
      '  ((l.kvartal_num = :kv_num) and'
      '  extract(year from l.date_data)  = :in_year))'
      ''
      ''
      ''
      'and'
      ''
      'l.id_log = (select first(1) l2.id_log'
      ''
      'from mon_import_log l2'
      ''
      'where'
      ' (l2.is_kvartal = 0 and :is_kv = 0'
      ' and'
      '  (extract(month from l2.date_data)  = :in_month and'
      '  extract(year from l2.date_data)  = :in_year))'
      ''
      '  or'
      ' (l2.is_kvartal = 1 and :is_kv = 1'
      ' and'
      '  ((l2.kvartal_num = :kv_num) and'
      
        '  extract(year from l2.date_data)  = :in_year))  and l2.id_organ' +
        'ization = l.id_organization'
      ''
      '   order by l2.is_error'
      ''
      ''
      '  )'
      ''
