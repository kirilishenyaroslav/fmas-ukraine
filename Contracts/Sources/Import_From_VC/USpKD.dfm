object fmKD: TfmKD
  ...
  object cxGridShowKD: TcxGrid
    ...
    ParentFont = False
    TabOrder = 0
    object cxGridShowKDDBTableView1: TcxGridDBTableView
      OnDblClick = cxGridShowKDDBTableView1DblClick
      DataController.DataSource = DataSourceSelectionKD
      DataController.DetailKeyFieldNames = 'ID_TYPE_DOG'
      ...
      object cxGridShowKDDBTableView1DBColumn1: TcxGridDBColumn
    ...
    object cxGridShowKDLevel1: TcxGridLevel
      GridView = cxGridShowKDDBTableView1
    end
  end
  ...
  object DataSourceSelectionKD: TDataSource
    DataSet = pFIBDataSetSpSelKD
    Left = 64
    Top = 56
  end
  object pFIBDataSetSpSelKD: TpFIBDataSet
    Database = pFIBDatabaseSpKD
    Transaction = pFIBTransactionRead
    SelectSQL.Strings = (
      'select * from cn_ini_type_dog'
      'order by name collate win1251_UA')
    Left = 64
    Top = 24
    poSQLINT64ToBCD = True
    object pFIBDataSetSpSelKDID_TYPE_DOG: TFIBBCDField
      FieldName = 'ID_TYPE_DOG'
      Size = 0
      RoundByScale = True
    end
    object pFIBDataSetSpSelKDCODENAME: TFIBStringField
      FieldName = 'CODENAME'
      Size = 50
      EmptyStrToNull = True
    end
    object pFIBDataSetSpSelKDNAME: TFIBStringField
      FieldName = 'NAME'
      Size = 255
      EmptyStrToNull = True
    end
    object pFIBDataSetSpSelKDISMAINDOG: TFIBBooleanField
      FieldName = 'ISMAINDOG'
    end
    object pFIBDataSetSpSelKDREPORT_NAME: TFIBStringField
      FieldName = 'REPORT_NAME'
      Size = 255
      EmptyStrToNull = True
    end
    object pFIBDataSetSpSelKDCOPYPRINTCOUNT: TFIBSmallIntField
      FieldName = 'COPYPRINTCOUNT'
    end
  end
  object pFIBDatabaseSpKD: TpFIBDatabase
  ...
  object pFIBTransactionRead: TpFIBTransaction
    DefaultDatabase = pFIBDatabaseSpKD
