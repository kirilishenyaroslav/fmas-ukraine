object fmspstage: Tfmspstage
  ...
  object cxGridShowForm: TcxGrid
    ...
    object cxGridShowFormDBTableView1: TcxGridDBTableView
      ...
      object cxGridShowFormDBTableView1DBColumn1: TcxGridDBColumn
        ...
        Width = 394
        DataBinding.FieldName = 'NAME_STAGE'
      end
    end
  ...
  object pFIBDataSetSpSelForm: TpFIBDataSet
    ...
    SelectSQL.Strings = (
      'select * from CN_VC_SEL_INITYPEDOG'
      'order by name_stage collate win1251_UA')
    Left = 64
    Top = 24
    poSQLINT64ToBCD = True
    object pFIBDataSetSpSelFormID_TYPE_STAGE: TFIBBCDField
      FieldName = 'ID_TYPE_STAGE'
      Size = 0
      RoundByScale = True
    end
    object pFIBDataSetSpSelFormNAME_STAGE: TFIBStringField
      FieldName = 'NAME_STAGE'
      Size = 100
      EmptyStrToNull = True
    end
    object pFIBDataSetSpSelFormCNT_MONTH: TFIBIntegerField
      FieldName = 'CNT_MONTH'
    end
  end
