object fmMova: TfmMova
  ...
  object cxGridShowMova: TcxGrid
    ...
    ParentFont = False
    TabOrder = 0
    OnDblClick = cxGridShowMovaDblClick
    object cxGridShowMovaDBTableView1: TcxGridDBTableView
      OnDblClick = cxGridShowMovaDBTableView1DblClick
      DataController.DataSource = DataSourceSelectionMova
      ...
      object cxGridShowMovaDBTableView1DBColumn1: TcxGridDBColumn
    ...
    object cxGridShowMovaLevel1: TcxGridLevel
      GridView = cxGridShowMovaDBTableView1
    end
  end
  object pFIBDatabaseSpMova: TpFIBDatabase
  ...
  object pFIBDataSetSpSelMova: TpFIBDataSet
    Database = pFIBDatabaseSpMova
    Transaction = pFIBTransactionRead
    SelectSQL.Strings = (
      'select * from CN_SP_NATIONAL'
      'order by name collate win1251_UA')
    Left = 64
    Top = 24
    poSQLINT64ToBCD = True
    object pFIBDataSetSpSelMovaID_NATIONAL: TFIBBCDField
      FieldName = 'ID_NATIONAL'
      Size = 0
      RoundByScale = True
    end
    object pFIBDataSetSpSelMovaNAME: TFIBStringField
      FieldName = 'NAME'
      EmptyStrToNull = True
    end
    object pFIBDataSetSpSelMovaSHORT_NAME: TFIBStringField
      FieldName = 'SHORT_NAME'
      Size = 10
      EmptyStrToNull = True
    end
  end
  object DataSourceSelectionMova: TDataSource
    DataSet = pFIBDataSetSpSelMova
    Left = 64
    Top = 56
  end
  object pFIBTransactionRead: TpFIBTransaction
    DefaultDatabase = pFIBDatabaseSpMova
