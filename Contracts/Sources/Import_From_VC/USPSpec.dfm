object fmSpSpec: TfmSpSpec
  ...
  object cxGridShowSpec: TcxGrid
    ...
    ParentFont = False
    TabOrder = 0
    OnDblClick = cxGridShowSpecDblClick
    object cxGridShowSpecDBTableView1: TcxGridDBTableView
      OnDblClick = cxGridShowSpecDBTableView1DblClick
      DataController.DataSource = DataSourceSelectionSpec
      ...
      object cxGridShowSpecDBTableView1DBColumn1: TcxGridDBColumn
    ...
    object cxGridShowSpecLevel1: TcxGridLevel
      GridView = cxGridShowSpecDBTableView1
    end
  end
  object DataSourceSelectionSpec: TDataSource
    DataSet = pFIBDataSetSpSelSpec
    Left = 64
    Top = 56
  end
  object pFIBTransactionRead: TpFIBTransaction
    DefaultDatabase = pFIBDatabaseSpSpec
    TimeoutAction = TARollback
    Left = 24
    Top = 56
  end
  object pFIBDatabaseSpSpec: TpFIBDatabase
  ...
  object pFIBDataSetSpSelSpec: TpFIBDataSet
    Database = pFIBDatabaseSpSpec
    Transaction = pFIBTransactionRead
    SelectSQL.Strings = (
      'select * from CN_VC_SEL_SPEC_P_JN(25)'
      'order by name collate win1251_UA')
    Left = 64
    Top = 24
    poSQLINT64ToBCD = True
    object pFIBDataSetSpSelSpecID_SPEC: TFIBBCDField
      FieldName = 'ID_SPEC'
      Size = 0
      RoundByScale = True
    end
    object pFIBDataSetSpSelSpecCODE_SPEC: TFIBStringField
      FieldName = 'CODE_SPEC'
      Size = 8
      EmptyStrToNull = True
    end
    object pFIBDataSetSpSelSpecNAME: TFIBStringField
      FieldName = 'NAME'
      Size = 60
      EmptyStrToNull = True
    end
