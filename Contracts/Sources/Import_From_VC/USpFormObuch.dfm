object fmSpFormObuch: TfmSpFormObuch
  Left = 213
  Top = 110
  Width = 634
  Height = 422
  Caption = 'fmSpFormObuch'
  Color = clBtnFace
  ...
  object cxGridShowForm: TcxGrid
    ...
    ParentFont = False
    TabOrder = 0
    OnDblClick = cxGridShowFormDblClick
    object cxGridShowFormDBTableView1: TcxGridDBTableView
      OnDblClick = cxGridShowFormDBTableView1DblClick
      DataController.DataSource = DataSourceSelectionForm
      ...
      object cxGridShowFormDBTableView1DBColumn1: TcxGridDBColumn
    ...
    object cxGridShowFormLevel1: TcxGridLevel
      GridView = cxGridShowFormDBTableView1
    end
  end
  object pFIBDatabaseSpForm: TpFIBDatabase
  ...
  object pFIBDataSetSpSelForm: TpFIBDataSet
    Database = pFIBDatabaseSpForm
    Transaction = pFIBTransactionRead
    SelectSQL.Strings = (
      'select * from CN_SP_FORM_STUD'
      'order by name collate win1251_UA')
    Left = 64
    Top = 24
    poSQLINT64ToBCD = True
    object pFIBDataSetSpSelFormID_FORM_STUD: TFIBBCDField
      FieldName = 'ID_FORM_STUD'
      Size = 0
      RoundByScale = True
    end
    object pFIBDataSetSpSelFormNAME: TFIBStringField
      FieldName = 'NAME'
      Size = 100
      EmptyStrToNull = True
    end
    object pFIBDataSetSpSelFormSHORT_NAME: TFIBStringField
      FieldName = 'SHORT_NAME'
      EmptyStrToNull = True
    end
  end
  object DataSourceSelectionForm: TDataSource
    DataSet = pFIBDataSetSpSelForm
    Left = 64
    Top = 56
  end
  object pFIBTransactionRead: TpFIBTransaction
    DefaultDatabase = pFIBDatabaseSpForm
