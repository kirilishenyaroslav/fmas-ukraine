object frmMainFormSumLgot: TfrmMainFormSumLgot
  Left = 649
  Top = 158
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'frmMainFormSumLgot'
  ClientHeight = 474
  ClientWidth = 321
  Color = clBtnFace
  ...
  object cxGroupBoxPeriodStud: TcxGroupBox
    ...
    object cxDateEditPeriodBegin: TcxDateEdit
      ...
      Width = 121
      Height = 21
      Properties.OnChange = cxDateEditPeriodBeginPropertiesChange
      TabOrder = 0
    end
    object cxDateEditPeriodEnd: TcxDateEdit
      ...
      Width = 121
      Height = 21
      Properties.OnChange = cxDateEditPeriodEndPropertiesChange
      TabOrder = 1
    end
  end
  ...
  object cxGroupBox2: TcxGroupBox
    ...
    Alignment = alTopLeft
    TabOrder = 9
    object CheckBoxProcent: TCheckBox
      Left = 8
      Top = 24
      Width = 201
      Height = 17
      Caption = 'CheckBoxProcent'
      TabOrder = 1
    end
    object CheckBoxSum: TCheckBox
      Left = 8
      Top = 8
      Width = 193
      Height = 17
