...
{$R *.dfm}
constructor TfrmInputs_AE.Create(AOwner:TComponent; LanguageIndex : byte);
begin
...
procedure TfrmInputs_AE.FormIniLanguage;
begin
...
procedure TfrmInputs_AE.OkButtonClick(Sender: TObject);
begin
...
procedure TfrmInputs_AE.CancelButtonClick(Sender: TObject);
begin
close;
end;

procedure TfrmInputs_AE.FormShow(Sender: TObject);
begin
Name_Edit.SetFocus;
end;

procedure TfrmInputs_AE.ShortName_EditKeyPress(Sender: TObject;
  var Key: Char);
begin
