...
{$R *.dfm}
constructor TfrmKat_AE.Create(AOwner:TComponent; LanguageIndex : byte);
begin
...
procedure TfrmKat_AE.FormIniLanguage;
begin
...
procedure TfrmKat_AE.OkButtonClick(Sender: TObject);
begin
...
procedure TfrmKat_AE.CancelButtonClick(Sender: TObject);
begin
close;
end;

procedure TfrmKat_AE.FormShow(Sender: TObject);
begin
Name_Edit.SetFocus;
end;

procedure TfrmKat_AE.ShortName_EditKeyPress(Sender: TObject;
  var Key: Char);
begin
