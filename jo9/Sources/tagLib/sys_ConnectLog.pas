...
{                  Модуль "Протоколирование пользовательских соединений        }
...
begin
 ...
 try
  ...
  DB.AfterConnect     := ConnectLog.DatabaseAfterConnect;
...
procedure TConnectLog.DatabaseAfterConnect(Sender: TObject);
begin
 try
  StoredProc.Transaction.StartTransaction;

  StoredProc.ExecProcedure('SYS_CONNECT_LOG_ADD', [S_id_User, GetLocalComputerName, GetUserName]);

  Connect_PK_ID := StoredProc.Fields[0].AsInt64;
