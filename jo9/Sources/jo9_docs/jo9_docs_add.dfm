object jo9_docs_add_Form: Tjo9_docs_add_Form
  ...
  object DataSet: TpFIBDataSet
    Database = JO9_Docs_Form.Database
    Transaction = JO9_Docs_Form.ReadTransaction
    UpdateTransaction = JO9_Docs_Form.WriteTransaction
    Left = 605
    Top = 23
  ...
  object StoredProc: TpFIBStoredProc
    Database = JO9_Docs_Form.Database
    Transaction = JO9_Docs_Form.WriteTransaction
    Left = 677
    Top = 23
  end
  object Timer: TTimer
  ...
  object Report: TfrxReport
    ...
    Datasets = <
      item
        DataSet = jo9_PrintForm.DBDataset
        DataSetName = 'DBDataset'
      end
      item
        DataSet = jo9_PrintForm.JODataset
        DataSetName = 'JODataset'
      end
      item
        DataSet = jo9_PrintForm.SecDataset
