...
type
  TFormPUB_SP_SPEC = class(TFormPrK_SpravOneLevel)
...
implementation
uses uConstants,uPUB_SP_SPEC_Edit, uPrKKlassSprav;
{$R *.dfm}
...
//  colMOVA_NAME.Caption:=ncolMOVA_NAME[IndexLanguage];
...
begin
  ...
  ID_SP_USPEC    :=aID_SP_MOVA;
  USPEC_NAME :=aMOVA_NAME;
  FullName := aFullName;
end;
