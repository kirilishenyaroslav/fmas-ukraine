object FormPrKKlassViewWithFilter: TFormPrKKlassViewWithFilter
  Left = 321
  Top = 131
  Width = 673
  Height = 550
  Caption = 'FormPrKKlassViewWithFilter'
  Color = clBtnFace
  ...
  object cxGridPrKViewWithFilter: TcxGrid
    ...
    object cxGridPrKViewWithFilterDBTableView1: TcxGridDBTableView
      ...
      object colIS_LOCKED: TcxGridDBColumn
        OnCustomDrawCell = colIS_LOCKEDCustomDrawCell
        Width = 33
        DataBinding.FieldName = 'IS_LOCKED'
      end
      object colID_SP_TYPE_PEREKL: TcxGridDBColumn
        Visible = False
        DataBinding.FieldName = 'ID_SP_TYPE_PEREKL'
      end
    end
  ...
  object cxGroupBoxAllFilter: TcxGroupBox
    ...
    object cxGroupBoxDate: TcxGroupBox
      ...
      TabOrder = 1
      Visible = False
      object cxGroupBoxDatePeriod: TcxGroupBox
        Left = 2
        Top = 61
        Width = 188
        Height = 60
        ...
        object cxCheckBoxFrom: TcxCheckBox
          ...
          Properties.OnChange = cxCheckBoxFromPropertiesChange
          State = cbsChecked
        ...
        object cxCheckBoxTo: TcxCheckBox
          ...
          Properties.Alignment = taCenter
          Properties.DisplayUnchecked = 'False'
          Properties.OnChange = cxCheckBoxToPropertiesChange
          State = cbsChecked
          Style.Color = 16776176
          TabOrder = 2
        end
      ...
      object cxGroupBoxDateRadioBut: TcxGroupBox
        Left = 2
        Top = 15
        Width = 188
        Height = 46
        ...
        object cxRadioButtonToday: TcxRadioButton
          ...
          TabOrder = 0
          TabStop = True
          OnClick = cxRadioButtonTodayClick
        end
        object cxRadioButtonPeriod: TcxRadioButton
          Left = 6
          Top = 25
          Width = 153
          Height = 17
          Cursor = crHandPoint
          Caption = 'cxRadioButtonPeriod'
          Color = clBtnFace
          ParentColor = False
          TabOrder = 1
          OnClick = cxRadioButtonPeriodClick
        end
      end
    end
    object cxGroupBoxMainElement: TcxGroupBox
      Left = 2
      Top = 15
      Width = 199
      Height = 124
      ...
      TabOrder = 0
      Ctl3D = True
      object cxCheckBoxFiltrOnDate: TcxCheckBox
        Left = 6
        Top = 16
        Width = 25
        Height = 21
        ...
        Properties.Alignment = taCenter
        Properties.DisplayUnchecked = 'False'
        Properties.OnChange = cxCheckBoxFiltrOnDatePropertiesChange
        Style.Color = 16776176
        TabOrder = 0
      end
      object cxLabelFiltrOnDate: TcxLabel
        Left = 34
        Top = 18
        Width = 159
        Height = 17
      ...
      object cxCheckBoxFiltrOnPerekl: TcxCheckBox
        Left = 6
        Top = 40
        Width = 25
        Height = 21
      ...
      object cxLabelFiltrOnPerekl: TcxLabel
        Left = 32
        Top = 42
        Width = 159
        Height = 17
      ...
      object cxLabelFiltrOnZach: TcxLabel
        Left = 32
        Top = 66
        Width = 159
        Height = 17
      ...
      object cxCheckBoxFiltrOnZach: TcxCheckBox
        Left = 6
        Top = 64
        Width = 25
        Height = 21
  ...
  object cxGroupBoxContracts: TcxGroupBox
    ...
    object dxBarDockControlContracts: TdxBarDockControl
      Left = 2
      Top = 15
      Width = 301
      Height = 72
  ...
  object dxBarManagerViewWithFilter: TdxBarManager
    ...
    Bars = <
      ...
      item
        ...
        DockControl = dxBarDockControlContracts
        DockedDockControl = dxBarDockControlContracts
        DockedLeft = 0
        DockedTop = 0
        FloatLeft = 276
        FloatTop = 213
  ...
  object TransactionWritePrKViewWithFilter: TpFIBTransaction
    DefaultDatabase = DataBasePrKViewWithFilter
    TimeoutAction = TARollback
    Left = 77
    Top = 352
  end
  object TransactionReadPrKViewWithFilter: TpFIBTransaction
    DefaultDatabase = DataBasePrKViewWithFilter
    TimeoutAction = TARollback
    Left = 48
    Top = 352
  end
  object DataBasePrKViewWithFilter: TpFIBDatabase
    DefaultTransaction = TransactionReadPrKViewWithFilter
    SQLDialect = 3
    Timeout = 0
  ...
  object DataSourcePrKViewWithFilter: TDataSource
    DataSet = DataSetPrKViewWithFilter
    Left = 17
    Top = 378
  end
  object DataSetPrKViewWithFilter: TpFIBDataSet
    Database = DataBasePrKViewWithFilter
    Transaction = TransactionReadPrKViewWithFilter
    AfterScroll = RxMemoryDataPrKViewWithFilterAfterScroll
    Left = 46
    Top = 379
    poSQLINT64ToBCD = True
  end
  object StoredProcPrKViewWithFilter: TpFIBStoredProc
    Database = DataBasePrKViewWithFilter
    Transaction = TransactionWritePrKViewWithFilter
    Left = 77
    Top = 379
  end
  ...
  object RxMemoryDataPrKViewWithFilter: TRxMemoryData
    FieldDefs = <>
    AfterScroll = RxMemoryDataPrKViewWithFilterAfterScroll
    Left = 112
    Top = 379
