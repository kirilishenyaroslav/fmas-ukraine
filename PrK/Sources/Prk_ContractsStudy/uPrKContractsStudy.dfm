object FormPrkContractsStudy: TFormPrkContractsStudy
  Left = 421
  Top = 273
  Width = 735
  Height = 480
  Caption = 'FormPrkContractsStudy'
  Color = clBtnFace
  ...
  object cxGroupBoxContracts: TcxGroupBox
    ...
    object dxBarDockControlContracts: TdxBarDockControl
      ...
      Height = 72
      Align = dalTop
      BarManager = dxBarManagerContractsStudy
    end
    object cxGroupBoxDataDog: TcxGroupBox
      ...
      object cxDBTextEditFIO_PAYER: TcxDBTextEdit
        ...
        Height = 21
        TabStop = False
        DataBinding.DataField = 'FIO_PAYER'
        DataBinding.DataSource = DataSourceContrakts
        TabOrder = 6
      end
    end
  end
  object cxGridPrKContractsStudy: TcxGrid
    Left = 0
    Top = 36
    Width = 414
    Height = 390
    Align = alClient
    TabOrder = 0
    object cxGridPrKContractsStudyDBTableView1: TcxGridDBTableView
      DataController.DataSource = DataSourcePrKContractsStudy
      DataController.Filter.Criteria = {FFFFFFFF0000000000}
      DataController.Summary.DefaultGroupSummaryItems = <>
      DataController.Summary.FooterSummaryItems = <>
      DataController.Summary.SummaryGroups = <>
      ...
      object colNAME_STATUS: TcxGridDBColumn
        SortOrder = soAscending
        Width = 33
        DataBinding.FieldName = 'NAME_DOG_STATUS'
      end
    ...
    object cxGridPrKContractsStudyLevel1: TcxGridLevel
      GridView = cxGridPrKContractsStudyDBTableView1
    end
  end
  ...
  object dxBarManagerContractsStudy: TdxBarManager
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    Font.Name = 'Tahoma'
    ...
    Bars = <
      item
        ...
        ItemLinks = <
          item
            Item = dxBarLargeButtonDejstv
            Visible = True
          end
          item
            Item = dxBarLargeButtonCandidat
            Visible = True
          end
          item
    ...
    object dxBarLargeButtonDejstv: TdxBarLargeButton
      Action = ActionDejstv
      Category = 0
      AutoGrayScale = False
    end
    object dxBarLargeButtonCandidat: TdxBarLargeButton
  ...
  object ActionListViewWithFilter: TActionList
    ...
    object ActionDejstv: TAction
      Caption = 'ActionDejstv'
      ImageIndex = 0
      OnExecute = ActionDejstvExecute
    end
    object ActionCandidat: TAction
      Caption = 'ActionCandidat'
      ImageIndex = 0
      OnExecute = ActionCandidatExecute
    end
  end
  ...
  object DataBasePrkContractsStudy: TpFIBDatabase
    DefaultTransaction = TransactionReadPrKContractsStudy
    SQLDialect = 3
    Timeout = 0
  ...
  object DataSetPrKContractsStudy: TpFIBDataSet
    Database = DataBasePrkContractsStudy
    Transaction = TransactionReadPrKContractsStudy
    Left = 96
    Top = 104
    poSQLINT64ToBCD = True
  end
  object TransactionReadPrKContractsStudy: TpFIBTransaction
    DefaultDatabase = DataBasePrkContractsStudy
    TimeoutAction = TARollback
    Left = 96
    Top = 152
  end
  object TransactionWritePrKContractsStudy: TpFIBTransaction
    DefaultDatabase = DataBasePrkContractsStudy
    TimeoutAction = TARollback
    TPBMode = tpbDefault
    Left = 96
  ...
  object DataSourcePrKContractsStudy: TDataSource
    DataSet = DataSetPrKContractsStudy
    Left = 96
    Top = 240
  end
  object StoredProcPrKContractsStudy: TpFIBStoredProc
    Database = DataBasePrkContractsStudy
    Transaction = TransactionWritePrKContractsStudy
    Left = 288
    Top = 64
  end
  object RxMemoryDataPrKContractsStudy: TRxMemoryData
    FieldDefs = <>
    Left = 288
    Top = 112
  end
  object DataSetContrakts: TpFIBDataSet
    Database = DataBasePrkContractsStudy
    Transaction = TransactionReadPrKContractsStudy
    DataSource = DataSourcePrKContractsStudy
    Left = 544
    Top = 121
    poSQLINT64ToBCD = True
  end
