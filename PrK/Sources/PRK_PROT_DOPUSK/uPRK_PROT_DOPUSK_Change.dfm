object FormPrK_PROT_DOPUSK_Change: TFormPrK_PROT_DOPUSK_Change
  Left = 361
  Top = 213
  BorderStyle = bsDialog
  Caption = 'FormPrK_PROT_DOPUSK_Change'
  ClientHeight = 175
  ClientWidth = 337
  Color = clBtnFace
  ...
  object cxLabelDateBeg: TcxLabel
    ...
    ParentFont = False
    TabOrder = 7
    Caption = 'cxLabelDateBeg'
  end
  object cxDateEditDateEnd: TcxDateEdit
    Left = 182
    Top = 79
    Width = 137
    Height = 21
