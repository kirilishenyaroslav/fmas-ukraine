...
uses
 ...
 uPRK_SP_DOLGNOST_PK, uPRK_SP_KAT_PRI_D,     uPRK_SP_TYPE_ZACH,     uPRK_SP_TYPE_DISC,
 uPRK_SP_DISC;
...
begin
   case aNamePrKSprav of
     ...
     PrK_SP_TYPE_DISC           : T:=TFormPRK_SP_TYPE_DISC.Create           (aOwner,aDBHANDLE,aNamePrKSprav,aParam);
     PrK_SP_DISC                : T:=TFormPRK_SP_DISC.Create                (aOwner,aDBHANDLE,aNamePrKSprav,aParam);
   end;
