inherited FormPrK_SP_DISC_Edit: TFormPrK_SP_DISC_Edit
  Left = 316
  Top = 201
  Caption = 'FormPrK_SP_DISC_Edit'
  ClientHeight = 310
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  ...
  object cxLabelTypeDisc: TcxLabel [13]
    Left = 16
    Top = 138
    Width = 274
    Height = 19
  ...
  object cxButtonEditTypeDisc: TcxButtonEdit [14]
    Left = 26
    Top = 163
    Width = 290
    Height = 21
    ...
    Style.Font.Style = [fsBold]
    TabOrder = 2
    Text = 'cxButtonEditTypeDisc'
    OnKeyPress = cxButtonEditTypeDiscKeyPress
  end
