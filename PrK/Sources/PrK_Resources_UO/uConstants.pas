...
const nFormPRK_SP_DERG_ZAKAZ_Caption :array[0..1] of string[60] =('Довідник (державне замовлення/договір)',
                                                                  'Справочник (Гос. заказ/договор)');
const nFormPRK_SP_EXZFORM_Caption    :array[0..1] of string[70] =('Довідник форм вступних випробувань',
                                                                  'Справочник форм вступительных испытаний');
const nFormPRK_SP_FOB_PROT_Caption   :array[0..1] of string[60] =('Довідник форм навчання для протоколу',
                                                                  'Справочник форм обучения для протокола');
const nFormPRK_SP_FORM_OBUCH_KATEGORY_Caption  :array[0..1] of string[60] =('Довідник категорій форми навчання',
                                                                            'Справочник категорий формы обучения');
const nFormPRK_SP_GOD_NABORA_Caption :array[0..1] of string[100]=('Довідник років набору абітурієнтів',
                                                                  'Справочник годов набора абитуриентов');
const nFormPRK_SP_GURTOG_Caption     :array[0..1] of string[50] =('Довідник потреби у гуртожитку',
                                                                  'Справочник потребности в общежитии');
const nFormPRK_SP_IN_LANG_Caption    :array[0..1] of string[50] =('Довідник іноземних мов',
                                                                  'Справочник иностранных языков');
const nFormPRK_SP_IS_COPY_Caption    :array[0..1] of string[50] =('Довідник(Копія/оригінал)',
                                                                  'Справочник (Копия/оригинал)');
const nFormPRK_SP_KAT_PRI_X_Caption  :array[0..1] of string[150]=('Довідник категорії прийому документів для XІDІTOG',
                                                                  'Справочник категории приема документов для XIDITOG');
const nFormPRK_SP_KURS_Caption       :array[0..1] of string[50] =('Довідник курсів навчання',
                                                                  'Справочник курсов обучения');
const nFormPRK_SP_LEVEL_VLADEN_Caption :array[0..1] of string[100]=('Довідник рівнів володіння іноземною мовою',
                                                                    'Справочник уровней владения иностранным языком');
const nFormPRK_SP_MOVA_Caption       :array[0..1] of string[50] =('Довідник мов навчання',
                                                                  'Справочник языков обучения');
const nFormPRK_SP_NPK_Caption        :array[0..1] of string[150]=('Довідник напрямків роботи приймальної комісії',
                                                                  'Справочник направлений работы приемной комиссии');
const nFormPRK_SP_OCENKA_Caption     :array[0..1] of string[100]=('Довідник оцінок вступних випробувань',
                                                                  'Справочник оценок вступительных испытаний');
const nFormPRK_SP_OLD_PRICH_Caption  :array[0..1] of string[50] =('Довідник причин перерви навчання',
                                                                  'Справочник причин перерыва обучения');
const nFormPrK_SP_PREDM_u_Caption    :array[0..1] of string[60] =('Довідник предметів конкурсного циклу',
                                                                  'Справочник предметов конкурсного цикла');
const nFormPRK_SP_PREDM_Caption      :array[0..1] of string[60] =('Довідник предметів атестату',
                                                                  'Справочник предметов атестата');
const nFormPRK_SP_PREIM_Caption      :array[0..1] of string[100] =('Довідник переваг абітурієнта при вступі',
                                                                   'Справочник преимуществ абитуриента при поступлении');
const nFormPRK_SP_PREIM_KATEGORY_Caption   :array[0..1] of string[100] =('Довідник категорій переваг абітурієнта при надходженні',
                                                                         'Справочник категорий преимуществ абитуриента при поступлении');
const nFormPRK_SP_PRICH_Caption         :array[0..1] of string[50] =('Довідник причин відмови',
                                                                     'Справочник причин отказа');
const nFormPRK_SP_PRIZN_ZACHISL_Caption :array[0..1] of string[50] =('Довідник ознак зарахування',
                                                                     'Справочник признаков зачисления');
const nFormPRK_SP_RISH_Caption          :array[0..1] of string[60] =('Довідник рішень приймальної комісії',
                                                                     'Справочник решений приемной комиссии');
const nFormPRK_SP_TYPE_DOK_OBR_Caption  :array[0..1] of string[100]=('Довідник типів документів про освіту',
                                                                     'Справочник типов документов об образовании');
const nFormPRK_SP_TYPE_PEREKL_Caption   :array[0..1] of string[100]=('Довідник типів перекладання документів',
                                                                     'Справочник типов перекладывания документов');
const nFormPRK_SP_TYPE_RAZN_Caption     :array[0..1] of string[100]=('Довідник типів академічних різниць',
                                                                     'Справочник типов академических разниц');
const nFormPRK_SP_TYPE_UCHZ_Caption     :array[0..1] of string[100]=('Довідник типів освітніх установ',
                                                                     'Справочник типов образовательных учреждений');
const nFormPRK_SP_UKR_LANG_Caption      :array[0..1] of string[100]=('Довідник знання української мови',
                                                                     'Справочник знания украинского языка');
const nFormPRK_SP_VID_DII_Caption       :array[0..1] of string[50] =('Довідник видів дії',
                                                                     'Справочник видов действия');
const nFormPRK_SP_VID_DOG_Caption       :array[0..1] of string[60] =('Довідник найменувань видів договорів',
                                                                     'Справочник наименований видов договоров');
const nFormPRK_SP_ZABR_Caption          :array[0..1] of string[100]=('Довідник ознаки "забрал документи"',
                                                                     'Справочник признака "забрал документы"');
const nFormPRK_SP_KAT_PRI_D_Caption     :array[0..1] of string[100]=('Довідник категорії прийому документів',
                                                                     'Справочник категории приема документов');


const nFormPRK_SP_MIN_PERELIK_PRIM_Caption  :array[0..1] of string[100]=('Довідник приміток до переліку спеціальностей',
                                                                         'Справочник примечаний к перечню специальностей');
const nFormPRK_SP_MIN_PERELIK_SPEC_Caption  :array[0..1] of string[100]=('Довідник переліку спеціальностей',
                                                                         'Справочник перечня специальностей');
const nFormPRK_SP_TYPE_KAT_STUD_Caption     :array[0..1] of string[100]=('Довідник Освітньо-кваліфікаційних рівнів',
                                                                         'Справочник Образовательно-квалификационных уровней');
const nFormPRK_SP_MIN_PERELIK_SHIFR_Caption :array[0..1] of string[100]=('Довідник шифрів спеціальностей)',
                                                                         'Справочник шифров специальностей');
const nFormPRK_SP_VUZ_LICENCE_Caption       :array[0..1] of string[100]=('Додаток до ліцензій ВУЗА на підготовку фахівців',
                                                                         'Приложение к лицензиям ВУЗА на подготовку специалистов');
const nFormPRK_SP_PLAN_NABORA_Caption       :array[0..1] of string[50] =('План набору на навчання',
                                                                         'План набора на обучение');
const nFormPRK_SP_SROK_OB_Caption           :array[0..1] of string[50] =('Довідник строків навчання',
                                                                         'Справочник сроков обучения');
const nFormPRK_DT_ABIT_Caption              :array[0..1] of string[50] =('Облікова картка абітурієнта',
                                                                         'Учетная карточка абитуриента');
const nFormPRK_SP_EDUCORG_Caption           :array[0..1] of string[50] =('Довідник Освітніх установ',
                                                                         'Справочник Образовательных учреждений');
const nFormPRK_SP_PERELIK_ISPIT_Caption     :array[0..1] of string[50] =('Перелік іспитів',
                                                                         'Перечень экзаменов');
const nFormPRK_SP_CEL_ZAMOVNIK_Caption      :array[0..1] of string[50] =('Довідник замовників цільового набору',
                                                                         'Справочник заказчиков целевого набора');
const nFormPRK_SP_PLAN_CEL_NABOR_Caption    :array[0..1] of string[50] =('План цільового набору',
                                                                         'План целевого набора');
const nFormPRK_SP_POTOK_Caption             :array[0..1] of string[50] =('Довідник потоків набору',
                                                                         'Справочник потоков набора');
const nFormPrKKlassViewWithFilter_Caption   :array[0..1] of string[50] =('Картки поточного набору даних',
                                                                         'Карточки текущего набора данных');
const nFormPRK_SP_ISPIT_VEDOM_TYPE_Caption  :array[0..1] of string[50] =('Довідник типів екзаменаційних відомостей',
                                                                         'Справочник типов экзаменационных ведомостей');
const nFormPRK_SP_TYPE_DOP_DOK_Caption      :array[0..1] of string[50] =('Довідник типів інших документів',
                                                                         'Справочник типов других документов');
const nFormPRK_SP_EKZ_RASP_Caption          :array[0..1] of string[80] =('Розклад проведення вступних випробувань по датах',
                                                                         'Расписание проведения вступительных испытаний по датам');
const nFormPrK_Ekz_Vedom_Caption            :array[0..1] of string[50] =('Екзаменаційні відомісті',
                                                                         'Экзаменационные ведомости');
const nFormISPIT_VEDOM_ABIT_ADD_Caption     :array[0..1] of string[50] =('Додати Абітурієнта в екз. відомість',
                                                                         'Добавить Абитуриента в екз. ведомость');
const nFormEKZ_VEDOM_ADD_Caption            :array[0..1] of string[50] =('Нова відомість',
                                                                         'Новая ведомость');
const nFormPRK_DT_ISPIT_OCENKA_Caption      :array[0..1] of string[50] =('Екзаменаційна відомість',
                                                                         'Экзаменационная ведомость');
const nFormPRK_REK_DO_ZARAH_Caption         :array[0..1] of string[50] =('Рекомендації до зарахування',
                                                                         'Рекомендации к зачислению');
const nFormPRK_SP_DOLGNOST_PK_Caption       :array[0..1] of string[50] =('Довідник посад приймальної комісії',
                                                                         'Справочник должностей приемной комиссии');
const nFormPRK_SP_SOSTAV_PK_Caption         :array[0..1] of string[50] =('Довідник складу приймальної комісії',
                                                                         'Справочник состава приемной комиссии');
const nFormPRK_SP_FORM_STUD_FOB_PROT_Caption:array[0..1] of string[50] =('Зв`язок "звичайних" форм навчання й для протоколу',
                                                                         'Связь "обычных" форм обучения и для протокола');
const nFormPrK_PROT_ZACH_Caption            :array[0..1] of string[50] =('Протоколи та накази про зарахування',
                                                                         'Протоколы и приказы о зачислении');
const nFormPrK_PROT_DOPUSK_Caption          :array[0..1] of string[50] =('Протоколи  про допуск',
                                                                         'Протоколы  о допуске');
const nFormPrK_PROT_ZACH_Add_Caption        :array[0..1] of string[50] =('Додавання нового протоколу',
                                                                         'Добавление нового протокола');
const nFormAddExistPRIK_ZACH_Caption        :array[0..1] of string[50] =('Додавання існуючих наказів',
                                                                         'Добавление существующих приказов');
const nFormPrK_PROT_ZACH_Caption_change     :array[0..1] of string[50] =('Протокол про зарахування',
                                                                         'Протокол о зачислении');
const nFormPrK_PROT_DOPUSK_Caption_change   :array[0..1] of string[50] =('Протокол про допуск',
                                                                         'Протокол о допуске');
const nFormPRIK_ZACH_Caption_change         :array[0..1] of string[50] =('Наказ',
                                                                         'Приказ');
const nFormPrK_PZ_Abit_Show_Add_Caption     :array[0..1] of string[50] =('Додавання Абітурієнта',
                                                                         'Добавление Абитуриента');
const nFormPrK_PZ_Abit_ShowProtokol_Caption :array[0..1] of string[50] =('Абітурієнти протоколу',
                                                                         'Абитуриенты протокола');
const nFormPrK_PZ_Abit_ShowPrikaz_Caption   :array[0..1] of string[50] =('Абітурієнти наказу',
                                                                         'Абитуриенты приказа');
const nFormPrK_Kassa_Bank_Caption           :array[0..1] of string[50] =('Вибір Абітурієнта',
                                                                         'Выбор Абитуриента');
const nFormPrK_Results_of_Filtr_Caption     :array[0..1] of string[50] =('Результати фільтраціі',
                                                                         'Результаты фильтрации');
const nFormPrK_Results_of_Filtr_Edit_Caption:array[0..1] of string[50] =('Редагування даних',
                                                                         'Редактирование данных');
const nFormPrK_Show_Reports_Caption         :array[0..1] of string[50] =('Формування звіту',
                                                                         'Формирование отчета');
const nFormPrK_Filtr_Caption                :array[0..1] of string[50] =('Пошук даних про абітурієнтів',
                                                                         'Поиск данных про абитуриентов');
const nFormPrK_Zach_Rules_Caption           :array[0..1] of string[50] =('Правила прийому',
                                                                         'Правила приема');
const nFormPRK_SP_COUNTING_RULE_Caption     :array[0..1] of string[100] =('Довідник правил зарахування, які припускають перевірку певних умов на БД',
                                                                         'Справочник правил зачисления, которые предполагают проверку определенных условий на БД');
//******************************************************************************
