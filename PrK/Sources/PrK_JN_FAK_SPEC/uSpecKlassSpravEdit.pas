...
type
  TFormSpecKlassSpravEdit = class(TForm)
...
var
  FormSpecKlassSpravEdit: TFormSpecKlassSpravEdit;

implementation
uses
    uConstants,uSpecSpravEditStandart;

{$R *.dfm}

constructor TFormSpecKlassSpravEdit.Create(aOwner: TComponent; aDataPrKSprav: TDataPrKSprav;
...
procedure TFormSpecKlassSpravEdit.cxTextEditKodKeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure TFormSpecKlassSpravEdit.ActionOKExecute(Sender: TObject);
var
...
procedure TFormSpecKlassSpravEdit.ActionCanselExecute(Sender: TObject);
begin
   ModalResult:=mrCancel;
end;

procedure TFormSpecKlassSpravEdit.FormShow(Sender: TObject);
begin
                                         {422-урк, 409-англ, 419-рус}
    LoadKeyboardLayout( StrCopy(Layout,nLayoutLang[IndLangEdit]),KLF_ACTIVATE);
end;

procedure TFormSpecKlassSpravEdit.inicCaption;
begin
...
procedure TFormSpecKlassSpravEdit.cxLabelFormCaptionMouseDown(
