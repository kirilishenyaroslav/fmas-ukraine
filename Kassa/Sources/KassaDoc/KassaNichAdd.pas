...
type
  ...
  public
      ...
      dog_flag : Double;
      sum_d : Double;
  constructor Create (Aowner:TComponent ; DBHANDLE : TpFIBDatabase; id_us : Integer; date_d : TDateTime); reintroduce; overload;
    { Public declarations }
  end;

var
  fmKassaNichAdd: TfmKassaNichAdd;
  id_user : Integer;
...
constructor TfmKassaNichAdd.Create(Aowner:TComponent; DBHANDLE : TpFIBDatabase; id_us : Integer; date_d : TDateTime);
begin
...
procedure TfmKassaNichAdd.cxOkButtonClick(Sender: TObject);
var
...
procedure TfmKassaNichAdd.cxSmEditPropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
var
  Add,Res : Variant;
begin
...
procedure TfmKassaNichAdd.cxMonthEditPropertiesChange(Sender: TObject);
begin
...
procedure TfmKassaNichAdd.cxRazdEditPropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
var
  Res : Variant;
  ResCount, i : Integer;
...
procedure TfmKassaNichAdd.FormShow(Sender: TObject);
begin
...
function TfmKassaNichAdd.SelectDogovor(all_summa : double) : boolean;
var
    inputDog : TDogInput;
    res   : TDogResult;
begin
...
procedure TfmKassaNichAdd.cxDogEditPropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
      SelectDogovor(0);
end;

procedure TfmKassaNichAdd.FormCreate(Sender: TObject);
var
      myDate : TDateTime;
      month, myDay: Word;
      GetNameSP:TPfibStoredProc;
      id_razd_temp : Integer;
      dog_flag_temp : Double;
begin
      cxSumEdit.Value:=FloatToCurr(sum_d);
    ...
    begin
      ...
      GetNameSP.Prepare;
      GetNameSP.ParamByName('D_ID_DOG_VX').Value:=dog_flag;
      GetNameSP.ExecProc;
...
procedure TfmKassaNichAdd.cxExitButtonClick(Sender: TObject);
begin
