...
uses
  ...
  cxCalendar, StdCtrls, ExtCtrls, cxMemo, dxBar, dxBarExtItems, KassaNichAdd, pFIBDatabase,
...
type
  ...
  public
    { Public declarations }
    fltForm1 : TfmKassaNichAdd;
    fmBankNich: TfmKassaNich;
    id_us : Integer;
    id_dog : Double;
    date_d : TDateTime;
    n_dog, d_dog, reg_dog, name_cust, summa: string;
    s : Currency;
    ...
    constructor Create(AOwner: TComponent; DBHANDLE : TpFIBDatabase; sum_doc : string; prih, id_user : Integer; date_doc : TDateTime);
  end;
...
constructor TfmKassaNich.Create(AOwner: TComponent; DBHANDLE : TpFIBDatabase; sum_doc : string; prih, id_user : Integer; date_doc : TDateTime);
begin
...
procedure TfmKassaNich.FormCreate(Sender: TObject);
begin
   fmBankNich.Caption:='Фінансування НІЧ';
   fmBankNich.BorderStyle:=bsSingle;
end;

procedure TfmKassaNich.cxParamGridTableView1FocusedRecordChanged(
  Sender: TcxCustomGridTableView; APrevFocusedRecord,
  AFocusedRecord: TcxCustomGridRecord;
  ANewItemRecordFocusingChanged: Boolean);
var
...
procedure TfmKassaNich.cxButtonCancelClick(Sender: TObject);
begin
  ModalResult:=mrCancel;
end;

procedure TfmKassaNich.cxButtonOkClick(Sender: TObject);
var
  i : Integer;
begin
    s:= 0;
...
procedure TfmKassaNich.cxButtonAddClick(Sender: TObject);
var
  month : Integer;
  month_edit : string;
  year : string;
  ...
  i, k : Integer;
begin
   fltForm1 := TfmKassaNichAdd.Create(self, DB, id_us, date_d);
...
procedure TfmKassaNich.cxButtonEditClick(Sender: TObject);
var
  month : Integer;
  month_edit : string;
  year : string;
...
procedure TfmKassaNich.cxButtonDelClick(Sender: TObject);
var
