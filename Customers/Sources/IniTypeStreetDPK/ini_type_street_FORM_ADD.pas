...
type
  TFini_type_street_form_add = class(TForm)
    Label1: TLabel;
    Label2: TLabel;
...
var
  Fini_type_street_form_add: TFini_type_street_form_add;
...
procedure TFini_type_street_form_add.CancelButtonClick(Sender: TObject);
begin
 ModalResult := mrCancel;
end;

procedure TFini_type_street_form_add.OKButtonClick(Sender: TObject);
begin
...
procedure TFini_type_street_form_add.FormShow(Sender: TObject);
begin
 FullNameEdit.SetFocus;
end;

procedure TFini_type_street_form_add.FullNameEditKeyPress(Sender: TObject;
  var Key: Char);
begin
 if Key  = #13 then ShortNameEdit.SetFocus;
end;

procedure TFini_type_street_form_add.ShortNameEditKeyPress(Sender: TObject;
  var Key: Char);
begin
