...
uses DataModule, sp_Object_Charge_Form_Add, sp_Object_Form_Add, Variants;
...
begin
 ...
 if Options.isModal then begin
  ...
  Application.CreateForm(Tsp_Object_Form1, sp_Object_Form1);
  sp_Object_Form1.FormStyle := fsMDIChild;
  sp_Object_Form1.Show;
 end;
end;
...
begin
 ...
 Application.CreateForm(Tsp_Object_Form_Add1, sp_Object_Form_Add1);
 ...
 if TreeList.FocusedNode = nil then begin
  ...
  if not VarIsNull(TreeList.FocusedNode.Values[1]) then begin
   ...
   + IntToStr(sp_Object_Form1.TreeList.FocusedNode.Values[1]) + ' and use_end='
...
begin
 ...
 if VarIsNull(TreeList.FocusedNode.Values[1]) then begin
  ...
  sp_Object_Form_Add1.Name_Department.Text      := TreeList.FocusedNode.Values[5];
  sp_Object_Form_Add.Id_Department              := TreeList.FocusedNode.Values[4];
  sp_Object_Form_Add1.KindRadioGroup.ItemIndex  := 1;
  sp_Object_Form_Add1.LevelRadioGroup.ItemIndex := 0;
 end;
...
begin
 ...
 Application.CreateForm(Tsp_Object_Charge_Form_Add1, sp_Object_Charge_Form_Add1);
...
begin
 if  not VarIsNull(TreeList.FocusedNode.Values[1]) then ModalResult := mrOk;
end;
...
begin
 ...
 Report.LoadFromFile('Reports\FPOP\sp_Object.frf');
