...
uses
  ...
  Check_User,
  Resources_unitb,
  splash_formbu in 'ExeApp\splash_formbu.pas' {splashBU},
  dmMain_BookBU in 'ExeApp\dmMain_BookBU.pas' {dmMainBU: TDataModule},
  MainFormBU in 'ExeApp\MainFormBU.pas' {frmMainFormBU},
  About in 'ExeApp\About.pas' {AboutBox};
