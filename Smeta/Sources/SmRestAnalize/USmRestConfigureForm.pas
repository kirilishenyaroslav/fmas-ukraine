...
uses GlobalSpr,Resources_unitb,BaseTypes,DateUtils,USmRestMainResults;
{$R *.dfm}
...
begin
     TfrmMainResults(self.Owner).Panel2.Caption:='Аналіз залишків на '+DateToStr(cxDateEdit1.Date);
     ModalResult:=mrYes;
end;
