...
const nMsgErrorTransaction          :array[0..1] of string[50]  =('Неможливо виповнити запит!',
                                                       '');
const nMsgImportAcademyYears        :array[0..1] of string[70] = ('Ви дійсно хочете імпортувати перелік академічних років з ЄДБО?', '');
const nMsgImportOrderTypes          :array[0..1] of string[50] = ('Ви дійсно хочете імпортувати типи наказів з ЄДБО?', '');
...
const ndxBtnStudImport   :array[0..1] of string[50] =('Імпорт зарахованих','Импорт зачисленых');
...
const ndxBtnPeopleEDBO   :array[0..1] of string[50] =('Довідник фізичних осіб (ЄДБО)','Справочник физических лиц (ЕДБО)');
...
const ndxBtnImportStud     :array[0..1] of string[50] =('Імпорт даних за зарахованими студентам', 'Импорт данных по зачисленным студентам');
