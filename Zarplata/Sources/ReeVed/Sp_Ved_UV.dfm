object FUV_Ved: TFUV_Ved
  ...
  object Grid: TcxGrid
    ...
    object GridView1: TcxGridDBTableView
      ...
      OnCanSelectRecord = GridView1CanSelectRecord
      OnFocusedRecordChanged = GridView1FocusedRecordChanged
      OnSelectionChanged = GridView1SelectionChanged
      ...
      object GrColID: TcxGridDBColumn
        Visible = False
        DataBinding.FieldName = 'ID_GRSHEET'
      end
      object GrColNumber: TcxGridDBColumn
      ...
      object GrColTypePayment: TcxGridDBColumn
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Width = 200
      end
      object GrColTypeSheet: TcxGridDBColumn
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Width = 144
      end
      object GrColViplata: TcxGridDBColumn
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Width = 102
        DataBinding.FieldName = 'GRSUMMA'
      end
      object GrColKodSmeta: TcxGridDBColumn
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Width = 73
      end
      object GrColDep: TcxGridDBColumn
        Width = 90
      end
    end
  ...
  object Panel1: TPanel
    ...
    Enabled = False
    TabOrder = 1
    object DBMaskEditNameSmeta: TcxDBMaskEdit
      Left = 208
      Top = 3
      Width = 441
      Height = 21
    ...
    object LabelNameSmeta: TcxLabel
      Left = 8
      Top = 5
      Width = 201
      Height = 18
    ...
    object LabelNameDepartment: TcxLabel
      Left = 0
      Top = 29
      Width = 209
      Height = 17
    ...
    object DBMaskEditNameDepartment: TcxDBMaskEdit
      Left = 208
      Top = 27
      Width = 441
      Height = 21
