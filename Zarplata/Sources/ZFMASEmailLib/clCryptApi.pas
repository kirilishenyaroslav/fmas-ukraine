...
type
  TclCryptDecodeObject = function (dwCertEncodingType :DWORD;
                           lpszStructType     :LPCSTR;
                     const pbEncoded          :PBYTE;
                           cbEncoded          :DWORD;
                           dwFlags            :DWORD;
...
type
  ...
  CERT_SIMPLE_CHAIN = record
    ...
    TrustStatus: CERT_TRUST_STATUS;
    cElement: Cardinal;
    rgpElement: array[0..0] of CERT_CHAIN_ELEMENT;
  ...
  CERT_CHAIN_CONTEXT = record
    ...
    TrustStatus: CERT_TRUST_STATUS;
    cChain: Cardinal;
    rgpChain: array[0..0] of CERT_SIMPLE_CHAIN;
  end;
  PCCERT_CHAIN_CONTEXT = ^CERT_CHAIN_CONTEXT;
   
  CERT_CHAIN_FIND_BY_ISSUER_PARA = record
    cbSize: Cardinal;
    pszUsageIdentifier: PChar;
    dwKeySpec: Cardinal;
    dwAcquirePrivateKeyFlags: Cardinal;
    cIssuer: Cardinal;
    rgIssuer: Pointer;
...
type
  TclCryptAcquireCertificatePrivateKey = function (pCert: PCCERT_CONTEXT;
                              dwFlags: DWORD;
                              pvReserved: Pointer;
                              phCryptProv: PHCRYPTPROV;
                              pdwKeySpec: PDWORD;
...
type
  TclCertOpenStore = function(lpszStoreProvider :LPCSTR;
                       dwEncodingType :DWORD;
                       hCryptProv :HCRYPTPROV;
                       dwFlags :DWORD;
                 const pvPara :PVOID):HCERTSTORE ; stdcall;
...
type
  TclCertCloseStore = function (hCertStore :HCERTSTORE; dwFlags :DWORD):BOOL ; stdcall;
...
type
  TclCertGetSubjectCertificateFromStore = function (hCertStore :HCERTSTORE;
                                            dwCertEncodingType :DWORD;
                                            pCertId :PCERT_INFO         // Only the Issuer and SerialNumber
                                            ):PCCERT_CONTEXT ; stdcall; // fields are used
...
type
  TclCertEnumCertificatesInStore = function (hCertStore :HCERTSTORE;
                                     pPrevCertContext :PCCERT_CONTEXT
                                     ):PCCERT_CONTEXT ; stdcall;
...
type
  TclCertFindCertificateInStore = function (hCertStore :HCERTSTORE;
                                    dwCertEncodingType :DWORD;
                                    dwFindFlags :DWORD;
                                    dwFindType :DWORD;
                              const pvFindPara :PVOID;
...
type
  TclCertDuplicateCertificateContext = function(pCertContext :PCCERT_CONTEXT): PCCERT_CONTEXT ; stdcall;
...
type
  TclCertCreateCertificateContext = function (dwCertEncodingType :DWORD;
                                      pbCertEncoded :PBYTE;
                                      cbCertEncoded :DWORD):PCCERT_CONTEXT ; stdcall;
...
type
  TclCertFreeCertificateContext = function(pCertContext :PCCERT_CONTEXT):BOOL ; stdcall;
...
type
  TclCertSetCertificateContextProperty = function (pCertContext :PCCERT_CONTEXT;
                                           dwPropId :DWORD;
                                           dwFlags :DWORD;
                                           pvData :PVOID):BOOL ; stdcall;
...
type
  TclCertGetCertificateContextProperty = function (pCertContext :PCCERT_CONTEXT;
                                           dwPropId :DWORD;
                                           pvData :PVOID;
                                           pcbData :PDWORD):BOOL ; stdcall;
...
type
  TclCertEnumCertificateContextProperties = function (pCertContext :PCCERT_CONTEXT;
                                              dwPropId :DWORD):DWORD ; stdcall;
...
type
  TclCertAddCertificateContextToStore = function (hCertStore :HCERTSTORE;
                                          pCertContext :PCCERT_CONTEXT;
                                          dwAddDisposition :DWORD;
                                          ppStoreContext :PPCCERT_CONTEXT //OPTIONAL
                                          ):BOOL ; stdcall;
...
type
  TclPFXImportCertStore = function (pPFX: PCRYPT_DATA_BLOB;
                                          szPassword: PWideChar;
                                          dwFlags: DWORD): HCERTSTORE; stdcall;
...
type
  TclPFXExportCertStoreEx = function (hStore: HCERTSTORE;
                                          pPFX: PCRYPT_DATA_BLOB;
                                          szPassword: PWideChar;
                                          pvReserved: Pointer;
                                          dwFlags: DWORD): BOOL; stdcall;
...
type
  TclCertDeleteCertificateFromStore = function (pCertContext :PCCERT_CONTEXT):BOOL ; stdcall;
...
type
  TclCryptSignAndEncodeCertificate = function (hCryptProv :HCRYPTPROV;
                                       dwKeySpec :DWORD;
                                       dwCertEncodingType :DWORD;
                                 const lpszStructType :LPCSTR; // "to be signed"
                                       pvStructInfo :PVOID;
...
const
  ...
  CERT_CHAIN_POLICY_BASE              = PChar(1);
  CERT_CHAIN_POLICY_AUTHENTICODE      = PChar(2);
  CERT_CHAIN_POLICY_AUTHENTICODE_TS   = PChar(3);
  CERT_CHAIN_POLICY_SSL               = PChar(4);
  CERT_CHAIN_POLICY_BASIC_CONSTRAINTS = PChar(5);
  CERT_CHAIN_POLICY_NT_AUTH           = PChar(6);
...
function CertGetCertificateChain(
    ...
    dwFlags: DWORD;
    pvReserved: PVOID;
    ppChainContext: PCCERT_CHAIN_CONTEXT): Boolean; stdcall;

type
  TclCertGetCertificateChain = function(
    hChainEngine: Cardinal;
    pCertContext: PCCERT_CONTEXT;
    pTime: PFILETIME;
    hAdditionalStore: HCERTSTORE;
...
function CertVerifyCertificateChainPolicy(
    ...
    pPolicyStatus: PCERT_CHAIN_POLICY_STATUS): Boolean; stdcall;
    
type
  TclCertVerifyCertificateChainPolicy = function(
    pszPolicyOID: PChar;
    pChainContext: PCCERT_CHAIN_CONTEXT;
    pPolicyPara: PCERT_CHAIN_POLICY_PARA;
    pPolicyStatus: PCERT_CHAIN_POLICY_STATUS): Boolean; stdcall;
...
procedure CertFreeCertificateChain(
    pChainContext: PCCERT_CHAIN_CONTEXT); stdcall;

type
  TclCertFreeCertificateChain = procedure(
    pChainContext: PCCERT_CHAIN_CONTEXT); stdcall;
...
type
  TclCertFindExtension = function (pszObjId :LPCSTR;
                           cExtensions :DWORD;
                           rgExtensions :PCERT_EXTENSION):PCERT_EXTENSION ; stdcall;
...
type
  TclCryptExportPublicKeyInfo = function (hCryptProv :HCRYPTPROV;
                                  dwKeySpec :DWORD;
                                  dwCertEncodingType :DWORD;
                                  pInfo :PCERT_PUBLIC_KEY_INFO;
                                  pcbInfo :PDWORD):BOOL ; stdcall;
...
type
  TclCryptImportPublicKeyInfoEx = function (hCryptProv :HCRYPTPROV;
                                    dwCertEncodingType :DWORD;
                                    pInfo :PCERT_PUBLIC_KEY_INFO;
                                    aiKeyAlg :ALG_ID;
                                    dwFlags :DWORD;
...
type
  TclCertNameToStr = function (dwCertEncodingType :DWORD;
                       pName :PCERT_NAME_BLOB;
                       dwStrType :DWORD;
                       psz :LPAWSTR; //OPTIONAL
                       csz :DWORD):DWORD ; stdcall;
...
type
  TclCertGetNameString = function (pCertContext: PCCERT_CONTEXT;
                       dwType: DWORD;
                       dwFlags: DWORD;
                       pvTypePara: Pointer;
                       pszNameString: LPAWSTR;
...
function CertStrToName(dwCertEncodingType :DWORD;
                       ...
                       pbEncoded :PBYTE;
                       pcbEncoded :PDWORD;
                       ppszError: Pointer):BOOL ; stdcall;

type
  TclCertStrToName = function (dwCertEncodingType :DWORD;
                       pszX500 :LPAWSTR;
                       dwStrType :DWORD;
                       pvReserved :PVOID;
                       pbEncoded :PBYTE;
...
type
  TclCryptSignMessage = function(pSignPara :PCRYPT_SIGN_MESSAGE_PARA;
                          fDetachedSignature :BOOL;
                          cToBeSigned :DWORD;
                          rgpbToBeSigned :PBYTE;
                          rgcbToBeSigned :PDWORD;
...
type
  TclCryptVerifyMessageSignature = function(pVerifyPara :PCRYPT_VERIFY_MESSAGE_PARA;
                                     dwSignerIndex :DWORD;
                               const pbSignedBlob :PBYTE;
                                     cbSignedBlob :DWORD;
                                     pbDecoded :PBYTE;
...
type
  TclCryptGetMessageSignerCount = function(dwMsgEncodingType :DWORD;
                              const pbSignedBlob :PBYTE;
                                    cbSignedBlob :DWORD):LONG ; stdcall;
*)
//+-------------------------------------------------------------------------
...
type
  TclCryptGetMessageCertificates = function(dwMsgAndCertEncodingType :DWORD;
                                     hCryptProv :HCRYPTPROV; // passed to CertOpenStore
                                     dwFlags :DWORD;  // passed to CertOpenStore
                               const pbSignedBlob :PBYTE;
                                     cbSignedBlob :DWORD):HCERTSTORE ; stdcall;
...
type
  TclCryptVerifyDetachedMessageSignature = function (pVerifyPara :PCRYPT_VERIFY_MESSAGE_PARA;
                                             dwSignerIndex :DWORD;
                                       const pbDetachedSignBlob :PBYTE;
                                             cbDetachedSignBlob :DWORD;
                                             cToBeSigned :DWORD;
...
type
  TclCryptEncryptMessage = function (pEncryptPara :PCRYPT_ENCRYPT_MESSAGE_PARA;
                             cRecipientCert :DWORD;
                             rgpRecipientCert : PCCERT_CONTEXT;
                             const pbToBeEncrypted :PBYTE;
                             cbToBeEncrypted :DWORD;
...
type
  TclCryptDecryptMessage = function (pDecryptPara :PCRYPT_DECRYPT_MESSAGE_PARA;
                       const pbEncryptedBlob :PBYTE;
                             cbEncryptedBlob :DWORD;
                             pbDecrypted :PBYTE;
                             pcbDecrypted :PDWORD;
...
type
  TclCryptSignAndEncryptMessage = function(pSignPara :PCRYPT_SIGN_MESSAGE_PARA;
                                    pEncryptPara :PCRYPT_ENCRYPT_MESSAGE_PARA;
                                    cRecipientCert :DWORD;
                                    rgpRecipientCert :array of PCCERT_CONTEXT;
                              const pbToBeSignedAndEncrypted :PBYTE;
...
type
  TclCryptDecryptAndVerifyMessageSignature = function(pDecryptPara :PCRYPT_DECRYPT_MESSAGE_PARA;
                                               pVerifyPara :PCRYPT_VERIFY_MESSAGE_PARA;
                                               dwSignerIndex :DWORD;
                                         const pbEncryptedBlob :PBYTE;
                                               cbEncryptedBlob :DWORD;
...
type
  TclCryptDecodeMessage = function(dwMsgTypeFlags :DWORD;
                            pDecryptPara   :PCRYPT_DECRYPT_MESSAGE_PARA;
                            pVerifyPara    :PCRYPT_VERIFY_MESSAGE_PARA ;
                            dwSignerIndex  :DWORD;
                      const pbEncodedBlob  :PBYTE;
...
type
  TclCryptHashMessage = function(pHashPara :PCRYPT_HASH_MESSAGE_PARA;
                          fDetachedHash :BOOL;
                          cToBeHashed :DWORD;
                    const rgpbToBeHashed :array of PBYTE;
                          rgcbToBeHashed :array of DWORD;
...
type
  TclCryptVerifyMessageHash = function(pHashPara :PCRYPT_HASH_MESSAGE_PARA;
                                pbHashedBlob :PBYTE;
                                cbHashedBlob :DWORD;
                                pbToBeHashed :PBYTE;
                                pcbToBeHashed :PDWORD;
...
type
  TclCryptVerifyDetachedMessageHash = function (pHashPara :PCRYPT_HASH_MESSAGE_PARA;
                                        pbDetachedHashBlob :PBYTE;
                                        cbDetachedHashBlob :DWORD;
                                        cToBeHashed :DWORD;
                                        rgpbToBeHashed :array of PBYTE;
...
type
  TclCryptSignMessageWithKey = function (pSignPara :PCRYPT_KEY_SIGN_MESSAGE_PARA;
                           const pbToBeSigned :PBYTE;
                                 cbToBeSigned :DWORD;
                                 pbSignedBlob :PBYTE;
                                 pcbSignedBlob :PDWORD):BOOL ; stdcall;
...
type
  TclCryptVerifyMessageSignatureWithKey = function (pVerifyPara :PCRYPT_KEY_VERIFY_MESSAGE_PARA;
                                            pPublicKeyInfo :PCERT_PUBLIC_KEY_INFO;
                                      const pbSignedBlob :PBYTE;
                                            cbSignedBlob :DWORD;
                                            pbDecoded :PBYTE;
...
type
  TclCertOpenSystemStore = function(hProv :HCRYPTPROV;
                             szSubsystemProtocol :LPAWSTR):HCERTSTORE ; stdcall;
(*
...
type
  TclCertAddEncodedCertificateToSystemStore = function (szCertStoreName :LPAWSTR;
                                          const pbCertEncoded :PBYTE;
                                                cbCertEncoded :DWORD):BOOL ; stdcall;
...
//------------------------------------------------------------------------------
//  Implementation for dynamic binding
//------------------------------------------------------------------------------
var
  CryptInitialized: Boolean;
  CryptModule: HModule = 0;
  ADVAPIModule: HModule = 0;
  clCertOpenSystemStore: TclCertOpenSystemStore;
  clCertOpenStore: TclCertOpenStore;
  clCertCloseStore: TclCertCloseStore;
  clCertFindCertificateInStore: TclCertFindCertificateInStore;
  clCertCreateCertificateContext: TclCertCreateCertificateContext;
  clCertFreeCertificateContext: TclCertFreeCertificateContext;
  clCertDuplicateCertificateContext: TclCertDuplicateCertificateContext;
  clCertGetCertificateChain: TclCertGetCertificateChain;
  clCertVerifyCertificateChainPolicy: TclCertVerifyCertificateChainPolicy;
  clCertFreeCertificateChain: TclCertFreeCertificateChain;
  clCertEnumCertificatesInStore: TclCertEnumCertificatesInStore;
  clCertFindExtension: TclCertFindExtension;
  clCryptEncryptMessage: TclCryptEncryptMessage;
  clCryptDecryptMessage: TclCryptDecryptMessage;
  clCryptAcquireContext: TclCryptAcquireContext;
  clCryptReleaseContext: TclCryptReleaseContext;
  clCryptAcquireCertificatePrivateKey: TclCryptAcquireCertificatePrivateKey;
  clCryptDecodeObject: TclCryptDecodeObject;
  clCryptSignAndEncryptMessage: TclCryptSignAndEncryptMessage;
  clCryptVerifyDetachedMessageSignature: TclCryptVerifyDetachedMessageSignature;
  clCryptGetMessageCertificates: TclCryptGetMessageCertificates;
  clCryptVerifyMessageSignature: TclCryptVerifyMessageSignature;
  clCryptSignMessage: TclCryptSignMessage;
  clCertNameToStr: TclCertNameToStr;
  clCertGetNameString: TclCertGetNameString;
  clCertDeleteCertificateFromStore: TclCertDeleteCertificateFromStore;
  clCertGetSubjectCertificateFromStore: TclCertGetSubjectCertificateFromStore;
  clCertAddCertificateContextToStore: TclCertAddCertificateContextToStore;
  clPFXImportCertStore: TclPFXImportCertStore;
  clPFXExportCertStoreEx: TclPFXExportCertStoreEx;
  clCryptImportPublicKeyInfoEx: TclCryptImportPublicKeyInfoEx;

  clCryptGetProvParam: TclCryptGetProvParam;
  clCryptGetUserKey: TclCryptGetUserKey;
  clCryptExportKey: TclCryptExportKey;
  clCryptImportKey: TclCryptImportKey;
  clCryptDecrypt: TclCryptDecrypt;
  clCryptEncrypt: TclCryptEncrypt;

  clCryptCreateHash: TclCryptCreateHash;
  clCryptHashData: TclCryptHashData;
  clCryptDestroyHash: TclCryptDestroyHash;
  clCryptDestroyKey: TclCryptDestroyKey;
  clCryptSetHashParam: TclCryptSetHashParam;
  clCryptGetHashParam: TclCryptGetHashParam;
  clCryptSignHash: TclCryptSignHash;
  clCryptVerifySignature: TclCryptVerifySignature;
  clCryptGetDefaultProvider: TclCryptGetDefaultProvider;
  clCryptEnumProviderTypes: TclCryptEnumProviderTypes;
  clCryptEnumProviders: TclCryptEnumProviders;
  clCertStrToName: TclCertStrToName;
  clCryptExportPublicKeyInfo: TclCryptExportPublicKeyInfo;
  clCryptSignAndEncodeCertificate: TclCryptSignAndEncodeCertificate;
  clCryptGenKey: TclCryptGenKey;
  clCertSetCertificateContextProperty: TclCertSetCertificateContextProperty;
  clCertGetCertificateContextProperty: TclCertGetCertificateContextProperty;
  clCertEnumCertificateContextProperties: TclCertEnumCertificateContextProperties;

procedure LoadCryptLibrary;
var
  Buffer: array[0..255] of Char;
begin
  if (CryptModule = 0) then
  begin
    CryptModule := LoadLibrary(PChar(CRYPT32));
    if (CryptModule <= HINSTANCE_ERROR) then
    begin
  ...
  if (ADVAPIModule = 0) then
  begin
    ADVAPIModule := LoadLibrary(PChar(ADVAPI32));
    if (ADVAPIModule <= HINSTANCE_ERROR) then
    begin
      ZeroMemory(@Buffer, SizeOf(Buffer));
      FormatMessage(FORMAT_MESSAGE_FROM_SYSTEM, nil, GetLastError(), 0, Buffer, SizeOf(Buffer), nil);
      raise Exception.Create(Buffer);
...
begin
  InitCrypt();
  if not Assigned(clCryptAcquireContext) then
    @clCryptAcquireContext := clGetProcAddress(ADVAPIModule, 'CryptAcquireContextA');

  Result := clCryptAcquireContext(phProv, pszContainer, pszProvider, dwProvType, dwFlags);
end;

function CryptReleaseContext(hProv: HCRYPTPROV; dwFlags: DWORD): BOOL; stdcall;
begin
  InitCrypt();
  if not Assigned(clCryptReleaseContext) then
    @clCryptReleaseContext := clGetProcAddress(ADVAPIModule, 'CryptReleaseContext');

  Result := clCryptReleaseContext(hProv, dwFlags);
end;
...
begin
  InitCrypt();
  if not Assigned(clCryptAcquireCertificatePrivateKey) then
    @clCryptAcquireCertificatePrivateKey := clGetProcAddress(CryptModule, 'CryptAcquireCertificatePrivateKey'); //xp 2000 nt, redist for 98

  Result := clCryptAcquireCertificatePrivateKey(pCert, dwFlags, pvReserved, phCryptProv, pdwKeySpec, pfCallerFreeProv);
end;
...
begin
  InitCrypt();
  if not Assigned(clCryptGetUserKey) then
    @clCryptGetUserKey := clGetProcAddress(ADVAPIModule, 'CryptGetUserKey'); //not used

  Result := clCryptGetUserKey(hProv, dwKeySpec, phUserKey);
end;
...
begin
  InitCrypt();
  if not Assigned(clCryptGetProvParam) then
    @clCryptGetProvParam := clGetProcAddress(ADVAPIModule, 'CryptGetProvParam');

  Result := clCryptGetProvParam(hProv, dwParam, pbData, pdwDataLen, dwFlags);
end;
...
begin
  InitCrypt();
  if not Assigned(clCryptExportKey) then
    @clCryptExportKey := clGetProcAddress(ADVAPIModule, 'CryptExportKey'); //not used

  Result := clCryptExportKey(hKey, hExpKey, dwBlobType, dwFlags, pbData, pdwDataLen);
end;
...
begin
  InitCrypt();
  if not Assigned(clCryptImportKey) then
    @clCryptImportKey := clGetProcAddress(ADVAPIModule, 'CryptImportKey'); //not used

  Result := clCryptImportKey(hProv, pbData, dwDataLen, hPubKey, dwFlags, phKey);
end;
...
begin
  InitCrypt();
  if not Assigned(clCryptDecrypt) then
    @clCryptDecrypt := clGetProcAddress(ADVAPIModule, 'CryptDecrypt'); //not used

  Result := clCryptDecrypt(hKey, hHash, Final, dwFlags, pbData, pdwDataLen);
end;
...
begin
  InitCrypt();
  if not Assigned(clCryptEncrypt) then
    @clCryptEncrypt := clGetProcAddress(ADVAPIModule, 'CryptEncrypt'); //not used

  Result := clCryptEncrypt(hKey, hHash, Final, dwFlags, pbData, pdwDataLen, dwBufLen);
end;
...
begin
  InitCrypt();
  if not Assigned(clCryptCreateHash) then
    @clCryptCreateHash := clGetProcAddress(ADVAPIModule, 'CryptCreateHash');

  Result := clCryptCreateHash(hProv, Algid, hKey, dwFlags, phHash);
end;
...
begin
  InitCrypt();
  if not Assigned(clCryptHashData) then
    @clCryptHashData := clGetProcAddress(ADVAPIModule, 'CryptHashData');

  Result := clCryptHashData(hHash, pbData, dwDataLen, dwFlags);
end;

function CryptDestroyHash(hHash :HCRYPTHASH) :BOOL;stdcall;
begin
  InitCrypt();
  if not Assigned(clCryptDestroyHash) then
    @clCryptDestroyHash := clGetProcAddress(ADVAPIModule, 'CryptDestroyHash');

  Result := clCryptDestroyHash(hHash);
end;

function CryptDestroyKey(hKey  :HCRYPTKEY) :BOOL;stdcall ;
begin
  InitCrypt();
  if not Assigned(clCryptDestroyKey) then
    @clCryptDestroyKey := clGetProcAddress(ADVAPIModule, 'CryptDestroyKey');

  Result := clCryptDestroyKey(hKey);
end;
...
begin
  InitCrypt();
  if not Assigned(clCryptSetHashParam) then
    @clCryptSetHashParam := clGetProcAddress(ADVAPIModule, 'CryptSetHashParam'); //not used

  Result := clCryptSetHashParam(hHash, dwParam, pbData, dwFlags);
end;
...
begin
  InitCrypt();
  if not Assigned(clCryptGetHashParam) then
    @clCryptGetHashParam := clGetProcAddress(ADVAPIModule, 'CryptGetHashParam');

  Result := clCryptGetHashParam(hHash, dwParam, pbData, pdwDataLen, dwFlags);
end;
...
begin
  InitCrypt();
  if not Assigned(clCryptSignHash) then
    @clCryptSignHash := clGetProcAddress(ADVAPIModule, 'CryptSignHashA');

  Result := clCryptSignHash(hHash, dwKeySpec, sDescription, dwFlags, pbSignature, pdwSigLen);
end;
...
begin
  InitCrypt();
  if not Assigned(clCryptVerifySignature) then
    @clCryptVerifySignature := clGetProcAddress(ADVAPIModule, 'CryptVerifySignatureA');

  Result := clCryptVerifySignature(hHash, pbSignature, dwSigLen, hPubKey, sDescription, dwFlags);
end;
...
begin
  InitCrypt();
  if not Assigned(clCryptGetDefaultProvider) then
    @clCryptGetDefaultProvider := clGetProcAddress(ADVAPIModule, 'CryptGetDefaultProviderA'); //not used

  Result := clCryptGetDefaultProvider(dwProvType, pdwReserved, dwFlags, pszProvName, pcbProvName);
end;
...
begin
  InitCrypt();
  if not Assigned(clCryptEnumProviderTypes) then
    @clCryptEnumProviderTypes := clGetProcAddress(ADVAPIModule, 'CryptEnumProviderTypesA');

  Result := clCryptEnumProviderTypes(dwIndex, pdwReserved, dwFlags, pdwProvType, pszTypeName, pcbTypeName);
end;
...
begin
  InitCrypt();
  if not Assigned(clCryptEnumProviders) then
    @clCryptEnumProviders := clGetProcAddress(ADVAPIModule, 'CryptEnumProvidersA'); //not used

  Result := clCryptEnumProviders(dwIndex, pdwReserved, dwFlags, pdwProvType, pszProvName, pcbProvName);
end;
...
begin
  InitCrypt();
  if not Assigned(clCertFindCertificateInStore) then
    @clCertFindCertificateInStore := clGetProcAddress(CryptModule, 'CertFindCertificateInStore'); //not used

  Result := clCertFindCertificateInStore(hCertStore, dwCertEncodingType, dwFindFlags, dwFindType, pvFindPara, pPrevCertContext);
end;
...
begin
  InitCrypt();
  if not Assigned(clCertEnumCertificatesInStore) then
    @clCertEnumCertificatesInStore := clGetProcAddress(CryptModule, 'CertEnumCertificatesInStore');

  Result := clCertEnumCertificatesInStore(hCertStore, pPrevCertContext);
end;
...
begin
  InitCrypt();
  if not Assigned(clCertCreateCertificateContext) then
    @clCertCreateCertificateContext := clGetProcAddress(CryptModule, 'CertCreateCertificateContext');

  Result := clCertCreateCertificateContext(dwCertEncodingType, pbCertEncoded, cbCertEncoded);
end;

function CertFreeCertificateContext(pCertContext :PCCERT_CONTEXT):BOOL ; stdcall;
begin
  InitCrypt();
  if not Assigned(clCertFreeCertificateContext) then
    @clCertFreeCertificateContext := clGetProcAddress(CryptModule, 'CertFreeCertificateContext');

  Result := clCertFreeCertificateContext(pCertContext);
end;

function CertDuplicateCertificateContext(pCertContext :PCCERT_CONTEXT):PCCERT_CONTEXT ; stdcall;
begin
  InitCrypt();
  if not Assigned(clCertDuplicateCertificateContext) then
    @clCertDuplicateCertificateContext := clGetProcAddress(CryptModule, 'CertDuplicateCertificateContext');

  Result := clCertDuplicateCertificateContext(pCertContext);
end;
...
begin
  InitCrypt();
  if not Assigned(clCryptDecodeObject) then
    @clCryptDecodeObject := clGetProcAddress(CryptModule, 'CryptDecodeObject');

  Result := clCryptDecodeObject(dwCertEncodingType, lpszStructType,
...
begin
  InitCrypt();
  if not Assigned(clCertGetCertificateChain) then
    @clCertGetCertificateChain := clGetProcAddress(CryptModule, 'CertGetCertificateChain'); //xp 2000 nt, redist for 98

  Result := clCertGetCertificateChain(hChainEngine, pCertContext, pTime,
...
begin
  InitCrypt();
  if not Assigned(clCertVerifyCertificateChainPolicy) then
    @clCertVerifyCertificateChainPolicy := clGetProcAddress(CryptModule, 'CertVerifyCertificateChainPolicy'); //xp 2000 nt, redist for 98

  Result := clCertVerifyCertificateChainPolicy(pszPolicyOID, pChainContext, pPolicyPara, pPolicyStatus);
end;
...
begin
  InitCrypt();
  if not Assigned(clCertFreeCertificateChain) then
    @clCertFreeCertificateChain := clGetProcAddress(CryptModule, 'CertFreeCertificateChain');//xp 2000 nt, redist for 98

  clCertFreeCertificateChain(pChainContext);
end;
...
begin
  InitCrypt();
  if not Assigned(clCertFindExtension) then
    @clCertFindExtension := clGetProcAddress(CryptModule, 'CertFindExtension');

  Result := clCertFindExtension(pszObjId, cExtensions, rgExtensions);
end;
...
begin
  InitCrypt();
  if not Assigned(clCryptImportPublicKeyInfoEx) then
    @clCryptImportPublicKeyInfoEx := clGetProcAddress(CryptModule, 'CryptImportPublicKeyInfoEx');

  Result := clCryptImportPublicKeyInfoEx(hCryptProv, dwCertEncodingType, pInfo, aiKeyAlg, dwFlags, pvAuxInfo, phKey);
end;
...
begin
  InitCrypt();
  if not Assigned(clCryptEncryptMessage) then
    @clCryptEncryptMessage := clGetProcAddress(CryptModule, 'CryptEncryptMessage');

  Result := clCryptEncryptMessage(pEncryptPara, cRecipientCert, rgpRecipientCert,
...
begin
  InitCrypt();
  if not Assigned(clCryptDecryptMessage) then
    @clCryptDecryptMessage := clGetProcAddress(CryptModule, 'CryptDecryptMessage');

  Result := clCryptDecryptMessage(pDecryptPara, pbEncryptedBlob, cbEncryptedBlob, pbDecrypted, pcbDecrypted, ppXchgCert);
end;
...
begin
  InitCrypt();
  if not Assigned(clCertOpenSystemStore) then
    @clCertOpenSystemStore := clGetProcAddress(CryptModule, 'CertOpenSystemStoreA');

  Result := clCertOpenSystemStore(hProv, szSubsystemProtocol);
end;
...
begin
  InitCrypt();
  if not Assigned(clCertOpenStore) then
    @clCertOpenStore := clGetProcAddress(CryptModule, 'CertOpenStore');

  Result := clCertOpenStore(lpszStoreProvider, dwEncodingType, hCryptProv, dwFlags, pvPara);
end;

function CertCloseStore(hCertStore: HCERTSTORE; dwFlags: DWORD):BOOL ; stdcall;
begin
  InitCrypt();
  if not Assigned(clCertCloseStore) then
    @clCertCloseStore  := clGetProcAddress(CryptModule, 'CertCloseStore');

  Result := clCertCloseStore(hCertStore, dwFlags);
end;
...
begin
  InitCrypt();
  if not Assigned(clCryptSignAndEncryptMessage) then
    @clCryptSignAndEncryptMessage := clGetProcAddress(CryptModule, 'CryptSignAndEncryptMessage'); //not used

  Result := clCryptSignAndEncryptMessage(pSignPara, pEncryptPara,
                                    cRecipientCert, rgpRecipientCert,
                                    pbToBeSignedAndEncrypted, cbToBeSignedAndEncrypted,
                                    pbSignedAndEncryptedBlob, pcbSignedAndEncryptedBlob);
end;
...
begin
  InitCrypt();
  if not Assigned(clCryptVerifyDetachedMessageSignature) then
    @clCryptVerifyDetachedMessageSignature := clGetProcAddress(CryptModule, 'CryptVerifyDetachedMessageSignature');

  Result := clCryptVerifyDetachedMessageSignature(pVerifyPara, dwSignerIndex,
                                             pbDetachedSignBlob, cbDetachedSignBlob,
                                             cToBeSigned, rgpbToBeSigned,
...
begin
  InitCrypt();
  if not Assigned(clCryptGetMessageCertificates) then
    @clCryptGetMessageCertificates := clGetProcAddress(CryptModule, 'CryptGetMessageCertificates');

  Result := clCryptGetMessageCertificates(dwMsgAndCertEncodingType, hCryptProv,
...
begin
  InitCrypt();
  if not Assigned(clCryptVerifyMessageSignature) then
    @clCryptVerifyMessageSignature := clGetProcAddress(CryptModule, 'CryptVerifyMessageSignature');

  Result := clCryptVerifyMessageSignature(pVerifyPara, dwSignerIndex,
...
begin
  InitCrypt();
  if not Assigned(clCryptSignMessage) then
    @clCryptSignMessage := clGetProcAddress(CryptModule, 'CryptSignMessage');

  Result := clCryptSignMessage(pSignPara, fDetachedSignature,
                          cToBeSigned, rgpbToBeSigned,
                          rgcbToBeSigned, pbSignedBlob, pcbSignedBlob);
end;
...
begin
  InitCrypt();
  if not Assigned(clCertNameToStr) then
    @clCertNameToStr := clGetProcAddress(CryptModule, 'CertNameToStrA'); //not used

  Result := clCertNameToStr(dwCertEncodingType,
                       pName, dwStrType, psz, csz);
end;
...
begin
  InitCrypt();
  if not Assigned(clCertGetNameString) then
    @clCertGetNameString := clGetProcAddress(CryptModule, 'CertGetNameStringA');

  Result := clCertGetNameString(pCertContext, dwType, dwFlags,
...
begin
  InitCrypt();
  if not Assigned(clCertDeleteCertificateFromStore) then
    @clCertDeleteCertificateFromStore := clGetProcAddress(CryptModule, 'CertDeleteCertificateFromStore');

  Result := clCertDeleteCertificateFromStore(pCertContext);
end;
...
begin
  InitCrypt();
  if not Assigned(clCertGetSubjectCertificateFromStore) then
    @clCertGetSubjectCertificateFromStore := clGetProcAddress(CryptModule, 'CertGetSubjectCertificateFromStore');

  Result := clCertGetSubjectCertificateFromStore(hCertStore, dwCertEncodingType, pCertId);
end;
...
begin
  InitCrypt();
  if not Assigned(clCertAddCertificateContextToStore) then
    @clCertAddCertificateContextToStore := clGetProcAddress(CryptModule, 'CertAddCertificateContextToStore');

  Result := clCertAddCertificateContextToStore(hCertStore,
                                          pCertContext, dwAddDisposition, ppStoreContext);
end;

function PFXImportCertStore(pPFX: PCRYPT_DATA_BLOB;
  szPassword: PWideChar; dwFlags: DWORD): HCERTSTORE; stdcall;
begin
  InitCrypt();
  if not Assigned(clPFXImportCertStore) then
    @clPFXImportCertStore := clGetProcAddress(CryptModule, 'PFXImportCertStore'); //xp 2000

  Result := clPFXImportCertStore(pPFX, szPassword, dwFlags);
end;

function PFXExportCertStoreEx(hStore: HCERTSTORE;
  pPFX: PCRYPT_DATA_BLOB; szPassword: PWideChar; pvReserved: Pointer; dwFlags: DWORD): BOOL; stdcall;
begin
  InitCrypt();
  if not Assigned(clPFXExportCertStoreEx) then
    @clPFXExportCertStoreEx := clGetProcAddress(CryptModule, 'PFXExportCertStoreEx'); //xp 2000

  Result := clPFXExportCertStoreEx(hStore, pPFX, szPassword, pvReserved, dwFlags);
end;
...
begin
  InitCrypt();
  if not Assigned(clCertStrToName) then
    @clCertStrToName := clGetProcAddress(CryptModule, 'CertStrToNameA');

  Result := clCertStrToName(dwCertEncodingType, pszX500, dwStrType, pvReserved, pbEncoded, pcbEncoded, ppszError);
end;
...
begin
  InitCrypt();
  if not Assigned(clCryptExportPublicKeyInfo) then
    @clCryptExportPublicKeyInfo := clGetProcAddress(CryptModule, 'CryptExportPublicKeyInfo');

  Result := clCryptExportPublicKeyInfo(hCryptProv, dwKeySpec, dwCertEncodingType, pInfo, pcbInfo);
end;
...
begin
  InitCrypt();
  if not Assigned(clCryptSignAndEncodeCertificate) then
    @clCryptSignAndEncodeCertificate := clGetProcAddress(CryptModule, 'CryptSignAndEncodeCertificate');

  Result := clCryptSignAndEncodeCertificate(hCryptProv, dwKeySpec, dwCertEncodingType, lpszStructType,
    pvStructInfo, pSignatureAlgorithm, pvHashAuxInfo, pbEncoded, pcbEncoded);
end;
...
begin
  InitCrypt();
  if not Assigned(clCryptGenKey) then
    @clCryptGenKey := clGetProcAddress(ADVAPIModule, 'CryptGenKey');

  Result := clCryptGenKey(hProv, Algid, dwFlags, phKey);
end;
...
begin
  InitCrypt();
  if not Assigned(clCertSetCertificateContextProperty) then
    @clCertSetCertificateContextProperty := clGetProcAddress(CryptModule, 'CertSetCertificateContextProperty');

  Result := clCertSetCertificateContextProperty(pCertContext, dwPropId, dwFlags, pvData);
end;
...
begin
  InitCrypt();
  if not Assigned(clCertGetCertificateContextProperty) then
    @clCertGetCertificateContextProperty := clGetProcAddress(CryptModule, 'CertGetCertificateContextProperty');

  Result := clCertGetCertificateContextProperty(pCertContext, dwPropId, pvData, pcbData);
end;
...
begin
  InitCrypt();
  if not Assigned(clCertEnumCertificateContextProperties) then
    @clCertEnumCertificateContextProperties := clGetProcAddress(CryptModule, 'CertEnumCertificateContextProperties');

  Result := clCertEnumCertificateContextProperties(pCertContext, dwPropId);
end;
