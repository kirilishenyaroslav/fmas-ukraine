...
type
  TclHttpOpenRequest = function (hConnect: HINTERNET; lpszVerb: PChar;
  lpszObjectName: PChar; lpszVersion: PChar; lpszReferrer: PChar;
  lplpszAcceptTypes: PLPSTR; dwFlags: DWORD;
  dwContext: DWORD): HINTERNET; stdcall;
...
type
  TclHttpAddRequestHeaders = function (hRequest: HINTERNET; lpszHeaders: PChar;
  dwHeadersLength: DWORD; dwModifiers: DWORD): BOOL; stdcall;
  {$EXTERNALSYM HttpAddRequestHeaders}
...
type
  TclHttpSendRequest = function (hRequest: HINTERNET; lpszHeaders: PChar; 
  dwHeadersLength: DWORD; lpOptional: Pointer;
  dwOptionalLength: DWORD): BOOL; stdcall;
...
type
  TclHttpSendRequestEx = function (hRequest: HINTERNET; lpBuffersIn: PInternetBuffers;
    lpBuffersOut: PInternetBuffers;
    dwFlags: DWORD; dwContext: DWORD): BOOL; stdcall;
...
type
  TclHttpEndRequest = function (hRequest: HINTERNET;
  lpBuffersOut: PInternetBuffers; dwFlags: DWORD;
  dwContext: DWORD): BOOL; stdcall;
...
type
  TclHttpQueryInfo = function (hRequest: HINTERNET; dwInfoLevel: DWORD;
  lpvBuffer: Pointer; var lpdwBufferLength: DWORD;
  var lpdwReserved: DWORD): BOOL; stdcall;
...
type
  TclInternetSetCookie = function (lpszUrl, lpszCookieName,
  lpszCookieData: PChar): BOOL; stdcall;
...
type
  TclInternetGetCookie = function (lpszUrl, lpszCookieName,
  lpszCookieData: PChar; var lpdwSize: DWORD): BOOL; stdcall;
...
type
  TclInternetErrorDlg = function (hWnd: HWND; hRequest: HINTERNET;
  dwError, dwFlags: DWORD; var lppvData: Pointer): DWORD; stdcall;
...
*)
function RetrieveUrlCacheEntryStream(lpszUrlName: PChar;
  var lpCacheEntryInfo: TInternetCacheEntryInfo;
...
type
  TclRetrieveUrlCacheEntryStream = function (lpszUrlName: PChar;
    var lpCacheEntryInfo: TInternetCacheEntryInfo;
    var lpdwCacheEntryInfoBufferSize: DWORD; fRandomRead: BOOL;
    dwReserved: DWORD): THandle; stdcall;
...
type
  TclReadUrlCacheEntryStream = function (hUrlCacheStream: THandle;
    dwLocation: DWORD; lpBuffer: Pointer;
    var lpdwLen: DWORD; Reserved: DWORD): BOOL; stdcall;
...
type
  TclUnlockUrlCacheEntryStream = function (hUrlCacheStream: THandle;
    Reserved: DWORD): BOOL; stdcall;

function GetUrlCacheEntryInfo(lpszUrlName: PChar;
  var lpCacheEntryInfo: TInternetCacheEntryInfo;
  var lpdwCacheEntryInfoBufferSize: DWORD): BOOL; stdcall;
  {$EXTERNALSYM GetUrlCacheEntryInfo}

type
  TclGetUrlCacheEntryInfo = function (lpszUrlName: PChar;
    var lpCacheEntryInfo: TInternetCacheEntryInfo;
    var lpdwCacheEntryInfoBufferSize: DWORD): BOOL; stdcall;
...
type
  TclFindFirstUrlCacheEntry = function (lpszUrlSearchPattern: PChar;
    var lpFirstCacheEntryInfo: TInternetCacheEntryInfo;
    var lpdwFirstCacheEntryInfoBufferSize: DWORD): THandle; stdcall;
...
type
  TclFindNextUrlCacheEntry = function (hEnumHandle: THandle;
    var lpNextCacheEntryInfo: TInternetCacheEntryInfo;
    var lpdwNextCacheEntryInfoBufferSize: DWORD): BOOL; stdcall;
...
type
  TclFindCloseUrlCache = function (hEnumHandle: THandle): BOOL; stdcall;

function DeleteUrlCacheEntry(lpszUrlName: LPCSTR): BOOL; stdcall;
  {$EXTERNALSYM DeleteUrlCacheEntry}

type
  TclDeleteUrlCacheEntry = function (lpszUrlName: LPCSTR): BOOL; stdcall;
...
//------------------------------------------------------------------------------
var
  WinInetInitialized: Boolean;
  WinInetModule: HModule = 0;
  clInternetCrackUrl: TclInternetCrackUrl;
  clInternetCreateUrl: TclInternetCreateUrl;
  clInternetCanonicalizeUrl: TclInternetCanonicalizeUrl;
  clInternetCombineUrl: TclInternetCombineUrl;
  clInternetOpen: TclInternetOpen;
  clInternetCloseHandle: TclInternetCloseHandle;
  clInternetConnect: TclInternetConnect;
  clInternetOpenUrl: TclInternetOpenUrl;
  clInternetReadFile: TclInternetReadFile;
  clInternetQueryOption: TclInternetQueryOption;
  clInternetSetOption: TclInternetSetOption;
  clInternetGetLastResponseInfo: TclInternetGetLastResponseInfo;
  clFtpFindFirstFile: TclFtpFindFirstFile;
  clFtpOpenFile: TclFtpOpenFile;
  clFtpCreateDirectory: TclFtpCreateDirectory;
  clFtpRemoveDirectory: TclFtpRemoveDirectory;
  clInternetFindNextFile: TclInternetFindNextFile;
  clFtpGetFileSize: TclFtpGetFileSize;
  clHttpOpenRequest: TclHttpOpenRequest;
  clHttpAddRequestHeaders: TclHttpAddRequestHeaders;
  clHttpSendRequest: TclHttpSendRequest;
  clHttpSendRequestEx: TclHttpSendRequestEx;
  clHttpEndRequest: TclHttpEndRequest;
  clHttpQueryInfo: TclHttpQueryInfo;
  clInternetErrorDlg: TclInternetErrorDlg;
  clInternetWriteFile: TclInternetWriteFile;
  clInternetSetFilePointer: TclInternetSetFilePointer;
  clFtpDeleteFile: TclFtpDeleteFile;
  clInternetGetCookie: TclInternetGetCookie;
  clInternetSetCookie: TclInternetSetCookie;
  clInternetSetStatusCallback: TclInternetSetStatusCallback;
  clFindFirstUrlCacheEntry: TclFindFirstUrlCacheEntry;
  clGetUrlCacheEntryInfo: TclGetUrlCacheEntryInfo;
  clRetrieveUrlCacheEntryStream: TclRetrieveUrlCacheEntryStream;
  clReadUrlCacheEntryStream: TclReadUrlCacheEntryStream;
  clUnlockUrlCacheEntryStream: TclUnlockUrlCacheEntryStream;
  clFindNextUrlCacheEntry: TclFindNextUrlCacheEntry;
  clFindCloseUrlCache: TclFindCloseUrlCache;
  clDeleteUrlCacheEntry: TclDeleteUrlCacheEntry;

procedure LoadWinInetLibrary;
var
  Buffer: array[0..255] of Char;
begin
  if (WinInetModule = 0) then
  begin
    WinInetModule := LoadLibrary('wininet.dll');
    if (WinInetModule <= HINSTANCE_ERROR) then
    begin
...
procedure FreeWinInetLibrary;
begin
  if (WinInetModule > HINSTANCE_ERROR) then
  begin
    FreeLibrary(WinInetModule);
    WinInetModule := 0;
    WinInetInitialized := False;
  end;
end;
...
procedure GetWinInetProcAddresses;
begin
  @clInternetCrackUrl := clGetProcAddress(WinInetModule, 'InternetCrackUrlA');
  @clInternetCreateUrl := clGetProcAddress(WinInetModule, 'InternetCreateUrlA');
  @clInternetCanonicalizeUrl := clGetProcAddress(WinInetModule, 'InternetCanonicalizeUrlA');
  @clInternetCombineUrl := clGetProcAddress(WinInetModule, 'InternetCombineUrlA');
  @clInternetOpen := clGetProcAddress(WinInetModule, 'InternetOpenA');
  @clInternetCloseHandle := clGetProcAddress(WinInetModule, 'InternetCloseHandle');
  @clInternetConnect := clGetProcAddress(WinInetModule, 'InternetConnectA');
  @clInternetOpenUrl := clGetProcAddress(WinInetModule, 'InternetOpenUrlA');
  @clInternetReadFile := clGetProcAddress(WinInetModule, 'InternetReadFile');
  @clInternetQueryOption := clGetProcAddress(WinInetModule, 'InternetQueryOptionA');
  @clInternetSetOption := clGetProcAddress(WinInetModule, 'InternetSetOptionA');
  @clInternetGetLastResponseInfo := clGetProcAddress(WinInetModule, 'InternetGetLastResponseInfoA');
  @clFtpFindFirstFile := clGetProcAddress(WinInetModule, 'FtpFindFirstFileA');
  @clFtpOpenFile := clGetProcAddress(WinInetModule, 'FtpOpenFileA');
  @clFtpCreateDirectory := clGetProcAddress(WinInetModule, 'FtpCreateDirectoryA');
  @clFtpRemoveDirectory := clGetProcAddress(WinInetModule, 'FtpRemoveDirectoryA');
  @clInternetFindNextFile := clGetProcAddress(WinInetModule, 'InternetFindNextFileA');
  @clFtpGetFileSize := clGetProcAddress(WinInetModule, 'FtpGetFileSize');
  @clHttpOpenRequest := clGetProcAddress(WinInetModule, 'HttpOpenRequestA');
  @clHttpAddRequestHeaders := clGetProcAddress(WinInetModule, 'HttpAddRequestHeadersA');
  @clHttpSendRequest := clGetProcAddress(WinInetModule, 'HttpSendRequestA');
  @clHttpSendRequestEx := clGetProcAddress(WinInetModule, 'HttpSendRequestExA');
  @clHttpEndRequest := clGetProcAddress(WinInetModule, 'HttpEndRequestA');
  @clHttpQueryInfo := clGetProcAddress(WinInetModule, 'HttpQueryInfoA');
  @clInternetErrorDlg := clGetProcAddress(WinInetModule, 'InternetErrorDlg');
  @clInternetWriteFile := clGetProcAddress(WinInetModule, 'InternetWriteFile');
  @clInternetSetFilePointer := clGetProcAddress(WinInetModule, 'InternetSetFilePointer');
  @clFtpDeleteFile := clGetProcAddress(WinInetModule, 'FtpDeleteFileA');
  @clInternetGetCookie := clGetProcAddress(WinInetModule, 'InternetGetCookieA');
  @clInternetSetCookie := clGetProcAddress(WinInetModule, 'InternetSetCookieA');
  @clInternetSetStatusCallback := clGetProcAddress(WinInetModule, 'InternetSetStatusCallback');
  @clFindFirstUrlCacheEntry := clGetProcAddress(WinInetModule, 'FindFirstUrlCacheEntryA');
  @clGetUrlCacheEntryInfo := clGetProcAddress(WinInetModule, 'GetUrlCacheEntryInfoA');
  @clRetrieveUrlCacheEntryStream := clGetProcAddress(WinInetModule, 'RetrieveUrlCacheEntryStreamA');
  @clReadUrlCacheEntryStream := clGetProcAddress(WinInetModule, 'ReadUrlCacheEntryStream');
  @clUnlockUrlCacheEntryStream := clGetProcAddress(WinInetModule, 'UnlockUrlCacheEntryStream');
  @clFindNextUrlCacheEntry := clGetProcAddress(WinInetModule, 'FindNextUrlCacheEntryA');
  @clFindCloseUrlCache := clGetProcAddress(WinInetModule, 'FindCloseUrlCache');
  @clDeleteUrlCacheEntry := clGetProcAddress(WinInetModule, 'DeleteUrlCacheEntry');
end;

procedure InitWinInet;
begin
  if not WinInetInitialized then
  begin
    WinInetModule := 0;
    LoadWinInetLibrary();
    GetWinInetProcAddresses();
    WinInetInitialized := True;
  end;
end;
...
begin
  InitWinInet();
  Result := clInternetCrackUrl(lpszUrl, dwUrlLength, dwFlags, lpUrlComponents);
end;
...
begin
  InitWinInet();
  Result := clInternetCreateUrl(lpUrlComponents, dwFlags, lpszUrl, dwUrlLength);
end;

function InternetCanonicalizeUrl(lpszUrl: PChar; lpszBuffer: PChar;
  var lpdwBufferLength: DWORD; dwFlags: DWORD): BOOL; stdcall;
begin
  InitWinInet();
  Result := clInternetCanonicalizeUrl(lpszUrl, lpszBuffer, lpdwBufferLength, dwFlags);
end;
...
begin
  InitWinInet();
  Result := clInternetCombineUrl(lpszBaseUrl, lpszRelativeUrl, lpszBuffer, lpdwBufferLength, dwFlags);
end;
...
begin
  InitWinInet();
  Result := clInternetOpen(lpszAgent, dwAccessType, lpszProxy, lpszProxyBypass, dwFlags);
end;

function InternetCloseHandle(hInet: HINTERNET): BOOL; stdcall;
begin
  InitWinInet();
  Result := clInternetCloseHandle(hInet);
end;
...
begin
  InitWinInet();
  Result := clFindFirstUrlCacheEntry(lpszUrlSearchPattern, lpFirstCacheEntryInfo,
...
begin
  InitWinInet();
  Result := clGetUrlCacheEntryInfo(lpszUrlName, lpCacheEntryInfo,
...
begin
  InitWinInet();
  Result := clRetrieveUrlCacheEntryStream(lpszUrlName, lpCacheEntryInfo,
...
begin
  InitWinInet();
  Result := clReadUrlCacheEntryStream(hUrlCacheStream, dwLocation,
    lpBuffer, lpdwLen, Reserved);
end;
...
begin
  InitWinInet();
  Result := clUnlockUrlCacheEntryStream(hUrlCacheStream, Reserved);
end;
...
begin
  InitWinInet();
  Result := clFindNextUrlCacheEntry(hEnumHandle, lpNextCacheEntryInfo,
...
begin
  InitWinInet();
  Result := clFindCloseUrlCache(hEnumHandle);
end;

function DeleteUrlCacheEntry(lpszUrlName: LPCSTR): BOOL; stdcall;
begin
  InitWinInet();
  Result := clDeleteUrlCacheEntry(lpszUrlName);
end;
...
begin
  InitWinInet();
  Result := clInternetConnect(hInet, lpszServerName, nServerPort, lpszUsername, lpszPassword,
...
begin
  InitWinInet();
  Result := clInternetOpenUrl(hInet, lpszUrl, lpszHeaders, dwHeadersLength, dwFlags, dwContext);
end;
...
begin
  InitWinInet();
  Result := clInternetReadFile(hFile, lpBuffer, dwNumberOfBytesToRead, lpdwNumberOfBytesRead);
end;
...
begin
  InitWinInet();
  Result := clInternetQueryOption(hInet, dwOption, lpBuffer, lpdwBufferLength);
end;
...
begin
  InitWinInet();
  Result := clInternetSetOption(hInet, dwOption, lpBuffer, dwBufferLength);
end;
...
begin
  InitWinInet();
  Result := clInternetGetLastResponseInfo(lpdwError, lpszBuffer, lpdwBufferLength);
end;
...
begin
  InitWinInet();
  Result := clInternetSetStatusCallback(hInet, lpfnInternetCallback);
end;
...
begin
  InitWinInet();
  Result := clFtpFindFirstFile(hConnect, lpszSearchFile, lpFindFileData, dwFlags, dwContext);
end;
...
begin
  InitWinInet();
  Result := clFtpOpenFile(hConnect, lpszFileName, dwAccess, dwFlags, dwContext);
end;

function FtpCreateDirectory(hConnect: HINTERNET; lpszDirectory: PChar): BOOL; stdcall;
begin
  InitWinInet();
  Result := clFtpCreateDirectory(hConnect, lpszDirectory);
end;

function FtpRemoveDirectory(hConnect: HINTERNET; lpszDirectory: PChar): BOOL; stdcall;
begin
  InitWinInet();
  Result := clFtpRemoveDirectory(hConnect, lpszDirectory);
end;

function FtpGetFileSize(hFile: HINTERNET; lpdwFileSizeHigh: LPDWORD): DWORD; stdcall;
begin
  InitWinInet();
  Result := clFtpGetFileSize(hFile, lpdwFileSizeHigh);
end;
...
begin
  InitWinInet();
  Result := clHttpOpenRequest(hConnect, lpszVerb, lpszObjectName, lpszVersion, lpszReferrer,
...
begin
  InitWinInet();
  Result := clHttpAddRequestHeaders(hRequest, lpszHeaders, dwHeadersLength, dwModifiers);
end;
...
begin
  InitWinInet();
  Result := clHttpSendRequest(hRequest, lpszHeaders, dwHeadersLength, lpOptional, dwOptionalLength);
end;
...
begin
  InitWinInet();
  Result := clHttpSendRequestEx(hRequest, lpBuffersIn, lpBuffersOut, dwFlags, dwContext);
end;
...
begin
  InitWinInet();
  Result := clHttpEndRequest(hRequest, lpBuffersOut, dwFlags, dwContext);
end;
...
begin
  InitWinInet();
  Result := clHttpQueryInfo(hRequest, dwInfoLevel, lpvBuffer, lpdwBufferLength, lpdwReserved);
end;
...
begin
  InitWinInet();
  Result := clInternetSetCookie(lpszUrl, lpszCookieName, lpszCookieData);
end;
...
begin
  InitWinInet();
  Result := clInternetGetCookie(lpszUrl, lpszCookieName, lpszCookieData, lpdwSize);
end;
...
begin
  InitWinInet();
  Result := clInternetErrorDlg(hWnd, hRequest, dwError, dwFlags, lppvData);
end;
...
begin
  InitWinInet();
  Result := clInternetWriteFile(hFile, lpBuffer, dwNumberOfBytesToWrite, lpdwNumberOfBytesWritten);
end;

function InternetFindNextFile(hFind: HINTERNET; lpvFindData: Pointer): BOOL; stdcall;
begin
  InitWinInet();
  Result := clInternetFindNextFile(hFind, lpvFindData);
end;
...
begin
  InitWinInet();
  Result := clInternetSetFilePointer(hFile, lDistanceToMove, pReserved, dwMoveMethod, dwContext);
end;

function FtpDeleteFile(hConnect: HINTERNET; lpszFileName: PChar): BOOL; stdcall;
begin
  InitWinInet();
  Result := clFtpDeleteFile(hConnect, lpszFileName);
end;
