unit PeopleComandiriovki_Ctrl_DM;
...
type
  ...
  public
    constructor Create(AOwner:TComponent;DB_Handle:TISC_DB_HANDLE;Parameter:TZPeopleComandirovParameters;Is_Grant: TZChildSystems);reintroduce;
  end;
...
constructor TDMWorkMode_Ctrl.Create(AOwner:TComponent;DB_Handle:TISC_DB_HANDLE;Parameter:TZPeopleComandirovParameters;Is_Grant: TZChildSystems);
begin
