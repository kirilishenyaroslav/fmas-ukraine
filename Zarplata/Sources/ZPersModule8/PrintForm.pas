...
procedure TfrmPrint.SetParams(IdPersDoc, IdM, IdTpSt:Integer; Handl:TISC_DB_HANDLE);
begin
...
function TfrmPrint.GetHandle:TISC_DB_HANDLE;
begin
    Result:=Self.DBHandle;
end;

procedure TfrmPrint.RBManClick(Sender: TObject);
begin
...
procedure TfrmPrint.RBStajClick(Sender: TObject);
begin
...
procedure TfrmPrint.ActCancelExecute(Sender: TObject);
begin
    Close;
end;

procedure TfrmPrint.cxBManEditPropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
var result : Variant;
begin
   try
...
procedure TfrmPrint.RBAllClick(Sender: TObject);
begin
...
procedure TfrmPrint.ActOkExecute(Sender: TObject);
var ID:Integer;
    lev:Integer;
begin
   try
