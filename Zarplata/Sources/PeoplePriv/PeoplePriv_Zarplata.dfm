object FZPeoplePriv: TFZPeoplePriv
  Left = 43
  Top = 137
  Width = 725
  Height = 356
  Caption = 'FZPeoplePriv'
  Color = clBtnFace
  ...
  object Grid_FIO: TcxGrid
    ...
    TabOrder = 0
    object Grid_FIODBTableView1: TcxGridDBTableView
      OnKeyPress = Grid_FIODBTableView1KeyPress
      DataController.DataSource = DSource_FIO
      DataController.Filter.Criteria = {FFFFFFFF0000000000}
      DataController.Summary.DefaultGroupSummaryItems = <>
      DataController.Summary.FooterSummaryItems = <>
      DataController.Summary.SummaryGroups = <>
      NavigatorButtons.ConfirmDelete = False
      OnFocusedRecordChanged = Grid_FIODBTableView1FocusedRecordChanged
      OptionsBehavior.IncSearch = True
      OptionsBehavior.IncSearchItem = Grid_FIO_ColumnFIO
      ...
      object Grid_FIO_ColumnTn: TcxGridDBColumn
      ...
      object Grid_FIO_ColumnFIO: TcxGridDBColumn
        PropertiesClassName = 'TcxTextEditProperties'
        Properties.Alignment.Vert = taVCenter
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
    ...
    object Grid_FIOLevel1: TcxGridLevel
      GridView = Grid_FIODBTableView1
    end
  end
  object Pages: TPageControl
    ...
    Width = 452
    Height = 272
    ActivePage = Page_IdMan
    Align = alClient
    TabOrder = 5
    object Page_IdMan: TTabSheet
      Caption = 'Page_IdMan'
      ImageIndex = 1
      TabVisible = False
      object Grid_PeoplePriv: TcxGrid
        Left = 0
        Top = 46
        Width = 444
        Height = 216
        ...
        BorderStyle = cxcbsNone
        TabOrder = 0
        object Grid_PeoplePrivDBTableView1: TcxGridDBTableView
          DataController.DataSource = DSource_PeoplePriv
          DataController.Filter.Criteria = {FFFFFFFF0000000000}
          DataController.Summary.DefaultGroupSummaryItems = <>
          DataController.Summary.FooterSummaryItems = <>
          DataController.Summary.SummaryGroups = <>
          NavigatorButtons.ConfirmDelete = False
          OnFocusedRecordChanged = Grid_PeoplePrivDBTableView1FocusedRecordChanged
          ...
          OptionsView.HeaderAutoHeight = True
          Styles.StyleSheet = GridTableViewStyleSheetDevExpress
          object Grid_PeoplePriv_Column_PrivKod: TcxGridDBColumn
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
            Width = 34
          end
          object Grid_PeoplePriv_Column_PrivName: TcxGridDBColumn
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
            Width = 356
          end
          object Grid_PeoplePriv_Column_DateBeg: TcxGridDBColumn
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
            Width = 61
          end
          object Grid_PeoplePriv_Column_DateEnd: TcxGridDBColumn
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
            Width = 58
          end
          object Grid_PeoplePriv_Column_Expense: TcxGridDBColumn
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
          end
        end
        object Grid_PeoplePrivLevel1: TcxGridLevel
          GridView = Grid_PeoplePrivDBTableView1
        end
      end
  ...
  object BarManager: TdxBarManager
    ...
    object InsertChildBtn: TdxBarLargeButton
      Caption = 'InsertChild2Btn'
      Category = 0
      Hint = 'InsertChild2Btn'
      Visible = ivAlways
      ShortCut = 45
      OnClick = InsertChildBtnClick
      AutoGrayScale = False
      LargeGlyph.Data = {
        F6060000424DF606000000000000360000002800000018000000180000000100
        180000000000C006000000000000000000000000000000000000FF00FFFF00FF
    ...
    object UpdateChildBtn: TdxBarLargeButton
      Caption = 'UpdateChild2Btn'
      Category = 0
      Hint = 'UpdateChild2Btn'
      Visible = ivAlways
      ShortCut = 113
      OnClick = UpdateChildBtnClick
      AutoGrayScale = False
      LargeGlyph.Data = {
    ...
    object DeleteChildBtn: TdxBarLargeButton
      Caption = 'DeleteChild2Btn'
      Category = 0
      Hint = 'DeleteChild2Btn'
      Visible = ivAlways
      ShortCut = 46
      OnClick = DeleteChildBtnClick
      AutoGrayScale = False
      LargeGlyph.Data = {
        F6060000424DF606000000000000360000002800000018000000180000000100
        180000000000C006000000000000000000000000000000000000FF00FFFF00FF
    ...
    object ViewChildBtn: TdxBarLargeButton
      Caption = 'ViewChild2Btn'
      Category = 0
      Hint = 'ViewChild2Btn'
      Visible = ivAlways
      ShortCut = 32
      OnClick = ViewChildBtnClick
      AutoGrayScale = False
      LargeGlyph.Data = {
        F6060000424DF606000000000000360000002800000018000000180000000100
        180000000000C006000000000000000000000000000000000000FF00FFFF00FF
  ...
  object DSource_FIO: TDataSource
    DataSet = DSet_FIO
    Left = 120
    Top = 72
  end
  object DSource_PeoplePriv: TDataSource
    DataSet = DSet_PeoplePriv
    Left = 649
    Top = 81
  end
  ...
  object DSet_PeoplePriv: TpFIBDataSet
    Database = DB
    Transaction = DefaultTransaction
    DataSource = DSource_FIO
    Left = 601
    Top = 81
    poSQLINT64ToBCD = True
  end
