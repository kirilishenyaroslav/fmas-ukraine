object FZSp_f1dfFirm: TFZSp_f1dfFirm
  Left = 305
  Top = 89
  Width = 798
  Height = 518
  Caption = 'FZSp_f1dfFirm'
  Color = clBtnFace
  ...
  object PanelNarChild2: TPanel
    ...
    BevelOuter = bvNone
    TabOrder = 1
    object GridF1dfFirmShifr: TcxGrid
      Left = 0
      Top = 0
      Width = 238
      Height = 412
      ...
      TabOrder = 0
      object GridF1dfFirmShifrView1: TcxGridDBTableView
        OnDblClick = GridF1dfFirmShifrView1DblClick
        DataController.DataModeController.SmartRefresh = True
        DataController.Filter.Criteria = {FFFFFFFF0000000000}
        DataController.KeyFieldNames = 'SHIFR'
        DataController.Summary.DefaultGroupSummaryItems = <>
        DataController.Summary.FooterSummaryItems = <>
        DataController.Summary.SummaryGroups = <>
        NavigatorButtons.ConfirmDelete = False
        OptionsBehavior.IncSearch = True
        OptionsBehavior.IncSearchItem = GridColumnShifr
        ...
        object GridColumnShifr: TcxGridDBColumn
      ...
      object GridF1dfFirmShifrLevel1: TcxGridLevel
        GridView = GridF1dfFirmShifrView1
      end
    end
  end
  object PanelNarGrid1: TPanel
    ...
    object GridF1dfFirm: TcxGrid
      ...
      BorderStyle = cxcbsNone
      TabOrder = 0
      object GridF1dfFirmDBBandedTableView1: TcxGridDBBandedTableView
        DataController.Filter.Criteria = {FFFFFFFF0000000000}
        DataController.KeyFieldNames = 'ID_1DF_FIRM'
        DataController.Summary.DefaultGroupSummaryItems = <>
        DataController.Summary.FooterSummaryItems = <>
        DataController.Summary.SummaryGroups = <>
        NavigatorButtons.ConfirmDelete = False
        ...
        object GridF1dfFirmDBBandedTableView1DBBandedColumnFirmName: TcxGridDBBandedColumn
          Width = 158
        ...
        object GridF1dfFirmDBBandedTableView1DBBandedColumnFirmNameFull: TcxGridDBBandedColumn
          Width = 158
          Position.BandIndex = 0
          Position.ColIndex = 0
          Position.RowIndex = 1
        ...
        object GridF1dfFirmDBBandedTableView1DBBandedColumnDirector: TcxGridDBBandedColumn
          Width = 140
        ...
        object GridF1dfFirmDBBandedTableView1DBBandedColumnTinDirector: TcxGridDBBandedColumn
          Width = 72
          Position.BandIndex = 1
          Position.ColIndex = 0
          Position.RowIndex = 1
          DataBinding.FieldName = 'TIN_DIRECTOR'
        end
        object GridF1dfFirmDBBandedTableView1DBBandedColumnTelDirector: TcxGridDBBandedColumn
          PropertiesClassName = 'TcxTextEditProperties'
          Width = 68
          Position.BandIndex = 1
          Position.ColIndex = 1
          Position.RowIndex = 1
          DataBinding.FieldName = 'TEL_DIRECTOR'
        end
        object GridF1dfFirmDBBandedTableView1DBBandedColumnGlavBuhg: TcxGridDBBandedColumn
          Width = 151
          Position.BandIndex = 2
          Position.ColIndex = 0
          Position.RowIndex = 0
          DataBinding.FieldName = 'GLAV_BUHG'
        end
        object GridF1dfFirmDBBandedTableView1DBBandedColumnTinGlBuhg: TcxGridDBBandedColumn
          Width = 105
          Position.BandIndex = 2
          Position.ColIndex = 0
          Position.RowIndex = 1
          DataBinding.FieldName = 'TIN_GLBUHG'
        end
        object GridF1dfFirmDBBandedTableView1DBBandedColumnTelGlBuhg: TcxGridDBBandedColumn
          PropertiesClassName = 'TcxTextEditProperties'
          Width = 105
          Position.BandIndex = 2
          Position.ColIndex = 1
          Position.RowIndex = 1
          DataBinding.FieldName = 'TEL_GLBUHG'
        end
        object GridF1dfFirmDBBandedTableView1DBBandedColumnDpi: TcxGridDBBandedColumn
          Width = 102
          Position.BandIndex = 3
          Position.ColIndex = 0
          Position.RowIndex = 0
          DataBinding.FieldName = 'DPI'
        end
        object GridF1dfFirmDBBandedTableView1DBBandedColumnKodDpi: TcxGridDBBandedColumn
          Width = 102
          Position.BandIndex = 3
          Position.ColIndex = 0
          Position.RowIndex = 1
          DataBinding.FieldName = 'KOD_DPI'
        end
        object GridF1dfFirmDBBandedTableView1DBBandedColumnOkpo: TcxGridDBBandedColumn
          Position.BandIndex = 4
          Position.ColIndex = 0
          Position.RowIndex = 0
          DataBinding.FieldName = 'OKPO'
        end
        object GridF1dfFirmDBBandedTableView1DBBandedColumnFileDa: TcxGridDBBandedColumn
          Position.BandIndex = 4
          Position.ColIndex = 0
          Position.RowIndex = 1
          DataBinding.FieldName = 'FILE_DA'
        end
      end
      object GridF1dfFirmLevel1: TcxGridLevel
        GridView = GridF1dfFirmDBBandedTableView1
      end
    end
  end
