object FMainInfl: TFMainInfl
  Left = 365
  Top = 81
  AutoScroll = False
  Caption = #1055#1086#1082#1072#1079#1085#1080#1082#1080' '#1110#1085#1092#1083#1103#1094#1110#1111
  ClientHeight = 498
  ClientWidth = 782
  Color = clBtnFace
  ...
  object pnlPeriod: TPanel
    ...
    object Label2: TLabel
      ...
      Width = 78
      Height = 13
      Caption = #1041#1072#1079#1086#1074#1080#1081' '#1087#1077#1088'i'#1086#1076
    end
    object EditMonth: TcxComboBox
      ...
      Properties.Items.Strings = (
        'January'
        'February')
      Properties.OnEditValueChanged = EditMonthPropertiesEditValueChanged
      TabOrder = 0
    end
  ...
  object grMain: TcxGrid
    ...
    object grMainDBVwMain: TcxGridDBTableView
      ...
      object grMainDBVwMainYear: TcxGridDBColumn
        Caption = #1056#1110#1082
        PropertiesClassName = 'TcxTextEditProperties'
        Properties.Alignment.Horz = taCenter
        OnGetDisplayText = grMainDBVwMainYearGetDisplayText
        FooterAlignmentHorz = taCenter
        HeaderAlignmentHorz = taCenter
        Width = 84
        DataBinding.FieldName = 'KOD_SETUP'
      end
      object grMainDBVwMainMonth: TcxGridDBColumn
        Caption = #1052#1110#1089#1103#1094#1100
        PropertiesClassName = 'TcxTextEditProperties'
        Properties.Alignment.Horz = taCenter
        OnGetDisplayText = grMainDBVwMainMonthGetDisplayText
        FooterAlignmentHorz = taCenter
        HeaderAlignmentHorz = taCenter
        Width = 68
        DataBinding.FieldName = 'KOD_SETUP'
      end
      object grMainDBVwMainZ_INDEX_INFL: TcxGridDBColumn
        Caption = #1030#1085#1076#1077#1082#1089' '#1030#1085#1092#1083#1103#1094#1110#1111
        ...
        HeaderAlignmentHorz = taCenter
        Width = 127
        DataBinding.FieldName = 'Z_INDEX_INFL'
      end
      object grMainDBVwMainIndInfl: TcxGridDBColumn
        Caption = #1050#1086#1077#1092#1110#1094#1110#1108#1085#1090' '#1110#1085#1076#1077#1082#1089#1072#1094#1110#1111
        PropertiesClassName = 'TcxMaskEditProperties'
        Properties.MaskKind = emkRegExprEx
        ...
        HeaderAlignmentHorz = taCenter
        Width = 161
        DataBinding.FieldName = 'KOEF_IND'
      end
      object grMainDBVwMainProjMin: TcxGridDBColumn
        ...
        HeaderAlignmentHorz = taCenter
        Width = 180
        DataBinding.FieldName = 'PROG_MIN'
      end
      object grMainDBVwMainSummInd: TcxGridDBColumn
        Caption = #1057#1091#1084#1072' '#1110#1085#1076#1077#1082#1089#1072#1094#1110#1111
        PropertiesClassName = 'TcxMaskEditProperties'
        Properties.MaskKind = emkRegExprEx
        Properties.EditMask = '[-]?\d?\d?\d?\d?([,]?\d\d?)?'
        HeaderAlignmentHorz = taCenter
        Width = 136
        DataBinding.FieldName = 'SUM_IND'
      end
    end
    object grMainLevel1: TcxGridLevel
      GridView = grMainDBVwMain
    end
  end
  ...
  object BarManager: TdxBarManager
    ...
    object LargeBtn: TdxBarLargeButton
