object fParSet: TfParSet
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBTableView1: TcxGridDBTableView
      ...
      object Grid1ClKodSetupEnd: TcxGridDBColumn
        OnGetDisplayText = Grid1ClKodSetupEndGetDisplayText
        ...
        Width = 123
        DataBinding.FieldName = 'KOD_SETUP_END'
      end
      object Grid1ClProcProf: TcxGridDBColumn
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        MinWidth = 50
        Options.Filtering = False
        Width = 92
        DataBinding.FieldName = 'PROC_PROF'
      end
      object Grid1ClProcPens: TcxGridDBColumn
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        MinWidth = 50
        Options.Filtering = False
        Width = 92
        DataBinding.FieldName = 'PROC_PENS'
      end
      object Grid1ClProcZan: TcxGridDBColumn
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        MinWidth = 50
        Options.Filtering = False
        Width = 92
        DataBinding.FieldName = 'PROC_ZAN'
      end
      object Grid1ClProcSoc: TcxGridDBColumn
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        MinWidth = 50
        Options.Filtering = False
        Width = 92
        DataBinding.FieldName = 'PROC_SOC'
      end
      object Grid1ClProcNSluch: TcxGridDBColumn
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        MinWidth = 50
        Options.Filtering = False
        Width = 92
        DataBinding.FieldName = 'PROC_NSLUCH'
      end
      object Grid1ClProcInv: TcxGridDBColumn
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        MinWidth = 50
        Options.Filtering = False
        Width = 92
        DataBinding.FieldName = 'PROC_INV'
      end
      object cxGrid1DBTableView1DBColumn1: TcxGridDBColumn
        Caption = #1028#1076#1080#1085#1080#1081' '#1089#1086#1094#1110#1072#1083#1100#1085#1080#1081' '#1085#1072#1083#1086#1075' ('#1088#1086#1073#1110#1090#1085#1080#1082#1080')'
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Options.Filtering = False
        DataBinding.FieldName = 'ESN_R'
      end
      object cxGrid1DBTableView1DBColumn5: TcxGridDBColumn
        Caption = #1028#1076#1080#1085#1080#1081' '#1089#1086#1094#1110#1072#1083#1100#1085#1080#1081' '#1085#1072#1083#1086#1075' ('#1088#1086#1073#1110#1090#1085#1080#1082#1080' '#1053#1044#1063')'
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Options.Filtering = False
        DataBinding.FieldName = 'ESN_NDC'
      end
      object cxGrid1DBTableView1DBColumn2: TcxGridDBColumn
        Caption = #1028#1076#1080#1085#1080#1081' '#1089#1086#1094#1110#1072#1083#1100#1085#1080#1081' '#1085#1072#1083#1086#1075' ('#1088#1086#1073#1110#1090#1085#1080#1082#1080'  - '#1110#1085#1074#1072#1083#1110#1076#1080')'
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Options.Filtering = False
        DataBinding.FieldName = 'ESN_INV'
      end
      object cxGrid1DBTableView1DBColumn3: TcxGridDBColumn
        Caption = #1028#1076#1080#1085#1080#1081' '#1089#1086#1094#1110#1072#1083#1100#1085#1080#1081' '#1085#1072#1083#1086#1075' ('#1083#1080#1089#1090#1080' '#1085#1077#1087#1088#1072#1094#1077#1079#1076#1072#1090#1085#1086#1089#1090#1110')'
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Options.Filtering = False
        DataBinding.FieldName = 'ESN_LL'
      end
      object cxGrid1DBTableView1DBColumn4: TcxGridDBColumn
        Caption = #1028#1076#1080#1085#1080#1081' '#1089#1086#1094#1110#1072#1083#1100#1085#1080#1081' '#1085#1072#1083#1086#1075' ('#1076#1086#1075#1086#1074#1086#1088#1072' '#1087#1110#1076#1088#1103#1076#1091')'
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Options.Filtering = False
        DataBinding.FieldName = 'ESN_DP'
      end
    end
  ...
  object SProc: TpFIBStoredProc
    ...
    SQL.Strings = (
        ...
        'EXECUTE PROCEDURE Z_PAR_SET_ADD_REC (?KOD_SETUP_END, ?PROC_PROF,' +
        ' ?PROC_PENS, ?PROC_ZAN, ?PROC_SOC, ?PROC_NSLUCH, ?PROC_INV)')
    Transaction = Transaction
    StoredProcName = 'Z_PAR_SET_ADD_REC'
    Left = 128
  end
end
