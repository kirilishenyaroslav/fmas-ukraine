object FCurrentCount: TFCurrentCount
  Left = 213
  Top = 199
  Width = 735
  Height = 497
  Caption = 'FCurrentCount'
  Color = clBtnFace
  ...
  object ListGrid: TcxGrid
    ...
    object ListGridTabView: TcxGridDBTableView
      ...
      OnFocusedRecordChanged = ListGridTabViewFocusedRecordChanged
  ...
  object BarManager: TdxBarManager
    ...
    object BarEditMinSum: TdxBarEdit
      Caption = #1053#1072#1081#1084#1077#1085#1096#1072' '#1089#1091#1084#1072' '#1076#1086' '#1089#1087#1083#1072#1090#1080
      Category = 0
      Hint = #1053#1072#1081#1084#1077#1085#1096#1072' '#1089#1091#1084#1072' '#1076#1086' '#1089#1087#1083#1072#1090#1080
      Visible = ivAlways
      Text = '30'
      ShowCaption = True
      Width = 100
  ...
  object CountProc: TpFIBStoredProc
    Database = MainDatabase
