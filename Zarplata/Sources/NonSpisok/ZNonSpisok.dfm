object FZNonSpisok: TFZNonSpisok
  ...
  object cxSplitter1: TcxSplitter
    ...
    Control = PanelDataMain
  end
  object PanelDetailData: TPanel
    Left = 265
    Top = 50
    Width = 529
    Height = 460
    ...
    object SplitterPanelDopData: TcxSplitter
      Left = 0
      Top = 392
      Width = 529
      Height = 8
    ...
    object GridChild: TcxGrid
      ...
      TabOrder = 2
      object GridChildDBTableView1: TcxGridDBTableView
        ...
        OnFocusedRecordChanged = GridChildDBTableView1FocusedRecordChanged
        ...
        object GridChildColKodSetup2: TcxGridDBColumn
          PropertiesClassName = 'TcxTextEditProperties'
          Properties.Alignment.Horz = taCenter
          Properties.Alignment.Vert = taVCenter
          Visible = False
          OnGetDisplayText = GridChildColKodSetup2GetDisplayText
          GroupIndex = 0
        ...
        object GridChildColKodSmeta: TcxGridDBColumn
          PropertiesClassName = 'TcxTextEditProperties'
          Properties.Alignment.Horz = taCenter
          Properties.Alignment.Vert = taVCenter
          HeaderAlignmentHorz = taCenter
        ...
        object GridChildColVoKod: TcxGridDBColumn
          PropertiesClassName = 'TcxTextEditProperties'
          Properties.Alignment.Horz = taCenter
          Properties.Alignment.Vert = taVCenter
          HeaderAlignmentHorz = taCenter
        ...
        object GridChildColVoName: TcxGridDBColumn
          PropertiesClassName = 'TcxTextEditProperties'
          Properties.Alignment.Vert = taVCenter
          HeaderAlignmentHorz = taCenter
          HeaderAlignmentVert = vaCenter
        ...
        object GridChildColKodDepartment: TcxGridDBColumn
          PropertiesClassName = 'TcxTextEditProperties'
          Properties.Alignment.Horz = taCenter
          Properties.Alignment.Vert = taVCenter
          HeaderAlignmentHorz = taCenter
      ...
      object GridChildLevel1: TcxGridLevel
        GridView = GridChildDBTableView1
      end
    end
  ...
  object PanelDataMain: TPanel
    ...
    object PanelContainer: TPanel
      ...
      object EditLocate: TcxTextEdit
        ...
        OnExit = EditLocateExit
        OnKeyPress = EditLocateKeyPress
      end
      object LabelLocate: TcxLabel
        Left = 0
        Top = 1
        Width = 41
        Height = 17
      ...
      object LocateNextbtn: TcxButton
        Left = 188
        Top = 1
        Width = 25
        Height = 19
        Action = ActionLocateNext
        ParentShowHint = False
        ShowHint = True
        TabOrder = 3
        Glyph.Data = {
  ...
  object ActList: TActionList
    ...
    object ActionLocateNext: TAction
      Caption = 'ActionLocateNext'
      ShortCut = 16502
      OnExecute = ActionLocateNextExecute
    end
  end
