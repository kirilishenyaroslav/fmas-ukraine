object frmZPersModule4: TfrmZPersModule4
  Left = 216
  Top = 368
  Width = 1036
  Height = 387
  Caption = #1058#1072#1073#1083#1080#1094#1103' 5 '#1044#1086#1076#1072#1090#1082#1091' 4 '#1079#1072' '#1087#1077#1088#1110#1086#1076' '
  Color = clBtnFace
  ...
  object Grid: TcxGrid
    ...
    object GridDBTableView1: TcxGridDBTableView
      DataController.DataSource = DModule.DSourceWorkDog
      ...
      DataController.OnDataChanged = GridDBTableView1DataControllerDataChanged
      ...
      object GridDBTableView1DBColumn1: TcxGridDBColumn
        Caption = #8470
      ...
      object GridDBTableView1DBColumn2: TcxGridDBColumn
      ...
      object GridDBTableView1DBColumn3: TcxGridDBColumn
        Caption = #1050#1072#1090#1077#1075#1086#1088#1110#1103
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Width = 86
        DataBinding.FieldName = 'KOD_CAT'
      end
      object TIN: TcxGridDBColumn
        Caption = #1053#1086#1084#1077#1088' '#1086#1073#1083#1110#1082#1086#1074#1086#1111' '#1082#1072#1088#1090#1082#1080' '#1047#1054' '#1079#1072' '#1044#1056#1060#1054' '#1044#1055#1040' '
        PropertiesClassName = 'TcxTextEditProperties'
        Properties.Alignment.Horz = taCenter
      ...
      object GridFam: TcxGridDBColumn
      ...
      object GridName: TcxGridDBColumn
      ...
      object GridOtch: TcxGridDBColumn
        Caption = #1055#1086' '#1073#1072#1090#1100#1082#1086#1074#1110
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Width = 75
        DataBinding.FieldName = 'FATH'
      end
      object GridDateBeg: TcxGridDBColumn
      ...
      object GridDateEnd: TcxGridDBColumn
      ...
      object GridDBTableView1DBColumn5: TcxGridDBColumn
        Caption = #1044#1072#1090#1072' '#1089#1090#1074#1086#1088#1077#1085#1085#1103' '#1085#1086#1074#1086#1075#1086' '#1088#1086#1073#1086#1095#1086#1075#1086' '#1084#1110#1089#1094#1103
        PropertiesClassName = 'TcxDateEditProperties'
        Properties.Alignment.Horz = taCenter
        Properties.Alignment.Vert = taVCenter
        FooterAlignmentHorz = taCenter
        ...
        MinWidth = 100
        Width = 104
        DataBinding.FieldName = 'DATE_NEW_WORK_PL'
      end
      object GridDBTableView1DBColumn4: TcxGridDBColumn
        ...
        HeaderAlignmentVert = vaCenter
        Width = 110
        DataBinding.FieldName = 'GROUNDS_OF_DISMISSAL'
      end
      object clDOG_CPH: TcxGridDBColumn
        Caption = #1044#1086#1075#1086#1074#1110#1088' '#1062#1055#1061' '#1079' '#1086#1089#1085#1086#1074#1085#1080#1084' '#1084#1110#1089#1094#1077#1084' '#1088#1086#1073#1086#1090#1080
  ...
  object BarManager: TdxBarManager
    ...
    object ButtonForm: TdxBarLargeButton
    ...
    object ButtonSign: TdxBarLargeButton
      Caption = #1055#1110#1076#1087#1080#1089#1072#1090#1080' '
      Category = 0
      Hint = #1055#1110#1076#1087#1080#1089#1072#1090#1080' '
      Visible = ivAlways
    ...
    object ButtonNotSign: TdxBarLargeButton
