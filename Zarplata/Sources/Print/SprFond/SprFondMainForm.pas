...
uses
  ...
  cxDropDownEdit, cxControls, cxGroupBox, IBase, SprFondDataModul,
...
constructor TFSprFond.Create(AOwner:TComponent; ADb_Handle:TISC_DB_HANDLE;AParameter: TFilterData;AIs_Grant: TZChildSystems);
begin
...
procedure TFSprFond.CancelBtnClick(Sender: TObject);
begin
ModalResult:=mrCancel;
end;

procedure TFSprFond.EditDataFilterPropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
var Man:Variant;
...
procedure TFSprFond.EditDataFilterExit(Sender: TObject);
var man:Variant;
begin
...
procedure TFSprFond.ActionYesExecute(Sender: TObject);
begin
