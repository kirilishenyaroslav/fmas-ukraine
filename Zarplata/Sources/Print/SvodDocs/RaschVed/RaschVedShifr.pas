...
constructor TFRaschVedShifr.Create(AParameter:TZAccListParameter);
begin
...
procedure TFRaschVedShifr.RefreshBtnClick(Sender: TObject);
var _recno:integer;
begin
...
procedure TFRaschVedShifr.ExitBtnClick(Sender: TObject);
begin
ModalResult:=mrCancel;
end;

destructor TFRaschVedShifr.Destroy;
begin
 MainDM.Destroy;
 inherited Destroy;
end;

procedure TFRaschVedShifr.PrintSvodBtnClick(Sender: TObject);
