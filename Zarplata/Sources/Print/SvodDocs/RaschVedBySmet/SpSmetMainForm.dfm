object FGr_SchForm: TFGr_SchForm
  Left = 228
  Top = 142
  ...
  object SchTreeList: TcxDBTreeList
    ...
    BufferedPaint = False
    DataController.ParentField = 'ID_SMETA'
    DataController.KeyField = 'ID_SMETA'
    OptionsView.ColumnAutoWidth = True
    OptionsView.Indicator = True
    RootValue = -1
    TabOrder = 4
    object SchTreeListcxDBTreeListSmetaKod: TcxDBTreeListColumn
    ...
    object SchTreeListcxDBTreeListSmetaName: TcxDBTreeListColumn
