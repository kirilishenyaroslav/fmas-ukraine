...
uses
  ...
  cxDropDownEdit, cxControls, cxGroupBox, IBase, SprYearDeclDataModul,
...
constructor TFYearDecl.Create(AOwner:TComponent; ADb_Handle:TISC_DB_HANDLE;AParameter: TFilterDataSprDoh;AIs_Grant: TZChildSystems);
var DModule:TDM;
begin
...
procedure TFYearDecl.CancelBtnClick(Sender: TObject);
begin
ModalResult:=mrCancel;
end;

procedure TFYearDecl.EditDataFilterPropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
var Man:Variant;
...
procedure TFYearDecl.EditDataFilterExit(Sender: TObject);
var man:Variant;
begin
...
procedure TFYearDecl.ActionYesExecute(Sender: TObject);
var DModule:TDM;
begin
