object FZSp_VidOplConsts: TFZSp_VidOplConsts
  Left = 248
  Top = 201
  Width = 657
  Height = 462
  ...
  object CxGrid1: TcxGrid
    ...
    object CxGrid1DBBandedTableView1: TcxGridDBBandedTableView
      ...
      Bands = <
        ...
        item
          Caption = #1042#1080#1076' '#1086#1087#1083#1072#1090
          Width = 303
        end>
      object ColumnNameShort: TcxGridDBBandedColumn
      ...
      object ColumnNameFull: TcxGridDBBandedColumn
      ...
      object ColumnVidOpl: TcxGridDBBandedColumn
        Caption = #1053#1072#1079#1074#1072' '#1074#1080#1076#1091' '#1086#1087#1083#1072#1090
        Options.Filtering = False
        Options.Focusing = False
        Width = 67
      ...
      object ColumnKodVidOpl: TcxGridDBBandedColumn
        Caption = #1050#1086#1076' '#1074#1080#1076#1091' '#1086#1087#1083#1072#1090
        ...
        Properties.OnButtonClick = ColumnKodVidOplPropertiesButtonClick
        Position.BandIndex = 1
        Position.ColIndex = 0
        Position.RowIndex = 0
  ...
  object DSetConsts: TpFIBDataSet
    ...
    RefreshSQL.Strings = (
      'SELECT * FROM Z_DT_VIDOPL_CONST_SELECT(NULL,NULL)')
    Left = 24
    Top = 144
    poSQLINT64ToBCD = True
  end
  object DSourceConst: TDataSource
    DataSet = DSetConsts
    Left = 72
    Top = 144
  end
