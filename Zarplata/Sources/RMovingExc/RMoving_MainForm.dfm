object FZRmovingExc: TFZRmovingExc
  Left = 104
  Top = 129
  Width = 781
  Height = 537
  Caption = 'FZRmovingExc'
  Color = clBtnFace
  ...
  object PanelCurrent: TPanel
    ...
    object Grid3: TcxGrid
      ...
      object Grid3DBTableView1: TcxGridDBTableView
        DataController.DataSource = DSource4
    ...
    object Grid2: TcxGrid
      ...
      object Grid2DBBandedTableView1: TcxGridDBBandedTableView
        ...
        DataController.Filter.Criteria = {FFFFFFFF0000000000}
        DataController.KeyFieldNames = 'ID_MAN_MOVING;DATE_BEG;DATE_END'
        ...
        object Grid22ClDateEnd: TcxGridDBBandedColumn
          PropertiesClassName = 'TcxDateEditProperties'
          Properties.Alignment.Horz = taCenter
          Properties.Alignment.Vert = taVCenter
          HeaderAlignmentHorz = taCenter
      ...
      object Grid2Level1: TcxGridLevel
        ...
        object Grid2Level4: TcxGridLevel
          GridView = Grid2DBBandedTableView1
        end
      end
    end
    object PostFilterPanel: TPanel
      Left = 0
      Top = 158
      Width = 508
      Height = 22
      Align = alBottom
      TabOrder = 3
      object PostFilterCheckBox: TcxCheckBox
        Left = 19
        Top = 1
        Width = 310
        Height = 21
        Properties.DisplayUnchecked = 'False'
        Properties.OnChange = PostFilterCheckBoxPropertiesChange
        TabOrder = 0
      end
    end
  end
  ...
  object DSet1: TpFIBDataSet
    ...
    OnFilterRecord = DSet1FilterRecord
    Left = 136
    Top = 118
  ...
  object DSet2: TpFIBDataSet
    ...
    Transaction = ReadTransaction
    DataSource = DSource1
    OnFilterRecord = DSet2FilterRecord
    Left = 136
    Top = 158
    poSQLINT64ToBCD = True
  end
  ...
  object DSet3: TpFIBDataSet
    ...
    Transaction = ReadTransaction
    DataSource = DSource1
    OnFilterRecord = DSet3FilterRecord
    Left = 136
    Top = 198
    poSQLINT64ToBCD = True
  end
