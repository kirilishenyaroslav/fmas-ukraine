...
constructor TFCurrCtrl_ByHours.Create(AOwner:TComponent;
                                      DB_Handle:TISC_DB_HANDLE;
                                      Id_Man_Moving:Integer;
                                      defpercent:Variant;
                                      defsumma:Variant);
...
//------------------------------------------------------------------------------
 ...
 if (defpercent<>null) and (defpercent<>0)
 then EditPercent.EditValue:=defpercent
 else EditPercent.EditValue:=100;

 if (defsumma<>null) and (defsumma<>0)
 then EditSumma.EditValue:=defsumma
 else EditSumma.EditValue:=0;
