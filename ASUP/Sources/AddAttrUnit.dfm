object AddAttrForm: TAddAttrForm
  Left = 369
  Top = 169
  ...
  object Label1: TLabel
    ...
    Width = 99
    Height = 13
    Caption = #1053#1072#1079#1074#1072' '#1072#1090#1088#1080#1073#1091#1090#1072':'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clGreen
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  object FC_ATTR_NAME: TFieldControl
    Left = 264
    Top = 32
    Width = 10
    Height = 18
    Control = NameAttrEdit
    ReadFromField = DetailsQueryNAME_PROPERTY
    Title = #1053#1072#1079#1074#1072' '#1072#1090#1088#1080#1073#1091#1090#1072
    MaxLength = 0
    ExactLength = 0
    CapitalizeStyle = csNone
  end
  object FC_ATTR_TYPE: TFieldControl
    Left = 264
    Top = 88
    Width = 10
    Height = 18
    Control = AttrTypeBox
    ReadFromField = DetailsQueryPROPERTY_TYPE
    Title = #1058#1080#1087' '#1072#1090#1088#1080#1073#1091#1090#1072
    MaxLength = 0
    ExactLength = 0
    CapitalizeStyle = csNone
  end
  object AttrTypeBox: TComboBox
    Left = 8
    Top = 88
    Width = 257
    Height = 21
  ...
  object NameAttrEdit: TCheckEdit
    Left = 8
    Top = 32
    Width = 257
    Height = 21
  ...
  object DetailsQuery: TIBQuery
    ...
    CachedUpdates = False
    SQL.Strings = (
      'SELECT * FROM PCARD_PROPERTIES WHERE'
    ...
    object DetailsQueryID_PROPERTY: TIntegerField
      FieldName = 'ID_PROPERTY'
      Origin = 'PCARD_PROPERTIES.ID_PROPERTY'
      Required = True
    end
    object DetailsQueryNAME_PROPERTY: TIBStringField
      FieldName = 'NAME_PROPERTY'
      Origin = 'PCARD_PROPERTIES.NAME_PROPERTY'
      Size = 255
    end
    object DetailsQueryPROPERTY_TYPE: TIntegerField
