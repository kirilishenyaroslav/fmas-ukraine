object PCardImportForm: TPCardImportForm
  Left = 222
  Top = 184
  BorderStyle = bsSingle
  Caption = #1030#1084#1087#1086#1088#1090' '#1086#1089#1086#1073#1080#1089#1090#1080#1093' '#1082#1072#1088#1090#1086#1082
  ClientHeight = 140
  ClientWidth = 342
  Color = clBtnFace
  ...
  object AllPCardsQuery: TIBQuery
    ...
    SQL.Strings = (
        ...
        'SELECT ID_PCARD,TN,ID_MAN,T_UNION,KLASS,INVALID FROM PRIVATE_CAR' +
        'DS')
    Top = 112
  end
  object GetBufInfoQuery: TIBQuery
    ...
    SQL.Strings = (
      ...
      ':INVALID,:PAR_KLASS,:PAR_TN,:PAR_IDMAN')
    Left = 40
    Top = 112
    ParamData = <
      item
