object DepartmentsSearchForm: TDepartmentsSearchForm
  Left = 267
  Top = 151
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsDialog
  Caption = #1047#1085#1072#1081#1090#1080' '#1087#1110#1076#1088#1086#1079#1076#1110#1083
  ClientHeight = 215
  ClientWidth = 274
  Color = clBtnFace
  ...
  object Search: TRadioGroup
    ...
    ItemIndex = 1
    Items.Strings = (
      #1055#1086#1074#1085#1110#1081' '#1085#1072#1079#1074#1110
      #1057#1082#1086#1088#1086#1095#1077#1085#1110#1081' '#1085#1072#1079#1074#1110)
    TabOrder = 0
  end
