object ExternProgsAddForm: TExternProgsAddForm
  Left = 301
  Top = 108
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = #1044#1086#1076#1072#1074#1072#1085#1085#1103' '#1079#1086#1074#1085#1110#1096#1085#1100#1086#1111' '#1087#1088#1086#1075#1088#1072#1084#1080
  ClientHeight = 140
  ClientWidth = 447
  Color = clBtnFace
  ...
  object Label3: TLabel
    ...
    Width = 143
    Height = 16
    Caption = #1055#1072#1088#1072#1084#1077#1090#1088#1080' '#1089#1090#1072#1088#1090#1091':'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clGreen
    Font.Height = -13
    Font.Name = 'MS Sans Serif'
