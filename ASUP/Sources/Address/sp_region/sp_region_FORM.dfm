object Fsp_region: TFsp_region
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBTableView1: TcxGridDBTableView
      ...
      object cxGrid1DBTableView1ID_REGION: TcxGridDBColumn
        Visible = False
        HeaderAlignmentHorz = taCenter
        DataBinding.FieldName = 'ID_REGION'
      end
      object cxGrid1DBTableView1ID_TYPE_REGION: TcxGridDBColumn
        Visible = False
        HeaderAlignmentHorz = taCenter
        DataBinding.FieldName = 'ID_TYPE_REGION'
      end
      object cxGrid1DBTableView1NAME_REGION: TcxGridDBColumn
        Visible = False
        HeaderAlignmentHorz = taCenter
        DataBinding.FieldName = 'NAME_REGION'
      end
      object cxGrid1DBTableView1NAME_TYPE_REGION: TcxGridDBColumn
        Visible = False
        HeaderAlignmentHorz = taCenter
        DataBinding.FieldName = 'NAME_TYPE_REGION'
      end
