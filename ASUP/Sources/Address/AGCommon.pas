...
const
 AGCommon_SP_OPTIONS_ALL : TSPOptions = (soAdd: true; soDel: true; soMod: true; soSel: true);
 AGCommon_SP_OPTIONS_WITHOUT_SEL : TSPOptions = (soAdd: true; soDel: true; soMod: true; soSel: false);
...
procedure AGCommonInitialize(Database : TpFIBDatabase; ReadTransaction : TpFIBTransaction; WriteTransaction : TpFIBTransaction);
...
implementation
uses  SysUtils, AGSYS_OPTIONS, Classes,  Controls;
