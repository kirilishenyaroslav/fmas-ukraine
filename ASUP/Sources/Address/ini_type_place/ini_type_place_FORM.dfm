object Fini_type_place: TFini_type_place
  Left = 314
  Top = 190
  Width = 384
  Height = 351
  Caption = #1044#1086#1074#1110#1076#1085#1080#1082' '#1090#1080#1087#1110#1074' '#1085#1072#1089#1077#1083#1077#1085#1080#1093' '#1087#1091#1085#1082#1090#1110#1074
  Color = clBtnFace
  ...
  object DataSet: TpFIBDataSet
    SelectSQL.Strings = (
      'select * from VIEW_INI_TYPE_PLACE ORDER BY "ORDER"')
