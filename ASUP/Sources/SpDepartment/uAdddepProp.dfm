object fmAddDepProp: TfmAddDepProp
  Left = 438
  Top = 178
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = #1044#1086#1076#1072#1090#1080' '#1074#1083#1072#1089#1090#1080#1074#1110#1089#1090#1100
  ClientHeight = 219
  ClientWidth = 414
  Color = clBtnFace
  ...
  object FormControl: TqFFormControl
    ...
    InsertSQL.Strings = (
        ...
        'EXECUTE PROCEDURE PUB_DEP_PROPERTIES_I :add, :Id_Property, :Date' +
        '_Beg, :Date_End, :Including')
    Mode = fmAdd
    CheckWhere = True
    CloseForm = True
  ...
  object Id_Property: TqFSpravControl
    ...
    DisplayName = #1042#1083#1072#1089#1090#1080#1074#1110#1089#1090#1100
    Interval = 120
    Value = Null
    LabelColor = clGreen
    Required = True
  ...
  object Including: TqFBoolControl
    Left = 24
    Top = 152
    Width = 377
    Height = 21
    FieldName = 'Including'
    DisplayName = #1042#1089#1090#1072#1085#1086#1074#1080#1090#1080' '#1074#1083#1072#1089#1090#1080#1074#1110#1089#1090#1100' '#1088#1072#1079#1086#1084' '#1079' '#1087#1110#1076#1083#1077#1075#1083#1080#1084#1080' '#1087#1110#1076#1088#1086#1079#1076#1110#1083#1072#1084#1080
    Interval = 120
    Value = True
    LabelColor = clGreen
    Required = True
