object AddAdditionalActionsForm: TAddAdditionalActionsForm
  Left = 400
  Top = 171
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = #1044#1086#1076#1072#1090#1082#1086#1074#1080#1081' '#1087#1091#1085#1082#1090' '#1085#1072#1082#1072#1079#1091
  ClientHeight = 183
  ClientWidth = 483
  Color = clBtnFace
  ...
  object AddExist: TSpeedButton
    Left = 448
    Top = 48
    Width = 33
    Height = 89
    Hint = #1044#1086#1076#1072#1090#1080' '#1074#1078#1077' '#1110#1089#1085#1091#1102#1095#1080#1081' '#1090#1077#1082#1089#1090
    Glyph.Data = {
  ...
  object PoryadokEdit: TCheckEdit
    Left = 72
    Top = 12
    Width = 121
    Height = 21
    TabOrder = 3
    OnKeyPress = PoryadokEditKeyPress
    InputSet = isAll
  end
end
