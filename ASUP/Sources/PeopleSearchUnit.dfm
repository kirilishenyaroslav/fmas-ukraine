object PeopleSearchForm: TPeopleSearchForm
  Left = 286
  Top = 176
  ...
  object SearchRadioGroup: TRadioGroup
    ...
    Items.Strings = (
      ...
      #1055#1086#1076#1072#1090#1082#1086#1074#1086#1084#1091' '#1085#1086#1084#1077#1088#1091)
    TabOrder = 1
  ...
  object PassCheck: TCheckBox
    Left = 16
    Top = 120
    Width = 177
    Height = 17
    Caption = #1042#1088#1072#1093#1086#1074#1091#1074#1072#1090#1080' '#1079#1084#1110#1085#1091' '#1087#1088#1110#1079#1074#1080#1097#1072
    TabOrder = 2
  end
