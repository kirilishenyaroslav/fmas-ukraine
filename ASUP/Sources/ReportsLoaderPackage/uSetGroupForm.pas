...
uses
  ...
  cxTextEdit, Buttons,dmLoaderMain, cxMaskEdit, cxDropDownEdit,
...
begin
    ...
    begin
        ...
        UpdateGroupQuery.ParamByName('ID_REPORT').Value:=IdReport;
        UpdateGroupQuery.ParamByName('REPORT_GROUP').Value:=GroupName;
