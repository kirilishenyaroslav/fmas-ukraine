object AddShtatSPZForm: TAddShtatSPZForm
  Left = 273
  Top = 146
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsDialog
  Caption = #1044#1086#1076#1072#1090#1080' '#1087#1086#1089#1072#1076#1091' '#1076#1086' '#1088#1086#1079#1073#1080#1074#1082#1080' '#1087#1086' '#1064#1055#1047
  ClientHeight = 139
  ClientWidth = 372
  Color = clBtnFace
