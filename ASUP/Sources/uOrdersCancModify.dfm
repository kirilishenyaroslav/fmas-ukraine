object fmOrdersCancModify: TfmOrdersCancModify
  Left = 314
  Top = 141
  Width = 326
  Height = 146
  BorderIcons = []
  Caption = #1047#1084#1110#1085#1077#1085#1085#1103' '#1085#1086#1084#1077#1088#1091' '#1090#1072' '#1076#1072#1090#1110' '#1088#1077#1108#1089#1090#1088#1072#1094#1110#1111' '#1085#1072#1082#1072#1079#1091
  Color = clBtnFace
  ...
  object FormControl: TqFFormControl
    ...
    UpdateSQL.Strings = (
      ...
      'where id_order = :where')
    SelectSQL.Strings = (
      'select num_order, date_order'
      'from asup_orders'
      'where id_order = :where')
    ModifyCaption = #1047#1084#1110#1085#1077#1085#1085#1103' '#1085#1086#1084#1077#1088#1091' '#1090#1072' '#1076#1072#1090#1110' '#1088#1077#1108#1089#1090#1088#1072#1094#1110#1111' '#1085#1072#1082#1072#1079#1091
    Mode = fmModify
    CheckWhere = True
    CloseForm = True
  end
  object NumOrder: TqFCharControl
    ...
    Height = 21
    FieldName = 'NUM_ORDER'
    DisplayName = #1053#1086#1084#1077#1088
    Interval = 120
    Value = ''
    LabelColor = clGreen
    Required = True
