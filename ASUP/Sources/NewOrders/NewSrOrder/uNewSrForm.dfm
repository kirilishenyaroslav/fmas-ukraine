object fmNewSrOrder: TfmNewSrOrder
  Left = 239
  Top = 10
  Width = 582
  Height = 562
  ...
  object PageControl: TPageControl
    ...
    object MainSheet: TTabSheet
      ...
      object FormControl: TqFFormControl
        ...
        ControlsOwner = Owner
        InsertSQL.Strings = (
          'SELECT * FROM ASUP_ORDER_NEW_SR_INSERT ('
          '    :ID_SR,'
          '    :DATE_BEG,'
          '    :NOTE,'
          '    :ID_ORDER_TYPE,'
          ...
          '    :INTRO)')
        UpdateSQL.Strings = (
          'EXECUTE PROCEDURE ASUP_ORDER_NEW_SR_UPDATE ('
          '    :ID_SR,'
          '    :DATE_BEG,'
          '    :NOTE,'
          '    :where)')
        SelectSQL.Strings = (
          'SELECT * FROM ASUP_ORDER_NEW_SR_SELECT(:where)')
      ...
      object OkButton: TBitBtn
        ...
        Height = 26
        Action = OkAction
        Caption = #1057#1090#1074#1086#1088#1080#1090#1080'/'#1055#1077#1088#1077#1092#1086#1088#1084#1091#1074#1072#1090#1080
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
        Font.Name = 'MS Sans Serif'
      ...
      object DateBeg: TqFDateControl
        ...
        Height = 21
        FieldName = 'DATE_BEG'
        DisplayName = #1044#1072#1090#1072' '#1074#1074#1086#1076#1091
        Interval = 120
        Value = 0
        LabelColor = clGreen
        Required = True
