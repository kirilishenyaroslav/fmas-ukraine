object PrintVipisForm: TPrintVipisForm
  Left = 387
  Top = 183
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = #1044#1088#1091#1082' '#1074#1080#1090#1103#1075#1091' '#1079' '#1085#1072#1082#1072#1079#1091
  ClientHeight = 453
  ClientWidth = 392
  Color = clBtnFace
  ...
  object Label1: TLabel
    ...
    Width = 281
    Height = 13
    Caption = #1054#1073#1077#1088#1110#1090#1100' '#1087#1091#1085#1082#1090#1080' '#1085#1072#1082#1072#1079#1091', '#1103#1082#1110' '#1090#1088#1077#1073#1072' '#1085#1072#1076#1088#1091#1082#1091#1074#1072#1090#1080':'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clGreen
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  object ResultList: TCheckListBox
    Left = 16
    Top = 40
    Width = 361
    Height = 345
