object fmAddManExitDekret: TfmAddManExitDekret
  Left = 269
  Top = 238
  ...
  object FormControl: TqFFormControl
    ...
    ControlsOwner = Owner
    InsertSQL.Strings = (
      'SELECT Id_Holiday_Remove'
      'FROM Man_Holiday_Remove_Insert(:Id_Order,'
      ':Num_Item, :Id_Holiday_Order, :Date_Remove,'
      #39#39', NULL, '#39'31.12.2150'#39')')
    UpdateSQL.Strings = (
      'EXECUTE PROCEDURE Man_Holiday_Remove_Update (:where, :Id_Order,'
      
        ':Num_Item, :Id_Holiday_Order, :Date_Remove, '#39#39', NULL, '#39'31.12.999' +
        '9'#39')')
    SelectSQL.Strings = (
      'SELECT * FROM MAN_HOLIDAY_REMOVE_SEL_BY_IHR(:where)')
  ...
  object People: TqFSpravControl
    ...
    TabOrder = 4
    AutoSaveToRegistry = False
    OnOpenSprav = PeopleOpenSprav
    DisplayText = ''
    DisplayTextField = 'MAN_STRING'
  end
  object Post: TqFCharControl
    Left = 24
    Top = 64
    Width = 545
    Height = 21
    FieldName = 'Full_Post_Name'
  ...
  object Order: TqFCharControl
    Left = 24
    Top = 96
    Width = 545
    Height = 21
    FieldName = 'Order_String'
    DisplayName = #1053#1072#1082#1072#1079
    Interval = 120
    Value = ''
    LabelColor = clGreen
    Required = True
  ...
  object Date_Remove: TqFDateControl
    Left = 24
    Top = 176
    Width = 313
    Height = 21
    FieldName = 'Date_Remove'
    DisplayName = #1044#1072#1090#1072' '#1074#1080#1093#1086#1076#1091' '#1079' '#1074#1110#1076#1087#1091#1089#1090#1082#1080
    Interval = 200
    Value = 0
    LabelColor = clGreen
    Required = True
  ...
  object PrevOrder: TqFInvisControl
    Left = 440
    Top = 232
    Width = 81
    Height = 21
