object fmOrderItems: TfmOrderItems
  Left = 263
  Top = 110
  Width = 614
  Height = 372
  ...
  object OrderViewGrid: TcxGrid
    ...
    Align = alClient
    TabOrder = 0
    object OrderItemsView: TcxGridDBTableView
      OnDblClick = OrderItemsViewDblClick
    ...
    object OrderViewGridLevel1: TcxGridLevel
      GridView = OrderItemsView
    end
  end
  ...
  object ItemsSelect: TpFIBDataSet
    Database = DB
  ...
  object ActionControl: TqFActionControl
    DeleteSQL.Strings = (
      'EXECUTE PROCEDURE DT_MAN_BONUS_ORDER_ITEM_DELETE(:where)')
    SelectDataSet = ItemsSelect
    KeyFields = 'ID_TEXT_ITEM'
    RefreshAction = RefreshAction
    DeleteAction = DeleteAction
    AddFormClass = 'TfmOrderItemEdit'
    AddAction = AddAction
