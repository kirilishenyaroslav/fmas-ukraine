object fmOrderItemEdit: TfmOrderItemEdit
  Left = 263
  Top = 110
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = #1056#1077#1076#1072#1075#1091#1074#1072#1085#1085#1103' '#1087#1091#1085#1082#1090#1091' '#1085#1072#1082#1072#1079#1091
  ClientHeight = 309
  ClientWidth = 398
  Color = clBtnFace
  ...
  object FormControl: TqFFormControl
    ...
    InsertSQL.Strings = (
        ...
        'SELECT ID_TEXT_ITEM FROM DT_MAN_BONUS_ORDER_ITEM_INSERT(:id_orde' +
        'r, :num_item, :text)')
    UpdateSQL.Strings = (
      
        'EXECUTE PROCEDURE DT_MAN_BONUS_ORDER_ITEM_UPDATE(:where, :id_ord' +
        'er, :num_item, :text)')
    SelectSQL.Strings = (
      'SELECT * FROM DT_MAN_BONUS_ORDER_ITEM_DET(:where)')
  ...
  object ItemText: TqFMemoControl
    Left = 24
    Top = 56
    Width = 345
    Height = 193
  ...
  object Id_Order: TqFInvisControl
    Left = 256
    Top = 24
    Width = 89
    Height = 21
