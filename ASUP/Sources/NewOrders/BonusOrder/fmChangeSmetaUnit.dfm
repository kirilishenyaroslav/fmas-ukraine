object fmChangeSmeta: TfmChangeSmeta
  ...
  Caption = #1047#1084#1110#1085#1072' '#1082#1086#1096#1090#1086#1088#1080#1089#1110#1074
  ClientHeight = 123
  ClientWidth = 552
  Color = clBtnFace
  ...
  object SmetaPps: TqFSpravControl
    ...
    Height = 21
    FieldName = 'Kod_Sm'
    DisplayName = '&'#1050#1086#1096#1090#1086#1088#1080#1089' '#1087#1110#1076#1074#1080#1097#1077#1085#1085#1103
    Interval = 160
    Value = Null
    LabelColor = clGreen
    Required = True
