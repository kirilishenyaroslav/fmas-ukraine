object fmAddPochasTarif: TfmAddPochasTarif
  Left = 241
  Top = 182
  BorderIcons = [biMinimize]
  BorderStyle = bsSingle
  Caption = 'fmAddPochasTarif'
  ClientHeight = 214
  ClientWidth = 479
  Color = clBtnFace
  ...
  object FormControl: TqFFormControl
    ...
    ControlsOwner = Owner
    InsertSQL.Strings = (
      'select ID_POCHAS_TARIF'
      'from ASUP_SP_POCHAS_TARIF_INSERT('
      '  :PERIOD_BEG,'
      '  :PERIOD_END,'
      '  :TARIF,'
      '  :ID_TARIF_TYPE,'
      '  :KOD_SM)')
    UpdateSQL.Strings = (
      'EXECUTE PROCEDURE ASUP_SP_POCHAS_TARIF_UPDATE ('
      '  :where,'
      '  :PERIOD_BEG,'
      '  :PERIOD_END,'
      '  :TARIF,'
      ...
      '  :KOD_SM)')
    SelectSQL.Strings = (
      'select * from ASUP_SP_POCHAS_TARIF_SELECT_ONE(:where)')
    AddCaption = #1053#1086#1074#1080#1081' '#1090#1072#1088#1080#1092
    ModifyCaption = #1056#1077#1076#1072#1075#1091#1074#1072#1085#1085#1103' '#1090#1072#1088#1080#1092#1091
    InfoCaption = #1055#1077#1088#1077#1075#1083#1103#1076' '#1090#1072#1088#1080#1092#1091
  ...
  object PeriodBeg: TqFDateControl
    ...
    DisplayName = #1044#1110#1108' '#1079
    Interval = 120
    Value = 38526
    LabelColor = clGreen
    Required = True
  ...
  object PeriodEnd: TqFDateControl
    ...
    DisplayName = #1044#1110#1108' '#1087#1086
    Interval = 120
    Value = 55050
    LabelColor = clGreen
    Required = True
  ...
  object Tarif: TqFSpravControl
    ...
    DisplayName = #1058#1080#1087' '#1090#1072#1088#1080#1092#1110#1082#1072#1094#1110#1111
    Interval = 120
    Value = Null
    LabelColor = clGreen
    Required = True
    ...
    DisplayTextField = 'TARIF_TYPE_NAME'
  end
