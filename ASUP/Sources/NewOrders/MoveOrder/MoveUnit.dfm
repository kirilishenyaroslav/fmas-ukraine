object MoveForm: TMoveForm
  ...
  object FormControl: TqFFormControl
    ...
    ControlsOwner = Owner
    InsertSQL.Strings = (
      'SELECT * FROM ASUP_MOVE_MAN_INSERT ('
      '    :ID_PCARD,'
      '    :DATE_BEG,'
      '    :DATE_END,'
      '    :ID_MOVING_TYPE,'
      ...
      '    :NOTE);')
    UpdateSQL.Strings = (
      'EXECUTE PROCEDURE ASUP_MOVE_MAN_UPDATE('
      '    :where,'
      '    :ID_PCARD,'
      '    :DATE_BEG,'
      '    :DATE_END,'
      ...
      '    :NOTE)')
    SelectSQL.Strings = (
      'SELECT * FROM ASUP_MOVE_MAN_SELECT(:where)')
    AddCaption = #1057#1090#1074#1086#1088#1077#1085#1085#1103' '#1087#1077#1088#1077#1074#1077#1076#1077#1085#1085#1103
    ModifyCaption = #1056#1077#1076#1072#1075#1091#1074#1072#1085#1085#1103' '#1087#1077#1088#1077#1074#1077#1076#1077#1085#1085#1103
    InfoCaption = #1055#1077#1088#1077#1075#1083#1103#1076' '#1087#1077#1088#1077#1074#1077#1076#1077#1085#1085#1103
  ...
  object PageControl: TPageControl
    ...
    object MainSheet: TTabSheet
      ...
      object qFLogicCheck2: TqFLogicCheck
        Left = 256
        Top = 104
        Width = 36
        Height = 21
        OnCheck = qFLogicCheck2Check
      end
      ...
      object DateEnd: TqFDateControl
        ...
        Height = 21
        FieldName = 'DATE_END'
        DisplayName = #1055#1077#1088#1077#1074#1077#1089#1090#1080' '#1076#1086
        Interval = 120
        Value = 38526
        LabelColor = clGreen
        Required = True
      ...
      object IspitSrok: TqFIntControl
        ...
        Height = 21
        FieldName = 'TEST_TERM'
        DisplayName = #1047' '#1074#1080#1087#1088#1086#1073#1085#1080#1084' '#1090#1077#1088#1084#1110#1085#1086#1084' ('#1084#1110#1089#1103#1094#1110#1074')'
        Interval = 250
        Value = 0
        LabelColor = clGreen
        Required = False
      ...
      object IsForever: TqFBoolControl
        ...
        DisplayName = #1055#1077#1088#1077#1074#1077#1089#1090#1080' '#1087#1086#1089#1090#1110#1081#1085#1086' ('#1073#1077#1079#1089#1090#1088#1086#1082#1086#1074#1086')'
        Interval = 120
        Value = False
        LabelColor = clGreen
        Required = False
      ...
      object OldWorkPlace: TqFSpravControl
        ...
        DisplayText = ''
        DisplayTextField = 'OLD_WORK_PLACE'
      end
  ...
  object GetIdMovingQuery: TpFIBDataSet
    ...
    SelectSQL.Strings = (
      ...
      'from   man_moving'
      'where id_order = :id_order and record_type in (2,3,6)')
    Left = 364
    Top = 44
  ...
  object WorkQuery: TpFIBDataSet
    ...
    DeleteSQL.Strings = (
        ...
        'execute procedure DT_MAN_MOV_SMET_DEL_BY_ORD_MOV(:id_order,:id_m' +
        'an_moving)')
    InsertSQL.Strings = (
    ...
    SelectSQL.Strings = (
        ...
        'select * from DT_MAN_MOV_SMET_SELECT_BY_ORD2(:id_order,:id_man_m' +
        'oving)')
    Left = 364
    Top = 80
    poSQLINT64ToBCD = True
  ...
  object GetDefaultsQuery: TpFIBDataSet
    ...
    SelectSQL.Strings = (
      ...
      '       ia.DEFAULT_ID_MOVING_TYPE_MOVE,'
      '       ia.DEFAULT_ID_SOVMEST_MOVE,'
    ...
    object GetDefaultsQueryDEFAULT_ID_MOVING_TYPE_MOVE: TFIBIntegerField
      FieldName = 'DEFAULT_ID_MOVING_TYPE_MOVE'
    end
    object GetDefaultsQueryDEFAULT_ID_SOVMEST_MOVE: TFIBIntegerField
  ...
  object AcceptCondQuery: TpFIBDataSet
    ...
    object AcceptCondQueryNAME_ACCEPT_COND: TFIBStringField
      DisplayLabel = #1059#1084#1086#1074#1080' '#1074#1089#1090#1091#1087#1091' '#1085#1072' '#1087#1086#1089#1072#1076#1091
  ...
  object BonusQuery: TpFIBDataSet
    ...
    SelectSQL.Strings = (
        ...
        'select * from ASUP_DT_MAN_BONUS_SELECT3(:id_order,:id_man_moving' +
        ')')
  ...
  object GetTypePost: TpFIBDataSet
    Database = LocalDatabase
    Transaction = LocalReadTransaction
    SelectSQL.Strings = (
      'SELECT p.Name_Type_Post, p.Id_Type_Post,'
      '       wc.Id_Work_Cond, wc.Name_Work_Cond,'
      '       wm.Id_Work_Mode, wm.Name,'
      '       ais.Id_Sovmest, ais.Name_Sovmest,'
      '       wr.Id_Work_Reason, wr.Name_Full'
      ''
      'FROM   man_moving mm'
      
        '    left join sp_type_post p on (mm.Id_Type_Post = p.Id_Type_Pos' +
        't)'
      
        '    left join Ini_Work_Cond wc on (mm.Id_Work_Cond = wc.Id_Work_' +
        'Cond)'
      
        '    left join dt_work_mode wm on (mm.Id_Work_Mode = wm.Id_Work_M' +
        'ode)'
      
        '    left join asup_ini_sovmest ais on (mm.is_main = ais.Id_Sovme' +
        'st)'
      
        '    left join Asup_Ini_Work_Reason wr on (mm.Id_Work_Reason = wr' +
        '.Id_Work_Reason)'
      ''
      'where  mm.id_man_moving = :id_man_moving;')
    AfterOpen = ShtatrasQueryAfterOpen
    Left = 296
    Top = 176
    poSQLINT64ToBCD = True
    object GetTypePostNAME_TYPE_POST: TFIBStringField
      FieldName = 'NAME_TYPE_POST'
      Size = 50
      EmptyStrToNull = True
    end
    object GetTypePostID_TYPE_POST: TFIBIntegerField
      FieldName = 'ID_TYPE_POST'
    end
    object GetTypePostID_WORK_COND: TFIBIntegerField
      FieldName = 'ID_WORK_COND'
    end
    object GetTypePostNAME_WORK_COND: TFIBStringField
      FieldName = 'NAME_WORK_COND'
      Size = 255
      EmptyStrToNull = True
    end
    object GetTypePostID_WORK_MODE: TFIBIntegerField
      FieldName = 'ID_WORK_MODE'
    end
    object GetTypePostNAME: TFIBStringField
      FieldName = 'NAME'
      Size = 255
      EmptyStrToNull = True
    end
    object GetTypePostID_SOVMEST: TFIBIntegerField
      FieldName = 'ID_SOVMEST'
    end
    object GetTypePostNAME_SOVMEST: TFIBStringField
      FieldName = 'NAME_SOVMEST'
      Size = 255
      EmptyStrToNull = True
    end
    object GetTypePostID_WORK_REASON: TFIBIntegerField
      FieldName = 'ID_WORK_REASON'
    end
    object GetTypePostNAME_FULL: TFIBStringField
      FieldName = 'NAME_FULL'
      Size = 255
      EmptyStrToNull = True
    end
  end
  object ReformSmetQuery: TpFIBDataSet
    Database = LocalDatabase
    Transaction = LocalWriteTransaction
    InsertSQL.Strings = (
      'execute procedure ASUP_ORDER_PROLONG_AUTO(:Id_Man_Moving);')
    Left = 300
    Top = 276
    poSQLINT64ToBCD = True
  end
