object fmHalfTimeOrderForm: TfmHalfTimeOrderForm
  Left = 299
  Top = 50
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsDialog
  Caption = #1053#1077#1087#1086#1074#1085#1080#1081' '#1088#1086#1073#1086#1095#1080#1081' '#1076#1077#1085#1100
  ClientHeight = 566
  ClientWidth = 792
  Color = clBtnFace
  ...
  object HalfTimeGrid: TcxGrid
    ...
    Align = alClient
    TabOrder = 0
    object HalfTimeView: TcxGridDBTableView
      ...
      object NumItem: TcxGridDBColumn
      ...
      object HoursFColumn: TcxGridDBColumn
        Caption = #1043#1086#1076#1080#1085' '#1089#1082#1086#1088#1086#1095#1077#1085#1085#1103
        Width = 124
        DataBinding.FieldName = 'Hours_F'
      end
      object FromWhereColumn: TcxGridDBColumn
        Caption = #1058#1080#1087' '#1089#1082#1086#1088#1086#1095#1077#1085#1085#1103
        Width = 125
        DataBinding.FieldName = 'FROM_WHERE'
      end
    end
    object HalfTimeGridLevel1: TcxGridLevel
      GridView = HalfTimeView
    end
  end
  ...
  object Panel3: TPanel
    ...
    Height = 28
    Align = alTop
    Caption = #1057#1087#1080#1089#1086#1082' '#1089#1087#1110#1074#1088#1086#1073#1110#1090#1085#1080#1082#1110#1074
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clMaroon
    Font.Height = -13
    Font.Name = 'MS Sans Serif'
  ...
  object SelectByOrder: TpFIBDataSet
    Database = DB
  ...
  object Source: TDataSource
    DataSet = SelectByOrder
    Left = 576
    Top = 288
  end
  object ActionControl: TqFActionControl
    DeleteSQL.Strings = (
      'EXECUTE PROCEDURE ASUP_TABLE_WORK_HALF_TIME_DEL :where')
    SelectDataSet = SelectByOrder
    KeyFields = 'ID_TABLE_WORK_HALF_TIME'
    RefreshAction = RefreshAction
    DeleteAction = DeleteAction
    AddFormClass = 'TfmAddManHalfTime'
    AddAction = AddAction
  ...
  object InsertNewOrder: TpFIBDataSet
    Database = DB
    Transaction = WriteTransaction
    SelectSQL.Strings = (
      'SELECT New_Id_Order'
      
        'FROM Insert_Order(:Id_Order, :Id_Order_Type, :Num_Order, :Date_O' +
        'rder, :Note, :Id_Status)')
    Left = 576
    Top = 400
    poSQLINT64ToBCD = True
