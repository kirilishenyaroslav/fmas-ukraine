object MainDM: TMainDM
  ...
  object ReportDataSet: TpFIBDataSet
    ...
    SelectSQL.Strings = (
      'SELECT'
      #9'ASUP_REPORT_INVALID.RANGEINVALID,'
      #9'ASUP_REPORT_INVALID.DATEVST,'
      #9'ASUP_REPORT_INVALID.FIO'
      'FROM ASUP_REPORT_INVALID(:DateE,:DateB);'
      '    ')
    Left = 96
    Top = 8
    poSQLINT64ToBCD = True
    object ReportDataSetRANGEINVALID: TFIBStringField
      FieldName = 'RANGEINVALID'
      Size = 70
      EmptyStrToNull = True
    end
    object ReportDataSetDATEVST: TFIBDateField
      FieldName = 'DATEVST'
    end
