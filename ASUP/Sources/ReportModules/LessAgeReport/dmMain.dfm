object MainDM: TMainDM
  ...
  object ReportDataSet: TpFIBDataSet
    ...
    SelectSQL.Strings = (
      'SELECT'
      #9'ASUP_REPORT_LESS_21.DEPARTMENT_NAME,'
      #9'ASUP_REPORT_LESS_21.FIO,'
      #9'ASUP_REPORT_LESS_21.POST_NAME,'
      #9'ASUP_REPORT_LESS_21.INCOME_DATE,'
      #9'ASUP_REPORT_LESS_21.BIRTH_DATE,'
      #9'ASUP_REPORT_LESS_21.ACHIEVE_AGE_DATE,'
      #9'ASUP_REPORT_LESS_21.DEPARTMENT_NAME_UPPER'
      'FROM ASUP_REPORT_LESS_21(?AGE,?IN_YEAR,?REPORT_DATE)')
    Active = True
    Left = 16
    Top = 64
    ...
    object ReportDataSetINCOME_DATE: TFIBDateField
    ...
    object ReportDataSetACHIEVE_AGE_DATE: TFIBDateField
      FieldName = 'ACHIEVE_AGE_DATE'
      DisplayFormat = 'dd.mm.yyyy'
    end
