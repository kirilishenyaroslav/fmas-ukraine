unit uPentionersReportForm;

interface

uses   DateUtils,
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  Dialogs,dmPentionersMain, cxControls, cxContainer, cxEdit, cxTextEdit, cxMaskEdit,
...
begin
 ...
 with DataModule.ConstsQuery do
  ...
  begin
   Close;
    ParamByName('PERIOD_BEG').Value:=(DateBegEdit.Date);
    ParamByName('PERIOD_END').Value:=(DateEndEdit.Date);
   CloseOpen(false);
  end;
    Report.LoadFromFile('Reports\Asup\AsupReportPensionersCommon.fr3');
