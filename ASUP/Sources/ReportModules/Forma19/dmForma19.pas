...
begin
    ...
    try
        ...
        DSetData.SQLs.SelectSQL.Text :='SELECT * FROM ASUP_FORMA19('''+DateToStr(PDateFormBeg)+''','''+DateToStr(PDateFormEnd)+''',?ID_DEPARTMENT) order by FIO';

        DSetDepartments.SQLs.SelectSQL.Text :=
                  'SELECT * FROM ASUP_FORMA19_DEPARTMENTS('''+
