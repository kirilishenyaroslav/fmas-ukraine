object DeadMainDM: TDeadMainDM
  ...
  object ReportDataSet: TpFIBDataSet
    ...
    SelectSQL.Strings = (
      'SELECT'
      #9'ASUP_REPORT_DEAD.FIO,'
      #9'ASUP_REPORT_DEAD.NAME_SOVMEST,'
      #9'ASUP_REPORT_DEAD.POST_NAME,'
      #9'ASUP_REPORT_DEAD.DEPARTMENT_NAME,'
      #9'ASUP_REPORT_DEAD.DEPARTMENT_NAME_UPPER,'
      #9'ASUP_REPORT_DEAD.REGARDS,'
      #9'ASUP_REPORT_DEAD.DATE_DISM,'
      #9'ASUP_REPORT_DEAD.NOTE,'
      #9'ASUP_REPORT_DEAD.IS_PROF,'
      #9'ASUP_REPORT_DEAD.IS_CANDIDATE'
      'FROM Asup_Report_Dead(:Date_Beg,:Date_End);'
      '    ')
    Active = True
    Left = 32
    Top = 64
    ...
    object ReportDataSetNAME_SOVMEST: TFIBStringField
    ...
    object ReportDataSetREGARDS: TFIBStringField
      FieldName = 'REGARDS'
      Size = 255
      EmptyStrToNull = True
    end
    object ReportDataSetDATE_DISM: TFIBDateField
      FieldName = 'DATE_DISM'
      DisplayFormat = 'dd.mm.yyyy'
    end
    object ReportDataSetNOTE: TFIBStringField
      FieldName = 'NOTE'
      Size = 255
      EmptyStrToNull = True
    end
    object ReportDataSetIS_PROF: TFIBIntegerField
      FieldName = 'IS_PROF'
    end
    object ReportDataSetIS_CANDIDATE: TFIBIntegerField
