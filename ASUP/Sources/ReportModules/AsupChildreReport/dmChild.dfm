object ChildDM: TChildDM
  ...
  object ReportDataSet: TpFIBDataSet
    ...
    SelectSQL.Strings = (
      'SELECT'
      #9'ASUP_MAN_CHILDERN_REPORT.DATE_BIRTH,'
      #9'ASUP_MAN_CHILDERN_REPORT.FIO_MAN,'
      #9'ASUP_MAN_CHILDERN_REPORT.FIO_CHILD'
      'FROM ASUP_MAN_CHILDERN_REPORT(:Date_Report);')
    Left = 96
    Top = 8
    ...
    object ReportDataSetFIO_MAN: TFIBStringField
      FieldName = 'FIO_MAN'
      Size = 100
      EmptyStrToNull = True
    end
    object ReportDataSetFIO_CHILD: TFIBStringField
      FieldName = 'FIO_CHILD'
      Size = 100
      EmptyStrToNull = True
    end
