object ReportForm: TReportForm
  ...
  Caption = #1057#1087#1080#1089#1086#1082' '#1076#1110#1090#1077#1081' '#1089#1087#1110#1074#1088#1086#1073#1110#1090#1085#1080#1082#1110#1074
  ClientHeight = 135
  ClientWidth = 379
  Color = clBtnFace
  ...
  object cxDateEditNow: TcxDateEdit
    Left = 8
    Top = 40
    Width = 121
    Height = 21
  ...
  object ZReport: TfrxReport
    ...
    ReportOptions.LastChange = 38714.640998252290000000
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo4: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.Strings = (
            #1057#1087#1080#1089#1086#1082' '#1076#1110#1090#1077#1081' '#1088#1086#1073#1110#1090#1085#1080#1082#1110#1074' '
            #1044#1086#1085#1077#1094#1100#1082#1086#1075#1086' '#1053#1072#1094#1110#1086#1085#1072#1083#1100#1085#1086#1075#1086' '#1059#1085#1110#1074#1077#1088#1089#1080#1090#1085#1090#1072
            #1055#1055#1057' ( '#1059#1044' )')
          ParentFont = False
          VAlign = vaCenter
        end
      end
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo6: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.Strings = (
            #1055'.'#1030'.'#1041' '#1076#1080#1090#1080#1085#1080' ('#1088#1086#1089'.)')
          VAlign = vaCenter
        end
        ...
        object Memo8: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.Strings = (
            #1055'.'#1030'.'#1041' '#1076#1080#1090#1080#1085#1080' ('#1091#1082#1088'.)')
          VAlign = vaCenter
        end
