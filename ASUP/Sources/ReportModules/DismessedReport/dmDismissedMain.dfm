object MainDM: TMainDM
  ...
  object ReportDataSet: TpFIBDataSet
    ...
    SelectSQL.Strings = (
      'SELECT'
      #9'ASUP_REPORT_DISMISSED.FIO,'
      #9'ASUP_REPORT_DISMISSED.NAME_SOVMEST,'
      #9'ASUP_REPORT_DISMISSED.POST_NAME,'
      #9'ASUP_REPORT_DISMISSED.DEPARTMENT_NAME,'
      #9'ASUP_REPORT_DISMISSED.DEPARTMENT_NAME_UPPER,'
      #9'ASUP_REPORT_DISMISSED.REGARDS,'
      #9'ASUP_REPORT_DISMISSED.DATE_DISM,'
      #9'ASUP_REPORT_DISMISSED.NOTE,'
      #9'ASUP_REPORT_DISMISSED.IS_PROF,'
      #9'ASUP_REPORT_DISMISSED.IS_CANDIDATE'
      'FROM ASUP_REPORT_DISMISSED(?PERIOD_BEG,?PERIOD_END)')
    Left = 16
    Top = 64
