object ScienceDM: TScienceDM
  ...
  object ReportDataSet: TpFIBDataSet
    ...
    SelectSQL.Strings = (
      'SELECT'
      #9'ASUP_REPORT_SCIENCE_PENSION.FIO,'
      #9'ASUP_REPORT_SCIENCE_PENSION.PENSION_TYPE,'
      #9'ASUP_REPORT_SCIENCE_PENSION.PENSION_DATE,'
      #9'ASUP_REPORT_SCIENCE_PENSION.DISMISSION_DATE'
      'FROM ASUP_REPORT_SCIENCE_PENSION(:REPORT_DATE)')
    Left = 56
    Top = 64
    ...
    object ReportDataSetPENSION_TYPE: TFIBStringField
      FieldName = 'PENSION_TYPE'
      Size = 255
      EmptyStrToNull = True
    end
    object ReportDataSetPENSION_DATE: TFIBDateField
      FieldName = 'PENSION_DATE'
    end
    object ReportDataSetDISMISSION_DATE: TFIBDateField
      FieldName = 'DISMISSION_DATE'
    end
  end
