object fmMoveReport: TfmMoveReport
  Left = 175
  Top = 141
  Width = 543
  Height = 283
  Caption = #1047#1074#1110#1090' '#1079' '#1087#1077#1088#1077#1074#1086#1076#1110#1074
  Color = clBtnFace
  ...
  object SignPost: TqFCharControl
    ...
    Height = 21
    FieldName = 'SignPost'
    DisplayName = #1055#1086#1089#1072#1076#1072' '#1086#1089#1086#1073#1080', '#1097#1086' '#1087#1110#1076#1087#1080#1089#1091#1108' '#1079#1074#1110#1090
    Interval = 220
    Value = ''
    LabelColor = clGreen
    Required = False
  ...
  object SignFIO: TqFCharControl
    ...
    Height = 21
    FieldName = 'SignFIO'
    DisplayName = #1055'. '#1030'. '#1055'/'#1073' '#1086#1089#1086#1073#1080', '#1097#1086' '#1087#1110#1076#1087#1080#1089#1091#1108' '#1079#1074#1110#1090
    Interval = 220
    Value = ''
    LabelColor = clGreen
    Required = False
  ...
  object Report: TfrxReport
    ...
    ReportOptions.CreateDate = 38594.479541354160000000
    ReportOptions.LastChange = 38594.479541354160000000
