object ScienceReportDM: TScienceReportDM
  ...
  object ReportDataSet: TpFIBDataSet
    ...
    SelectSQL.Strings = (
      'SELECT'
      #9'ASUP_REPORT_SCIENCE_REGARDS.REGARDS_STEP,'
      #9'ASUP_REPORT_SCIENCE_REGARDS.REGARDS_ZVAN,'
      #9'ASUP_REPORT_SCIENCE_REGARDS.SCIENCE_SPEC,'
      #9'ASUP_REPORT_SCIENCE_REGARDS.FIO,'
      #9'ASUP_REPORT_SCIENCE_REGARDS.DEPARTMENT_NAME,'
      #9'ASUP_REPORT_SCIENCE_REGARDS.DEPARTMENT_NAME_UPPER'
      'FROM ASUP_REPORT_SCIENCE_REGARDS(:ID_REGARD_PROP,'
      ':REPORT_DATE)')
    Left = 40
    Top = 80
    poSQLINT64ToBCD = True
    object ReportDataSetREGARDS_STEP: TFIBStringField
      FieldName = 'REGARDS_STEP'
      Size = 255
      EmptyStrToNull = True
    end
    object ReportDataSetREGARDS_ZVAN: TFIBStringField
      FieldName = 'REGARDS_ZVAN'
      Size = 255
      EmptyStrToNull = True
    end
    object ReportDataSetSCIENCE_SPEC: TFIBStringField
      FieldName = 'SCIENCE_SPEC'
      Size = 255
      EmptyStrToNull = True
    end
  ...
  object RegardsPropertiesDataSet: TpFIBDataSet
    Database = Database
    Transaction = ReadTransaction
    SelectSQL.Strings = (
      'SELECT'
      #9'SP_REGARDS_PROPERTIES.ID_PROPERTIE,'
      #9'SP_REGARDS_PROPERTIES.PROP_NAME'
      'FROM SP_REGARDS_PROPERTIES')
    Left = 168
    Top = 216
    poSQLINT64ToBCD = True
    object RegardsPropertiesDataSetID_PROPERTIE: TFIBIntegerField
      FieldName = 'ID_PROPERTIE'
    end
    object RegardsPropertiesDataSetPROP_NAME: TFIBStringField
      FieldName = 'PROP_NAME'
      Size = 25
      EmptyStrToNull = True
    end
  ...
  object PropertiesDataSource: TDataSource
    DataSet = RegardsPropertiesDataSet
    Left = 40
    Top = 216
  end
end
