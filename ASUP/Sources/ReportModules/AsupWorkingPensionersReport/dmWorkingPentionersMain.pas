...
type
  TMainDM = class(TDataModule)
    ...
    ReportDataSetTIN_NUM: TFIBStringField;
    ReportDataSetDATE_BIRTH: TFIBDateField;
    ReportDataSetDATE_START_PENTION: TFIBDateField;
    ReportDataSetDATE_DISMISSION: TFIBStringField;
    ReportDataSetADRES: TFIBStringField;
    ReportDataSetFIO_PENTION: TFIBStringField;
  private
