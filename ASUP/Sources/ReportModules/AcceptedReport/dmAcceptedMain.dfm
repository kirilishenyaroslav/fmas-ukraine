object MainDM: TMainDM
  ...
  object ReportDataSet: TpFIBDataSet
    ...
    SelectSQL.Strings = (
      'SELECT'
      #9'ASUP_REPORT_ACCEPTED.FIO,'
      #9'ASUP_REPORT_ACCEPTED.NAME_SOVMEST,'
      #9'ASUP_REPORT_ACCEPTED.POST_NAME,'
      #9'ASUP_REPORT_ACCEPTED.DEPARTMENT_NAME,'
      #9'ASUP_REPORT_ACCEPTED.DEPARTMENT_NAME_UPPER,'
      #9'ASUP_REPORT_ACCEPTED.REGARDS,'
      #9'ASUP_REPORT_ACCEPTED.DATE_ACC,'
      #9'ASUP_REPORT_ACCEPTED.IS_PROF,'
      #9'ASUP_REPORT_ACCEPTED.IS_CANDIDATE'
      'FROM ASUP_REPORT_ACCEPTED(?PERIOD_BEG,?PERIOD_END)')
    Left = 16
    Top = 64
    ...
    object ReportDataSetDATE_ACC: TFIBDateField
      FieldName = 'DATE_ACC'
    end
