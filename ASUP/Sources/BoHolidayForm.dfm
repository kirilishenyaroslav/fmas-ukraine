object BoHoliday: TBoHoliday
  Left = 198
  Top = 179
  Width = 697
  Height = 480
  Caption = #1042#1110#1076#1087#1091#1089#1090#1082#1080' '#1073#1077#1079' '#1086#1087#1083#1072#1090#1080
  Color = clBtnFace
  ...
  object HolidayGrid: TDBGrid
    ...
    OnKeyDown = HolidayGridKeyDown
    OnKeyPress = HolidayGridKeyPress
    Columns = <
      item
        Expanded = False
        FieldName = 'NUM_ITEM'
      ...
      item
        Expanded = False
        FieldName = 'H_TERM'
        Title.Caption = #1076#1085#1110#1074
        Width = 37
        Visible = True
      end
      item
  ...
  object ResultQuery: TIBQuery
    ...
    CachedUpdates = False
    SQL.Strings = (
      'SELECT * FROM GET_BO_HOLIDAYS_BY_ORDER(:ID_ORDER)')
    Left = 216
    Top = 225
    ParamData = <
      item
