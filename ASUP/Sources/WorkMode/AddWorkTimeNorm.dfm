object AddWorkTimeForm: TAddWorkTimeForm
  Left = 251
  Top = 110
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsDialog
  Caption = #1044#1086#1076#1072#1090#1080' '#1085#1086#1088#1084#1091' '#1088#1086#1073#1086#1095#1086#1075#1086' '#1095#1072#1089#1091
  ClientHeight = 166
  ClientWidth = 325
  Color = clBtnFace
  ...
  object Kol_HoursLabel: TLabel
    Left = 24
    Top = 88
    Width = 132
    Height = 13
    Caption = #1053#1086#1088#1084#1072' '#1088#1086#1073#1086#1095#1086#1075#1086' '#1095#1072#1089#1091':'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clGreen
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  object FC_Year: TFieldControl
    Left = 304
    Top = 24
    Width = 18
    Height = 18
    Control = YearBox
    ReadFromField = DetailsQueryWTYEAR
    Title = '"'#1056#1110#1082'"'
    MaxLength = 0
    ExactLength = 0
  ...
  object FC_Month: TFieldControl
    Left = 304
    Top = 56
    Width = 18
    Height = 18
    Control = MonthBox
    ReadFromField = DetailsQueryWTMONTH
    Title = '"'#1052#1110#1089#1103#1094#1100'"'
    MaxLength = 0
    ExactLength = 0
    CapitalizeStyle = csNone
  end
  object FC_KolHours: TFieldControl
    Left = 304
    Top = 88
    Width = 18
    Height = 18
    Control = KolHoursEdit
    ReadFromField = DetailsQueryKOL_HOURS
    Title = '"'#1053#1086#1088#1084#1072' '#1088#1086#1073#1086#1095#1086#1075#1086' '#1095#1072#1089#1091'"'
    MaxLength = 0
    ExactLength = 0
    CapitalizeStyle = csNone
  end
  ...
  object KolHoursEdit: TCheckEdit
    Left = 184
    Top = 88
    Width = 97
    Height = 21
  ...
  object DetailsQuery: TIBQuery
    ...
    CachedUpdates = False
    SQL.Strings = (
      'SELECT wtYear, wtMonth, Kol_Hours'
      'FROM dt_WorkTimeNorm'
      'WHERE wtYear = :wtYear'
      'and wtMonth = :wtMonth')
    Left = 16
    Top = 128
    ...
    object DetailsQueryWTYEAR: TIntegerField
      FieldName = 'WTYEAR'
      Required = True
    end
    object DetailsQueryWTMONTH: TIntegerField
      FieldName = 'WTMONTH'
      Required = True
    end
    object DetailsQueryKOL_HOURS: TIBBCDField
      FieldName = 'KOL_HOURS'
      Precision = 9
      Size = 2
    end
