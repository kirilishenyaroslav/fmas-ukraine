object fmCopyExc: TfmCopyExc
  Left = 233
  Top = 114
  Width = 397
  Height = 218
  Caption = #1050#1086#1087#1110#1102#1074#1072#1090#1080' '#1074#1080#1085#1103#1090#1082#1080' '#1088#1077#1078#1080#1084#1110#1074' '#1087#1088#1072#1094#1110
  Color = clBtnFace
  ...
  object Label6: TLabel
    ...
    Width = 231
    Height = 13
    Caption = #1050#1086#1087#1110#1102#1074#1072#1090#1080' '#1074#1080#1085#1103#1090#1082#1080' '#1091' '#1094#1077#1081' '#1088#1077#1078#1080#1084' '#1087#1088#1072#1094#1110':'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clMaroon
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  object Label1: TLabel
    ...
    Width = 251
    Height = 13
    Caption = #1050#1086#1087#1110#1102#1074#1072#1090#1080' '#1074#1080#1085#1103#1090#1082#1080' '#1079' '#1094#1100#1086#1075#1086' '#1088#1077#1078#1080#1084#1091' '#1087#1088#1072#1094#1110':'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clGreen
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  object TargetWorkMode: TSpComboBox
    Left = 22
    Top = 36
    Width = 339
    Height = 21
  ...
  object SourceWorkMode: TSpComboBox
    Left = 22
    Top = 100
    Width = 339
    Height = 21
  ...
  object WorkQuery: TIBQuery
    ...
    CachedUpdates = False
    SQL.Strings = (
      'EXECUTE PROCEDURE Copy_Work_Exc :Source, :Target')
    Left = 24
    Top = 144
    ParamData = <
      item
