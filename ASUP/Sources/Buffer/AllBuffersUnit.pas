...
procedure TAllBuffersForm.nach_dump;
var
    First_PBKey, Last_PBKey: Integer;
begin
    try
        WriteTransaction.StartTransaction;
        GetPBKeyRange('SELECT * FROM ASUP_LTD_ALL_NACH_EXPORT', First_PBKey, Last_PBKey);
        ExportRange(WriteTransaction, First_PBKey, Last_PBKey, 'Sp_Nach', 'Buff_Sp_Nach');
    ...
    Nach.Font.Color := clMaroon;
end;

procedure TAllBuffersForm.VO_DUMP;
var
    ID_PBKey, First_PBKey, Last_PBKey: Integer;
    form: TProcessForm;
begin
    if version = 1 then
    begin
        try
            WriteTransaction.StartTransaction;
            GetPBKeyRange('SELECT * FROM ASUP_LTD_ALL_VIDOPL_EXPORT', First_PBKey, Last_PBKey);
            ExportRange(WriteTransaction, First_PBKey, Last_PBKey, 'Payment', 'Buff_Payment');
...
begin
{
    ...
    MassExport('Pep_Data', 'Buff_Pep_Data', 'SELECT * FROM ASUP_LTD_ALL_PCARD_EXPORT');
...
begin
    ...
    begin
        try
            WriteTransaction.StartTransaction;
            GetPBKeyRange('SELECT * FROM ASUP_LTD_ALL_POST_EXPORT', First_PBKey, Last_PBKey);
            ExportRange(WriteTransaction, First_PBKey, Last_PBKey, 'Sp_Post', 'Buff_Sp_Post');
...
begin
    ...
    begin
        try
            WriteTransaction.StartTransaction;
            GetPBKeyRange('SELECT * FROM ASUP_LTD_ALL_TIME_EXPORT', First_PBKey, Last_PBKey);
            ExportRange(WriteTransaction, First_PBKey, Last_PBKey, 'Sp_Time', 'Buff_Sp_Time');
            ExportRange(WriteTransaction, First_PBKey, Last_PBKey, 'Dt_Time', 'Buff_Dt_Time');
...
begin
    ...
    begin
        try
            WriteTransaction.StartTransaction;
            GetPBKeyRange('SELECT * FROM ASUP_LTD_ALL_VIHOD_EXPORT', First_PBKey, Last_PBKey);
            ExportRange(WriteTransaction, First_PBKey, Last_PBKey, 'Day_Type', 'Buff_Day_Type');
...
var
    ID_PBKey, y, m, First_PBKey, Last_PBKey: Integer;
    form: TProcessForm;
    dayString: string;
begin
    if version = 1 then
    begin
        try
            WriteTransaction.StartTransaction;
            GetPBKeyRange('SELECT * FROM ASUP_LTD_ALL_CALENDAR_EXPORT', First_PBKey, Last_PBKey);
            ExportRange(WriteTransaction, First_PBKey, Last_PBKey, 'Calender', 'Buff_Calender');
...
begin
    ...
    begin
        try
            WriteTransaction.StartTransaction;
            GetPBKeyRange('SELECT * FROM ASUP_LTD_ALL_TABLE_EXPORT', First_PBKey, Last_PBKey);
            ExportRange(WriteTransaction, First_PBKey, Last_PBKey, 'Table', 'Buff_Table');
            ExportRange(WriteTransaction, First_PBKey, Last_PBKey, 'Tab_Hour', 'Buff_Tab_Hour');
...
procedure TAllBuffersForm.orders_dump;
var
    First_PBKey, Last_PBKey: Integer;
    err: Boolean;
begin
    ...
    try
        WriteTransaction.StartTransaction;
        GetPBKeyRange('SELECT * FROM ASUP_LTD_ALL_ORDERS_EXPORT', First_PBKey, Last_PBKey);
        ExportRange(WriteTransaction, First_PBKey, Last_PBKey, 'Pep_Ord', 'Buff_Pep_Ord');
        ExportRange(WriteTransaction, First_PBKey, Last_PBKey, 'Bonus', 'Buff_Bonus');
        ExportRange(WriteTransaction, First_PBKey, Last_PBKey, 'Holiday', 'Buf_Holiday');
    ...
    begin
        WriteTransaction.Commit;
        OrdersRadio.Font.Color := clMaroon;
    end;
end;
...
begin
    ...
    begin
        try
            WriteTransaction.StartTransaction;
            GetPBKeyRange('SELECT * FROM ASUP_LTD_ALL_HOSP_EXPORT', First_PBKey, Last_PBKey);
            ExportRange(WriteTransaction, First_PBKey, Last_PBKey, 'Hospital', 'Buf_Hospital');
            ExportRange(WriteTransaction, First_PBKey, Last_PBKey, 'Hosp_Det', 'Buf_Hosp_Det');
...
begin
    ...
    if OrdersRadio.Checked then orders_dump;
    if Nach.Checked then nach_dump;
