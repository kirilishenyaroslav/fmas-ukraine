object PCardsViewForm: TPCardsViewForm
  ...
  object PCardGrid: TDBGrid
    ...
    OnDrawColumnCell = PCardGridDrawColumnCell
  ...
  object ResultQuery: TIBQuery
    ...
    SQL.Strings = (
        ...
        'SELECT Id_PCard, TN, Familia, Imya, Otchestvo, Id_Man, Date_Clos' +
        'e, Id_Server'
    ...
    object ResultQueryDATE_CLOSE: TDateField
      FieldName = 'DATE_CLOSE'
    end
    object ResultQueryID_SERVER: TIntegerField
      FieldName = 'ID_SERVER'
      Origin = 'PCARD_LIST.ID_SERVER'
    end
  end
  ...
  object SysOptQuery: TIBQuery
    Database = Main.ChermetDatabase
    Transaction = Main.DefaultTransaction
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'SELECT ID_SERVER FROM SYS_OPTIONS')
    Left = 8
    Top = 392
    object SysOptQueryID_SERVER: TIntegerField
      FieldName = 'ID_SERVER'
      Origin = 'SYS_OPTIONS.ID_SERVER'
    end
  end
end
