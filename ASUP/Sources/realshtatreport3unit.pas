...
uses PersonalCommon, DepartmentsViewUnit, uExportReport, qFTools;
{$R *.dfm}
...
begin
    ...
    StructQuery.Transaction := PersonalCommon.ReadTransaction;
...
begin
    ...
    Report.Variables['Firm_Name'] := QuotedStr(Consts_Query['Firm_Name']);
    Report.Variables['AllStavok'] := QuotedStr(FloatToStr(AllStavok));
    Report.Variables['AllFund'] := QuotedStr(FloatToStr(AllFund));
    Report.Variables['Hidden_Id_Post'] := Consts_Query['Hidden_Id_Post'];
