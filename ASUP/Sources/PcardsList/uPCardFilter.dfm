object fmPCardFilter: TfmPCardFilter
  Left = 372
  Top = 244
  Width = 457
  Height = 163
  Caption = #1060#1110#1083#1100#1090#1088' '#1089#1087#1080#1089#1082#1072' '#1086#1089#1086#1073#1086#1074#1080#1093' '#1082#1072#1088#1090#1086#1082
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object FilterString: TqFCharControl
    Left = 16
    Top = 16
    Width = 409
    Height = 21
    DisplayName = #1060#1110#1083#1100#1090#1088' '#1079#1072' '#1055'.'#1030'.'#1055'/'#1073'. '#1072#1073#1086' '#1090#1072#1073#1077#1083#1100#1085#1080#1084' '#1085#1086#1084#1077#1088#1086#1084
    Interval = 300
    Value = ''
    LabelColor = clGreen
    Required = True
  ...
  object RusFIO: TqFBoolControl
    Left = 24
    Top = 48
    Width = 200
    Height = 21
    DisplayName = #1060#1110#1083#1100#1090#1088' '#1079#1072' '#1088#1086#1089#1110#1081#1089#1100#1082#1080#1084' '#1055'.'#1030'.'#1055'/'#1073'.'
    Interval = 120
    Value = False
    LabelColor = clGreen
    Required = True
