object PassVidanForm: TPassVidanForm
  Left = 193
  Top = 135
  BorderStyle = bsSingle
  Caption = #1044#1086#1074#1110#1076#1085#1080#1082' '#1074#1110#1076#1076#1110#1083#1110#1074' '#1052#1042#1044
  ClientHeight = 381
  ClientWidth = 505
  Color = clBtnFace
  ...
  object ResultGrid: TDBGrid
    ...
    Columns = <
      item
        Expanded = False
        FieldName = 'VIDAN'
        Title.Caption = #1042#1110#1076#1076#1110#1083' '#1052#1042#1044
  ...
  object ResultQuery: TIBQuery
    ...
    CachedUpdates = False
    SQL.Strings = (
      'SELECT DISTINCT  VIDAN FROM PASS_DATA ORDER BY VIDAN')
    Left = 216
    Top = 344
    object ResultQueryVIDAN: TIBStringField
      FieldName = 'VIDAN'
