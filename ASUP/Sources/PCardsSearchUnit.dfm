object PCardsSearchForm: TPCardsSearchForm
  Left = 203
  Top = 166
  ...
  object SearchRadioGroup: TRadioGroup
    ...
    ItemIndex = 0
    Items.Strings = (
      #1055#1088#1110#1079#1074#1080#1097#1091
      #1058#1072#1073#1077#1083#1100#1085#1086#1084#1091' '#1085#1086#1084#1077#1088#1091)
    TabOrder = 0
    OnClick = SearchRadioGroupClick
  end
  ...
  object SearchTNQuery: TIBQuery
    ...
    object SearchTNQueryID_PCARD: TIntegerField
      FieldName = 'ID_PCARD'
      Origin = 'PRIVATE_CARDS.ID_PCARD'
      Required = True
    end
  end
  object SearchFamiliaQuery: TIBQuery
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'SELECT Id_PCard '
      ...
      'WHERE'
      'C.Id_Man = P.Id_Man'
      'AND Rus_Familia STARTING WITH :Familia')
    Left = 168
    Top = 8
    ParamData = <
      item
    ...
    object SearchFamiliaQueryID_PCARD: TIntegerField
      FieldName = 'ID_PCARD'
      Required = True
    end
  end
