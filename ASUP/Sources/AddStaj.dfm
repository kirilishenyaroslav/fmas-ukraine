object AddStajForm: TAddStajForm
  Left = 226
  Top = 187
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object FC_name_staj: TFieldControl
    Left = 303
    Top = 32
    Width = 18
    Height = 18
    Control = name_stajEdit
    ReadFromField = DetailsQueryname_staj
    Title = '"'#1057#1090#1072#1078'"'
    MaxLength = 50
    ExactLength = 0
    CapitalizeStyle = csNone
  end
  object FC_is_default: TFieldControl
    Left = 175
    Top = 64
    Width = 18
    Height = 18
    Control = is_defaultBox
    ReadFromField = DetailsQueryis_default
    Title = '"'#1040#1074#1090#1086#1084#1072#1090#1080#1095#1085#1086'"'
    MaxLength = 0
    ExactLength = 0
    CapitalizeStyle = csNone
  end
  ...
  object Label2: TLabel
    ...
    Width = 129
    Height = 13
    Caption = #1057#1090#1072#1074#1080#1090#1080' '#1072#1074#1090#1086#1084#1072#1090#1080#1095#1085#1086
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clGreen
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  object name_stajEdit: TCheckEdit
    Left = 5
    Top = 28
    Width = 292
    Height = 21
  ...
  object is_defaultBox: TCheckBox
    Left = 141
    Top = 55
    Width = 20
    Height = 17
  ...
  object DetailsQuery: TIBQuery
    ...
    SQL.Strings = (
        ...
        'SELECT name_staj,is_default FROM ini_staj WHERE id_staj = :id_st' +
        'aj')
    Left = 88
    ParamData = <
      item
    ...
    object DetailsQueryname_staj: TIBStringField
      FieldName = 'name_staj'
      Size = 50
    end
    object DetailsQueryis_default: TIBStringField
