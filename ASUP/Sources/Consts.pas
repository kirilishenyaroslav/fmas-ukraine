{ -internal}
{-$Id: Consts.pas,v 1.2 2007/01/30 15:48:52 oleg Exp $}
...
resourcestring
    ...
    SMsgDlgWarning = 'Увага!';
    SMsgDlgError = 'Помилка!';
    SMsgDlgInformation = 'Інформація';
    SMsgDlgConfirm = 'Підтвердження';
    SMsgDlgYes = '&Так';
    SMsgDlgNo = '&Ні';
    SMsgDlgOK = 'Гаразд';
    SMsgDlgCancel = 'Відміна';
    SMsgDlgHelp = '&Довідка';
    SMsgDlgHelpNone = 'Нема довідки';
    SMsgDlgHelpHelp = 'Довідка';
    SMsgDlgAbort = '&Abort';
    SMsgDlgRetry = '&Retry';
