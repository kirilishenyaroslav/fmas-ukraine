object F_SP_Raise_Del: TF_SP_Raise_Del
  Left = 307
  Top = 276
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsDialog
  Caption = #1047' '#1103#1082#1086#1075#1086' '#1076#1085#1103' '#1079#1072#1082#1088#1080#1090#1080' '#1085#1072#1076#1073#1072#1074#1082#1091'?'
  ClientHeight = 88
  ClientWidth = 338
  Color = clBtnFace
  ...
  object DT_DateEnd: TDateTimePicker
    ...
    Width = 89
    Height = 21
    Date = 38405.989882442130000000
    Format = 'dd.MM.yyyy'
    Time = 38405.989882442130000000
    TabOrder = 0
  end
