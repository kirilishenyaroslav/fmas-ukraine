object _AddInvalidForm: T_AddInvalidForm
  Left = 382
  Top = 246
  BorderStyle = bsDialog
  Caption = #1044#1086#1076#1072#1090#1080'/'#1047#1084#1110#1085#1080#1090#1080' '#1074#1083#1072#1089#1090#1080#1074#1110#1089#1090#1100
  ClientHeight = 145
  ClientWidth = 466
  Color = clBtnFace
  ...
  object Label1: TLabel
    ...
    Width = 174
    Height = 16
    Caption = #1044#1086#1076#1072#1090#1082#1086#1074#1072' '#1074#1083#1072#1089#1090#1080#1074#1110#1089#1090#1100
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clGreen
    Font.Height = -13
    Font.Name = 'MS Sans Serif'
  ...
  object SpCB_Inv: TSpComboBox
    ...
    AutoDrop = True
    SpParams.Table = 'ASUP_ADD_PROPS'
    SpParams.IdField = 'id_prop'
    SpParams.SpFields = 'id_prop;prop_neme'
    SpParams.Title = #1042#1083#1072#1089#1090#1080#1074#1086#1089#1090#1110
    SpParams.ComboField = 'prop_neme'
    SpParams.ColumnNames = #1042#1083#1072#1089#1090#1080#1074#1086#1089#1090#1110
