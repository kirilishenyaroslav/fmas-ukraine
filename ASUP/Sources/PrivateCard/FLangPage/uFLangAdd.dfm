object AddFLangForm: TAddFLangForm
  Left = 349
  Top = 300
  BorderStyle = bsDialog
  Caption = #1044#1086#1076#1072#1090#1080'/'#1047#1084#1110#1085#1080#1090#1080' '#1084#1086#1074#1091
  ClientHeight = 120
  ClientWidth = 548
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object FC_FLang: TFieldControl
    Left = 525
    Top = 7
    Width = 18
    Height = 18
    Control = SpCB_FLang
    Title = '"'#1052#1086#1074#1072'"'
    MaxLength = 0
    ExactLength = 0
  ...
  object FC_Degree: TFieldControl
    Left = 525
    Top = 47
    Width = 18
    Height = 18
    Control = SpCB_Degree
    Title = '"'#1057#1090#1091#1087#1110#1085#1100' '#1074#1086#1083#1086#1076#1110#1085#1085#1103'"'
    MaxLength = 0
    ExactLength = 0
    CapitalizeStyle = csNone
  end
  object SpCB_FLang: TSpComboBox
    Left = 149
    Top = 6
    Width = 369
    Height = 21
    ...
    AutoDrop = True
    SpParams.Table = 'ASUP_FLang'
    SpParams.IdField = 'id_FLang'
    SpParams.SpFields = 'name_FLang'
    SpParams.Title = #1030#1085#1086#1079#1077#1084#1085#1110' '#1084#1086#1074#1080
    SpParams.ComboField = 'name_FLang'
    SpParams.ColumnNames = #1052#1086#1074#1072
  ...
  object SpCB_Degree: TSpComboBox
    Left = 149
    Top = 46
    Width = 369
    Height = 21
    ...
    SpOpenItem = #1030#1085#1096#1072'...'
    AutoDrop = True
    SpParams.Table = 'ASUP_FLang_degree'
    SpParams.IdField = 'id_FLang_degree'
    SpParams.SpFields = 'name_degree'
    SpParams.Title = #1057#1090#1091#1087#1110#1085#1110' '#1074#1086#1083#1086#1076#1110#1085#1085#1103' '#1110#1085#1086#1079#1077#1084#1085#1086#1102' '#1084#1086#1074#1086#1102
    SpParams.ComboField = 'name_degree'
    SpParams.ColumnNames = #1057#1090#1091#1087#1110#1085#1100' '#1074#1086#1083#1086#1076#1110#1085#1085#1103
    SpParams.DontHideFirstColumn = False
    SpParams.SpMode = [spfAdd, spfModify, spfDelete, spfFind, spfSelect, spfExt]
  end
end
