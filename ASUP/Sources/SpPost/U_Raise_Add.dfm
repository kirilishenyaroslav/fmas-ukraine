object AddRaiseForm: TAddRaiseForm
  Left = 356
  Top = 204
  BorderStyle = bsDialog
  Caption = #1044#1086#1076#1072#1090#1080' '#1085#1072#1076#1073#1072#1074#1082#1091
  ClientHeight = 87
  ClientWidth = 492
  Color = clBtnFace
  ...
  object qFSC_Raise: TqFSpravControl
    Left = 8
    Top = 8
    Width = 473
    Height = 21
    ...
    OnOpenSprav = qFSC_RaiseOpenSprav
    DisplayText = ''
  end
  object qFFC_Percent: TqFFloatControl
    Left = 8
    Top = 32
    Width = 153
    Height = 21
  ...
  object pFIBDS_Raise: TpFIBDataSet
    SelectSQL.Strings = (
      'select * from SP_RAISE_SELECT2(:id_raise,:act_date);')
    Left = 224
    Top = 59
