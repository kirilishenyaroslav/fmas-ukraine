object fmAddHolidayLong: TfmAddHolidayLong
  Left = 367
  Top = 114
  ...
  object FormControl: TqFFormControl
    ...
    InsertSQL.Strings = (
        ...
        'SELECT Id_Post_Holiday FROM SP_POST_HOLIDAY_I(:Holiday_Long, :Id' +
        '_Holiday)')
    UpdateSQL.Strings = (
      
        'EXECUTE PROCEDURE SP_POST_HOLIDAY_U(:where, :Holiday_Long, :Id_H' +
        'oliday)')
    SelectSQL.Strings = (
      'SELECT * FROM Sp_Post_Holiday_S(:where)')
    AddCaption = #1042#1110#1076#1087#1091#1089#1090#1082#1072' '#1076#1086' '#1087#1086#1089#1072#1076#1080': '#1076#1086#1076#1072#1090#1080
    ModifyCaption = #1042#1110#1076#1087#1091#1089#1090#1082#1072' '#1076#1086' '#1087#1086#1089#1072#1076#1080': '#1079#1084#1110#1085#1080#1090#1080
    InfoCaption = #1042#1110#1076#1087#1091#1089#1090#1082#1072' '#1076#1086' '#1087#1086#1089#1072#1076#1080': '#1087#1077#1088#1077#1075#1083#1103#1076
    Mode = fmAdd
    CheckWhere = True
    CloseForm = True
  ...
  object HolidayLong: TqFIntControl
    Left = 16
    Top = 16
    Width = 425
    Height = 21
    FieldName = 'Holiday_Long'
    DisplayName = #1058#1088#1080#1074#1072#1083#1110#1089#1090#1100' '#1074#1110#1076#1087#1091#1089#1090#1082#1080
    Interval = 200
    Value = Null
    LabelColor = clGreen
    Required = True
  ...
  object TypeHoliday: TqFSpravControl
    Left = 16
    Top = 56
    Width = 433
    Height = 21
    ...
    OnOpenSprav = TypeHolidayOpenSprav
    DisplayText = ''
    DisplayTextField = 'Holiday_Type_Full_Name'
  end
  ...
  object ActionList1: TActionList
    Left = 240
    Top = 96
    object AcceptButton: TAction
      Caption = #1043#1072#1088#1072#1079#1076
      ShortCut = 121
      SecondaryShortCuts.Strings = (
        'Ctrl+End')
      OnExecute = AcceptButtonExecute
    end
  end
end
