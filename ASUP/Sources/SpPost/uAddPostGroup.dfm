object fmAddPostGroup: TfmAddPostGroup
  Left = 367
  Top = 114
  ...
  object FormControl: TqFFormControl
    ...
    InsertSQL.Strings = (
      'SELECT *'
      'FROM UP_SP_POST_GROUP_INSERT(:Name_Post_Group)')
    UpdateSQL.Strings = (
      
        'EXECUTE PROCEDURE UP_SP_POST_GROUP_UPDATE(:where, :Name_Post_Gro' +
        'up)')
    SelectSQL.Strings = (
      'SELECT * FROM UP_SP_POST_GROUP_SELECT(:where)')
    AddCaption = #1044#1086#1076#1072#1090#1080' '#1075#1088#1091#1087#1091
    ModifyCaption = #1047#1084#1110#1085#1080#1090#1080' '#1075#1088#1091#1087#1091
    Mode = fmAdd
    CheckWhere = True
    CloseForm = True
  ...
  object PostGroupName: TqFCharControl
    Left = 16
    Top = 16
    Width = 321
    Height = 21
    FieldName = 'Name_Post_Group'
    DisplayName = #1053#1072#1079#1074#1072' '#1075#1088#1091#1087#1080
    Interval = 120
    Value = ''
    LabelColor = clGreen
    Required = True
