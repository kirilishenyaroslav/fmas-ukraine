object SpHolidayLong: TSpHolidayLong
  Left = 367
  Top = 114
  Width = 545
  Height = 458
  Caption = #1058#1088#1080#1074#1072#1083#1110#1089#1090#1100' '#1074#1110#1076#1087#1091#1089#1090#1086#1082
  Color = clBtnFace
  ...
  object cxGrid1: TcxGrid
    ...
    Align = alClient
    TabOrder = 0
    object HolidayLongView: TcxGridDBTableView
      OnDblClick = HolidayLongViewDblClick
      OnKeyDown = HolidayLongViewKeyDown
      ...
      object HolidayLongViewHOLIDAY_LONG: TcxGridDBColumn
        Caption = #1058#1088#1080#1074#1072#1083#1110#1089#1090#1100' '#1074#1110#1076#1087#1091#1089#1090#1082#1080
        Width = 165
        DataBinding.FieldName = 'HOLIDAY_LONG'
      end
      object HolidayLongViewHOLIDAY_TYPE_FULL_NAME: TcxGridDBColumn
        Caption = #1058#1080#1087' '#1074#1110#1076#1087#1091#1089#1090#1082#1080
        Width = 370
        DataBinding.FieldName = 'HOLIDAY_TYPE_FULL_NAME'
      end
      object HolidayLongViewID_POST_HOLIDAY: TcxGridDBColumn
        Visible = False
        DataBinding.FieldName = 'ID_POST_HOLIDAY'
      end
      object HolidayLongViewID_HOLIDAY: TcxGridDBColumn
        Visible = False
        DataBinding.FieldName = 'ID_HOLIDAY'
      end
    end
    object cxGrid1Level1: TcxGridLevel
      GridView = HolidayLongView
    end
  end
  ...
  object ActionControl: TqFActionControl
    DeleteSQL.Strings = (
      'EXECUTE PROCEDURE SP_POST_HOLIDAY_D :where')
    KeyFields = 'ID_POST_HOLIDAY'
    RefreshAction = RefreshAction
    DeleteAction = DeleteAction
    AddFormClass = 'TfmAddHolidayLong'
    AddAction = AddAction
    ModifyAction = ModifyAction
    OnShowForm = ActionControlShowForm
