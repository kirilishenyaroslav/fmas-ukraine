object fmSpPostGroup: TfmSpPostGroup
  Left = 367
  Top = 114
  Width = 588
  Height = 411
  Caption = #1043#1088#1091#1087#1080' '#1087#1086#1089#1072#1076
  Color = clBtnFace
  ...
  object cxGrid1: TcxGrid
    ...
    Align = alClient
    TabOrder = 1
    object PostGroupView: TcxGridDBTableView
      OnDblClick = PostGroupViewDblClick
  ...
  object ActionControl: TqFActionControl
    DeleteSQL.Strings = (
      'EXECUTE PROCEDURE UP_SP_POST_GROUP_DELETE(:where)')
    KeyFields = 'Id_Post_Group'
    RefreshAction = RefreshAction
    DeleteAction = DeleteAction
    AddFormClass = 'TfmAddPostGroup'
    AddAction = AddAction
