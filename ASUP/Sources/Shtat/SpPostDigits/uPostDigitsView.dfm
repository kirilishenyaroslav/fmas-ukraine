object fmPostDigitsView: TfmPostDigitsView
  Left = 238
  Top = 223
  BorderStyle = bsSingle
  Caption = #1056#1086#1079#1088#1103#1076#1080' '#1087#1086#1089#1072#1076#1086#1074#1080#1093' '#1086#1082#1083#1072#1076#1110#1074
  ClientHeight = 315
  ClientWidth = 688
  Color = clBtnFace
  ...
  object DigitsGrid: TcxGrid
    ...
    object DigitsView: TcxGridDBTableView
      DataController.DataSource = dmPostDigits.PostDigitsSource
      ...
      object DigitsViewID_POST_DIGIT: TcxGridDBColumn
        Visible = False
        DataBinding.FieldName = 'ID_POST_DIGIT'
      end
      ...
      object DigitsViewKOEFF_STR: TcxGridDBColumn
        ...
        Options.Sorting = False
        SortOrder = soAscending
        DataBinding.FieldName = 'KOEFF_STR'
      end
      object DigitsViewSUMMA: TcxGridDBColumn
        Options.Sorting = False
  ...
  object ActionControl: TqFActionControl
    DeleteSQL.Strings = (
      'EXECUTE PROCEDURE Asup_Post_Digits_D :where')
    KeyFields = 'Id_Post_Digit'
    RefreshAction = RefreshAction
    DeleteAction = DeleteAction
    AddFormClass = 'TfmAddPostDigit'
    AddAction = AddAction
