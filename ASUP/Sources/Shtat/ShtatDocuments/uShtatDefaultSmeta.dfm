object fmDefaultSmeta: TfmDefaultSmeta
  Left = 194
  Top = 137
  Width = 696
  Height = 270
  ...
  object cxGrid1: TcxGrid
    ...
    Align = alClient
    TabOrder = 0
    object ShtatDefaultSmeta: TcxGridDBTableView
      ...
      object ShtatDefaultSmetaSMETA_NAME: TcxGridDBColumn
        Caption = #1050#1086#1096#1090#1086#1088#1080#1089
        Width = 526
        DataBinding.FieldName = 'Smeta_Name'
      end
      object ShtatDefaultSmetaID_SMETA: TcxGridDBColumn
        Visible = False
        Width = 83
        DataBinding.FieldName = 'ID_SMETA'
      end
      object ShtatDefaultSmetaPERCENT: TcxGridDBColumn
  ...
  object ActionControl: TqFActionControl
    DeleteSQL.Strings = (
      'EXECUTE PROCEDURE DT_SR_DEFAULT_SMETA_D :add, :where')
    KeyFields = 'Id_Smeta'
    RefreshAction = RefreshAction
    DeleteAction = DeleteAction
    AddFormClass = 'TfmAddDefaultSmeta'
    AddAction = AddAction
