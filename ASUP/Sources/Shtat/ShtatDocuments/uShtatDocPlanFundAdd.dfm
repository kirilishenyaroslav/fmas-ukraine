object fmShtatDocPlanFundAdd: TfmShtatDocPlanFundAdd
  Left = 203
  Top = 117
  BorderStyle = bsSingle
  Caption = 'fmShtatDocPlanFundAdd'
  ClientHeight = 218
  ClientWidth = 645
  Color = clBtnFace
  ...
  object FormControl: TqFFormControl
    ...
    Width = 60
    Height = 21
    ControlsParent = Panel1
    ControlsOwner = Owner
    InsertSQL.Strings = (
      
        'SELECT Id_SR_Hours_Pay FROM Shtat_SR_Fund_Insert(:add, :Id_Smeta' +
        ','
      ':Id_SR_Fund_Type, 0, :Summa)')
    UpdateSQL.Strings = (
      'EXECUTE PROCEDURE Shtat_SR_Fund_Update(:where, :Percent, :Summa)')
    SelectSQL.Strings = (
      'SELECT * FROM SHTAT_SR_FUND_INFO(:where)')
    AddCaption = #1044#1086#1076#1072#1090#1080' '#1087#1083#1072#1085#1086#1074#1080#1081' '#1087#1086#1082#1072#1079#1085#1080#1082
    ModifyCaption = #1047#1084#1110#1085#1080#1090#1080' '#1087#1083#1072#1085#1086#1074#1080#1081' '#1087#1086#1082#1072#1079#1085#1080#1082
    InfoCaption = #1055#1083#1072#1085#1086#1074#1080#1081' '#1087#1086#1082#1072#1079#1085#1080#1082': '#1087#1077#1088#1077#1075#1083#1103#1076
  ...
  object Panel1: TPanel
    ...
    Height = 130
    TabOrder = 0
    object IdSRFundType: TqFSpravControl
      Left = 8
      Top = 56
      Width = 449
      Height = 21
      FieldName = 'Id_SR_Fund_Type'
      DisplayName = #1058#1080#1087' '#1087#1086#1082#1072#1079#1085#1080#1082#1072
      Interval = 120
      Value = Null
      LabelColor = clGreen
      Required = True
      ...
      OnOpenSprav = IdSRFundTypeOpenSprav
      DisplayText = ''
      DisplayTextField = 'Name_SR_Fund_Type'
    end
