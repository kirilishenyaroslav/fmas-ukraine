object fmAddDefaultSmeta: TfmAddDefaultSmeta
  Left = 258
  Top = 101
  ...
  object FormControl: TqFFormControl
    ...
    InsertSQL.Strings = (
        ...
        'SELECT Id FROM DT_SR_DEFAULT_SMETA_I(:Id_SR, :Id_Smeta, :Percent' +
        ')')
    UpdateSQL.Strings = (
      
        'EXECUTE PROCEDURE DT_SR_DEFAULT_SMETA_U :Id_SR, :Id_Smeta, :Perc' +
        'ent')
    SelectSQL.Strings = (
      'SELECT * FROM DT_SR_DEFAULT_SMETA_DETAILS(:Id_SR, :where)')
    AddCaption = #1044#1086#1076#1072#1090#1080' '#1076#1078#1077#1088#1077#1083#1086' '#1092#1110#1085#1072#1085#1089#1091#1074#1072#1085#1085#1103
    ModifyCaption = #1047#1084#1110#1085#1080#1090#1080' '#1076#1078#1077#1088#1077#1083#1086' '#1092#1110#1085#1072#1085#1089#1091#1074#1072#1085#1085#1103
    InfoCaption = #1044#1078#1077#1088#1077#1083#1086' '#1092#1110#1085#1072#1085#1089#1091#1074#1072#1085#1085#1103': '#1110#1085#1092#1086
    Mode = fmAdd
    CheckWhere = True
    CloseForm = True
  end
