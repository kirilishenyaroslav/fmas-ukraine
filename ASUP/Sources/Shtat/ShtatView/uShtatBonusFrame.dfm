object frmShtatBonus: TfrmShtatBonus
  Left = 0
  Top = 0
  Width = 800
  Height = 201
  ...
  object BonusGrid: TcxGrid
    ...
    Align = alClient
    TabOrder = 1
    object ShtatBonusView: TcxGridDBTableView
      OnKeyDown = ShtatBonusViewKeyDown
      DataController.DataSource = dmShtatView.BonusSource
      ...
      DataController.Summary.FooterSummaryItems = <
        item
          Kind = skSum
          FieldName = 'BONUS_SUM'
          Column = ShtatBonusViewBONUS_SUM
        end
        item
          Kind = skSum
          FieldName = 'BONUS_PPS'
          Column = ShtatBonusViewBONUS_PPS
        end
        item
          Kind = skSum
          FieldName = 'BONUS_MAIN'
          Column = ShtatBonusViewBONUS_MAIN
        end>
      ...
      object ShtatBonusViewRAISE_NAME: TcxGridDBColumn
        DataBinding.FieldName = 'RAISE_NAME'
      end
      object ShtatBonusViewPERCENT: TcxGridDBColumn
        DataBinding.FieldName = 'PERCENT'
      end
      object ShtatBonusViewSUMMA: TcxGridDBColumn
        DataBinding.FieldName = 'SUMMA'
      end
      object ShtatBonusViewSMETA_KOD: TcxGridDBColumn
        DataBinding.FieldName = 'SMETA_KOD'
      end
      object ShtatBonusViewPPS_SMETA_KOD: TcxGridDBColumn
        DataBinding.FieldName = 'PPS_SMETA_KOD'
      end
      object ShtatBonusViewDATE_BEG: TcxGridDBColumn
        DataBinding.FieldName = 'DATE_BEG'
      end
      object ShtatBonusViewDATE_END: TcxGridDBColumn
        DataBinding.FieldName = 'DATE_END'
      end
      object ShtatBonusViewID_SHTAT_BONUS: TcxGridDBColumn
        Visible = False
        DataBinding.FieldName = 'ID_SHTAT_BONUS'
      end
      object ShtatBonusViewID_RAISE: TcxGridDBColumn
        Visible = False
        DataBinding.FieldName = 'ID_RAISE'
      end
      object ShtatBonusViewIS_PERCENT: TcxGridDBColumn
        Visible = False
        DataBinding.FieldName = 'IS_PERCENT'
      end
      object ShtatBonusViewKOD_SM: TcxGridDBColumn
        Visible = False
        DataBinding.FieldName = 'KOD_SM'
      end
      object ShtatBonusViewKOD_SM_PPS: TcxGridDBColumn
        Visible = False
        DataBinding.FieldName = 'KOD_SM_PPS'
      end
      object ShtatBonusViewSMETA_TITLE: TcxGridDBColumn
        Visible = False
        DataBinding.FieldName = 'SMETA_TITLE'
      end
      object ShtatBonusViewPPS_SMETA_TITLE: TcxGridDBColumn
        Visible = False
        DataBinding.FieldName = 'PPS_SMETA_TITLE'
      end
      object ShtatBonusViewBONUS_SUM: TcxGridDBColumn
        DataBinding.FieldName = 'BONUS_SUM'
      end
      object ShtatBonusViewBONUS_MAIN: TcxGridDBColumn
        Caption = #1054#1089#1085'.'
        DataBinding.FieldName = 'BONUS_MAIN'
      end
      object ShtatBonusViewBONUS_PPS: TcxGridDBColumn
        DataBinding.FieldName = 'BONUS_PPS'
      end
    end
    object BonusGridLevel1: TcxGridLevel
      GridView = ShtatBonusView
    end
  end
  ...
  object ActionControl: TqFActionControl
    DeleteSQL.Strings = (
      'EXECUTE PROCEDURE Shtat_Bonus_Delete :where')
    KeyFields = 'Id_Shtat_Bonus'
    RefreshAction = RefreshAction
    DeleteAction = DeleteAction
    AddFormClass = 'TfmShtatBonusAdd'
    AddAction = AddAction
