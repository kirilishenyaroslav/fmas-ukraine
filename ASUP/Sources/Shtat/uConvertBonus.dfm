object ConvertBonusForm: TConvertBonusForm
  Left = 222
  Top = 126
  Width = 479
  Height = 193
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = #1055#1077#1088#1077#1074#1086#1076' '#1085#1072#1076#1073#1072#1074#1086#1082' '#1079' '#1087#1088#1086#1094#1077#1085#1090#1085#1080#1093' '#1076#1086' '#1089#1091#1084#1086#1074#1080#1093
  Color = clBtnFace
  ...
  object FormControl: TqFFormControl
    ...
    ControlsOwner = Owner
    InsertSQL.Strings = (
      'EXECUTE PROCEDURE UP_SHTAT_BONUS_CONVERT_PERC :Id_SR, :Id_Smeta')
    Mode = fmAdd
    CheckWhere = True
    CloseForm = True
