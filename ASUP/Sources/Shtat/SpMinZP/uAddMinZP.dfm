object fmAddMinZP: TfmAddMinZP
  ...
  object FormControl: TqFFormControl
    ...
    InsertSQL.Strings = (
        ...
        'SELECT Id_Min_ZP FROM ASUP_SP_MIN_ZIP_I(:Value_Min_ZP, :Date_Beg' +
        ', :Date_End, :Cut_Prev)')
    UpdateSQL.Strings = (
      'EXECUTE PROCEDURE ASUP_SP_MIN_ZIP_U :where, :Value_Min_Zp,'
      ':Date_Beg, :Date_End')
    SelectSQL.Strings = (
      'SELECT * FROM ASUP_SP_MIN_ZIP_INFO(:where)')
    AddCaption = #1044#1086#1076#1072#1090#1080' '#1084#1110#1085#1110#1084#1072#1083#1100#1085#1091' '#1079'/'#1087
    ModifyCaption = #1047#1084#1110#1085#1080#1090#1080' '#1084#1110#1085#1110#1084#1072#1083#1100#1085#1091' '#1079'/'#1087
    InfoCaption = #1052#1110#1085#1110#1084#1072#1083#1100#1085#1072' '#1079'/'#1087': '#1087#1077#1088#1077#1075#1083#1103#1076
  ...
  object Value_Min_ZP: TqFFloatControl
    Left = 16
    Top = 16
    Width = 241
    Height = 21
    FieldName = 'Value_Min_ZP'
    DisplayName = #1047#1085#1072#1095#1077#1085#1085#1103
    Interval = 120
    Value = Null
    LabelColor = clGreen
    Required = True
