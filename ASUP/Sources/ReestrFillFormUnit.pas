...
uses
    ...
    Buttons, cxLookAndFeelPainters, cxButtons, cxButtonEdit, SpCommon,
...
var
    sp: TSprav;
begin
    if HospListQuery.IsEmpty then Exit;
    ...
    begin
        ...
        begin
            ...
            begin
                ...
                if AdminMode then FieldValues['Admin_Mode'] := 1
                else FieldValues['Admin_Mode'] := 0;

                FieldValues['Show_Edit_Form'] := 1;
                FieldValues['Input_Id_PCard'] := HospListQuery['ID_PCARD'];
                FieldValues['Input_Id_Man_Hosp'] := HospListQuery['Id_Hosp'];
