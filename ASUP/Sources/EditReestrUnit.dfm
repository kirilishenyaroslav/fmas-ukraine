object EditReestrForm: TEditReestrForm
  Left = 332
  Top = 179
  Width = 334
  Height = 205
  Caption = 'EditReestrForm'
  Color = clBtnFace
  ...
  object FC_NUM_REESTR: TFieldControl
    Left = 272
    Top = 24
    Width = 18
    Height = 18
    Control = NumReestrEdit
    ReadFromField = DetailsQueryNUM_REESTR
    Title = #1053#1086#1084#1077#1088' '#1088#1077#1108#1089#1090#1088#1072
    MaxLength = 0
    ExactLength = 0
    CapitalizeStyle = csNone
  end
  object FC_DATE_REESTR: TFieldControl
    Left = 232
    Top = 64
    Width = 18
    Height = 18
    Control = DateReestrPicker
    ReadFromField = DetailsQueryDATE_REESTR
    Title = #1044#1072#1090#1072' '#1088#1077#1108#1089#1090#1088#1072
    MaxLength = 0
    ExactLength = 0
    CapitalizeStyle = csNone
  end
  ...
  object DateReestrPicker: TDateTimePicker
    Left = 112
    Top = 64
    Width = 113
    Height = 21
    Date = 38323.635878171300000000
    Time = 38323.635878171300000000
    TabOrder = 1
  end
  ...
  object DetailsQuery: TIBQuery
    ...
    CachedUpdates = False
    SQL.Strings = (
      'SELECT * FROM DT_HOSP_REESTR WHERE'
      'ID_REESTR=:ID_REESTR')
    Top = 144
    ParamData = <
      item
    ...
    object DetailsQueryID_REESTR: TIntegerField
      FieldName = 'ID_REESTR'
      Origin = 'DT_HOSP_REESTR.ID_REESTR'
      Required = True
    end
    object DetailsQueryNUM_REESTR: TIBStringField
      FieldName = 'NUM_REESTR'
      Origin = 'DT_HOSP_REESTR.NUM_REESTR'
    end
    object DetailsQueryDATE_REESTR: TDateField
