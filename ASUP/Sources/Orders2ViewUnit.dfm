object Orders2ViewForm: TOrders2ViewForm
  Left = 268
  Top = 216
  Width = 726
  Height = 460
  ...
  object ButtonsPanel: TPanel
    ...
    object UnFormButton: TSpeedButton
      ...
      Width = 99
      Height = 47
      Hint = #1056#1086#1079#1092#1086#1088#1084#1091#1074#1072#1090#1080'/'#1042#1110#1076#1085#1086#1074#1080#1090#1080
  ...
  object InputQuery: TpFIBDataSet
    ...
    SelectSQL.Strings = (
        ...
        'select * from ASUP_ORDERS_SELECT(:FILTER_DATE_BEG, :FILTER_DATE_' +
        'END,:ID_PCARD, :FILTER_SHOW_DELETED);')
