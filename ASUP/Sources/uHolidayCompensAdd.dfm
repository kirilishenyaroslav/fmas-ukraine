object fmHolidayCompensAdd: TfmHolidayCompensAdd
  Left = 191
  Top = 129
  ...
  object BottomPanel: TPanel
    ...
    object FormControl: TqFFormControl
      ...
      ControlsOwner = Owner
      InsertSQL.Strings = (
        'select id_holiday_compens'
        'from ASUP_DT_HOLIDAY_COMPENS_INSERT ('
        '  :PERIOD_BEG,'
        '  :PERIOD_END,'
        '  :DAYS_COUNT,'
        '  :REASON,'
        ...
        '  :NUM_ITEM)')
      UpdateSQL.Strings = (
        'EXECUTE PROCEDURE ASUP_DT_HOLIDAY_COMPENS_UPDATE ('
        '  :where,'
        '  :PERIOD_BEG,'
        '  :PERIOD_END,'
        '  :DAYS_COUNT,'
      ...
      SelectSQL.Strings = (
        'SELECT *'
        'FROM ASUP_DT_HOLIDAY_COMPENS_SELECT2(:where)')
      AddCaption = #1057#1090#1074#1086#1088#1077#1085#1085#1103' '#1082#1086#1084#1087#1077#1085#1089#1072#1094#1110#1111' '#1074#1110#1076#1087#1091#1089#1090#1082#1080
      ModifyCaption = #1056#1077#1076#1072#1075#1091#1074#1072#1085#1085#1103' '#1082#1086#1084#1087#1077#1085#1089#1072#1094#1110#1111' '#1074#1110#1076#1087#1091#1089#1090#1082#1080
      InfoCaption = #1055#1077#1088#1077#1075#1083#1103#1076' '#1082#1086#1084#1087#1077#1085#1089#1072#1094#1110#1111' '#1074#1110#1076#1087#1091#1089#1090#1082#1080
  ...
  object DAYSCOUNT: TqFIntControl
    Left = 16
    Top = 144
    Width = 225
    Height = 21
