object fmTableRealSignerAdd: TfmTableRealSignerAdd
  Left = 383
  Top = 244
  ...
  object FormControl: TqFFormControl
    ...
    ControlsOwner = Owner
    InsertSQL.Strings = (
      'SELECT * FROM Dt_Table_Signers_Insert(:where, :Id_PCard,'
      ':Date_Beg, :Date_End)')
    UpdateSQL.Strings = (
      'EXECUTE PROCEDURE DT_TABLE_SIGNER_REAL_UPDATE :where,'
      ':Id_PCard, :Date_Beg, :Date_End')
    SelectSQL.Strings = (
      'SELECT * FROM DT_TABLE_SIGNER_REAL_DETAILS(:where)')
    AddCaption = #1044#1086#1076#1072#1090#1080
    ModifyCaption = #1047#1084#1110#1085#1080#1090#1080
    InfoCaption = #1030#1085#1092#1086#1088#1084#1072#1094#1110#1103
  end
  ...
  object Panel: TPanel
    ...
    object Id_PCard: TqFSpravControl
      Left = 16
      Top = 16
      Width = 401
      Height = 21
      FieldName = 'Id_PCard'
      DisplayName = #1051#1102#1076#1080#1085#1072
      Interval = 120
      Value = Null
      LabelColor = clGreen
      Required = True
