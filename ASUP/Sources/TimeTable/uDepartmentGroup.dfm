object fmDepartmentsGroup: TfmDepartmentsGroup
  Left = 239
  Top = 137
  BorderStyle = bsSingle
  Caption = #1043#1088#1091#1087#1080' '#1087#1110#1076#1088#1086#1079#1076#1110#1083#1110#1074
  ClientHeight = 446
  ClientWidth = 688
  Color = clBtnFace
  ...
  object GroupsGrid: TDBGrid
    ...
    OnDblClick = GroupsGridDblClick
    OnKeyDown = GroupsGridKeyDown
  end
  object Panel1: TPanel
    ...
    object AddTreeButton: TSpeedButton
      Left = 60
      Top = 0
      Width = 181
      Height = 50
      Caption = #1044#1086#1076#1072#1090#1080' '#1074#1110#1090#1082#1091' '#1087#1110#1076#1088#1086#1079#1076#1110#1083#1110#1074
      Flat = True
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      ...
      NumGlyphs = 2
      ParentFont = False
      OnClick = AddTreeButtonClick
    end
    object DeleteDeptButton: TSpeedButton
      Left = 241
      Top = 0
      Width = 60
      Height = 50
      ...
      NumGlyphs = 2
      ParentFont = False
      OnClick = DeleteDeptButtonClick
    end
    object RefreshDeptsButton: TSpeedButton
      Left = 301
      Top = 0
      Width = 60
      Height = 50
      ...
      NumGlyphs = 2
      ParentFont = False
      OnClick = RefreshDeptsButtonClick
    end
  end
  object DeptsGrid: TDBGrid
    Left = 0
    Top = 252
    Width = 688
    Height = 194
  ...
  object DeptGroupSelect: TIBQuery
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'SELECT * FROM Sp_Dept_Group_Select')
    Left = 512
    Top = 120
    object DeptGroupSelectID_DEPT_GROUP: TIntegerField
      FieldName = 'ID_DEPT_GROUP'
      Origin = 'SP_DEPT_GROUP_SELECT.ID_DEPT_GROUP'
      Visible = False
    end
    object DeptGroupSelectNAME_DEPT_GROUP: TIBStringField
      DisplayLabel = #1053#1072#1079#1074#1072' '#1075#1088#1091#1087#1080' '#1087#1110#1076#1088#1086#1079#1076#1110#1083#1110#1074
      FieldName = 'NAME_DEPT_GROUP'
      Origin = 'SP_DEPT_GROUP_SELECT.NAME_DEPT_GROUP'
      Size = 255
    end
  end
  object DeptGroupSource: TDataSource
    DataSet = DeptGroupSelect
    Left = 464
    Top = 104
  end
  ...
  object DeptsByGroup: TIBQuery
    BufferChunks = 1000
    CachedUpdates = False
    DataSource = DeptGroupSource
    SQL.Strings = (
      'SELECT * FROM Group_Depts_Select(:Id_Dept_Group)')
    Left = 408
    Top = 312
    ParamData = <
      item
    ...
    object DeptsByGroupID_DEPARTMENT: TIntegerField
      FieldName = 'ID_DEPARTMENT'
      Origin = 'GROUP_DEPTS_SELECT.ID_DEPARTMENT'
      Visible = False
    end
    object DeptsByGroupNAME_FULL: TIBStringField
      DisplayLabel = #1053#1072#1079#1074#1072' '#1087#1110#1076#1088#1086#1079#1076#1110#1083#1091
      FieldName = 'NAME_FULL'
      Origin = 'GROUP_DEPTS_SELECT.NAME_FULL'
      Size = 255
    end
  end
  object DeptsSource: TDataSource
    DataSet = DeptsByGroup
    Left = 280
    Top = 312
  end
end
