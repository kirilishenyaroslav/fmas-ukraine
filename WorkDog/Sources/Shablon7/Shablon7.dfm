object frmShablon7: TfrmShablon7
  Left = 773
  Top = 480
  BorderStyle = bsSingle
  Caption = #1064#1072#1073#1083#1086#1085' 7'
  ClientHeight = 466
  ClientWidth = 491
  Color = clBtnFace
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        ...
        object Label13: TLabel
          ...
          Width = 106
          Height = 13
          Caption = #1055#1110#1076#1089#1090#1074#1072' '#1076#1086#1075#1086#1074#1086#1088#1072
        end
        ...
        object GroupBox2: TGroupBox
          ...
          object cxButtonEdit_name_p: TcxButtonEdit
            ...
            Properties.OnChange = cxButtonEdit_name_pPropertiesChange
        ...
        object CurrencyEditsum_dog: TCurrencyEdit
          ...
          TabOrder = 8
          OnChange = CurrencyEditsum_dogChange
        end
        ...
        object GroupBox3: TGroupBox
          ...
          object cxDateEdit_date_end: TcxDateEdit
            ...
            Height = 21
            ParentFont = False
            Properties.OnChange = cxDateEdit_date_endPropertiesChange
            Style.Color = clMoneyGreen
            Style.Font.Charset = DEFAULT_CHARSET
            Style.Font.Color = clWindowText
            Style.Font.Height = -11
      ...
      object TabSheet2: TTabSheet
        Caption = #1047#1085#1072#1095#1077#1085#1085#1103' '#1087#1086' '#1079#1072#1084#1086#1074#1095#1072#1085#1085#1102
        ImageIndex = 1
        object GroupBox7: TGroupBox
          ...
          object cxTextEdit_def_n_dog2: TcxTextEdit
            Left = 24
            Top = 8
            Width = 89
            Height = 21
          ...
          object cxTextEdit_def_d_dog2: TcxTextEdit
            Left = 136
            Top = 8
            Width = 89
            Height = 21
          ...
          object cxTextEdit_reg_n2: TcxTextEdit
            Left = 344
            Top = 8
            Width = 129
            Height = 21
    ...
    object dxStatusBar1: TdxStatusBar
      ...
      Panels = <
        ...
        item
          ...
          PanelStyle.Alignment = taCenter
          Fixed = False
          Text = 'Ctrl+Enter - '#1042#1110#1076#1082#1088#1080#1090#1080' '#1076#1086#1074#1110#1076#1085#1080#1082
          Width = 120
        end
        item
          PanelStyleClassName = 'TdxStatusBarTextPanelStyle'
          PanelStyle.Alignment = taCenter
          Text = 'F10 - '#1055#1088#1080#1081#1085#1103#1090#1080
          Width = 75
        end>
      PaintStyle = stpsXP
  ...
  object pFIBDataSet_id_dokument: TpFIBDataSet
    ...
    SelectSQL.Strings = (
      'select *'
      'from dog_dt_document_info(:d_id_document)')
    Left = 394
    Top = 181
  ...
  object pFIBDataSet_post: TpFIBDataSet
    ...
    SelectSQL.Strings = (
        ...
        'r,'
      'pub_sp_cust_rate_acc.id_rate_account, pub_sp_bank.id_bank'
      ...
      'and pub_sp_customer.id_customer=:param_cust'
      '')
    Left = 456
    Top = 181
    poSQLINT64ToBCD = True
  end
  object pFIBDataSet_kowtoris_id: TpFIBDataSet
    Database = pFIBDatabase
    Transaction = pFIBTransactionRead
    SelectSQL.Strings = (
      'select distinct max(dog_dt_smet_dog.id_dog)+1 id_dog_kowt'
      'from dog_dt_document, dog_dt_smet_dog'
      'where dog_dt_document.kod_dog=:id_document'
  ...
  object dxBarManager1: TdxBarManager
    ...
    Bars = <
      item
        ...
        ItemLinks = <
          ...
          item
            Item = dxBarLargeButton_red
            Visible = True
          end
          item
            Item = dxBarLargeButton_prosm
            Visible = True
          end
          item
    ...
    object dxBarLargeButton_red: TdxBarLargeButton
      Caption = #1047#1084#1110#1085#1080#1090#1080
      Category = 0
    ...
    object dxBarLargeButton_prosm: TdxBarLargeButton
  ...
  object pFIBDataSet_smet_info: TpFIBDataSet
    ...
    SelectSQL.Strings = (
      ...
      'where  dog_dt_smet_dog.id_dog=:param_doc')
    Left = 18
    Top = 160
    poSQLINT64ToBCD = True
  end
  ...
  object DataSetHistory: TpFIBDataSet
    Database = pFIBDatabase
    Transaction = pFIBTransactionRead
    SelectSQL.Strings = (
      'select * from dog_dt_document_hist_info(:id_history)')
    Left = 40
    Top = 24
    poSQLINT64ToBCD = True
  end
  object DataSetHistSmet: TpFIBDataSet
    Database = pFIBDatabase
    Transaction = pFIBTransactionRead
    SelectSQL.Strings = (
      'select * from dog_dt_smet_hist_info(:id_history)')
    Left = 72
    Top = 24
    poSQLINT64ToBCD = True
  end
