...
begin
 ...
 StoredProc.StoredProcName :=  'DOG_SP_INFLATION_ADD';
  StoredProc.Prepare;
 StoredProc.ParamByName('DATE_BEG').AsDate:=f.DateBegEdit.Date;
StoredProc.ParamByName('DATE_END').AsDate:=f.DateEndEdit.Date;
StoredProc.ParamByName('INFLATION_INDEX').AsDouble:=f.IndexEdit.Value;
 StoredProc.ExecProc;
