...
type
  TForm2 = class(TForm)
    ...
    ExpID: TDBText;
    ExpName: TDBText;
    AllowSumEdit: TcxGridDBColumn;
    ExpIsEdit: TDBText;
    NdsCol: TcxGridDBColumn;
    ExpNds: TDBText;
...
begin
 ...
 is_edit :=ExpIsEdit.Caption;
 is_nds:=ExpNds.Caption;
 is_dblnds:=ExpDblNds.Caption;
 is_tar_print:=ExpTarPrint.Caption;
 ModalResult:=mrOk;
end;
// -----------------------------------------------------------------------------
