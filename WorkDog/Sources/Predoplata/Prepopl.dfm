object frmPredopl: TfrmPredopl
  ...
  Caption = #1055#1077#1088#1077#1076#1087#1083#1072#1090#1072
  ClientHeight = 440
  ClientWidth = 666
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object GroupBox2: TGroupBox
      ...
      object cxTextEdit_name_p: TcxTextEdit
        Left = 8
        Top = 24
        Width = 297
        Height = 21
    ...
    object cxButton_hist: TcxButton
      ...
      Width = 145
      Height = 25
      Caption = #1030#1089#1090#1086#1088#1110#1103' 1 '#1079#1084#1110#1085#1080
      TabOrder = 9
  ...
  object pFIBDataSet_tip_dog_add: TpFIBDataSet
    ...
    SelectSQL.Strings = (
      ...
      '       p.short_name,'
      '       f.def_note'
      'from   pub_sp_tip_dog p, pub_sp_tip_dog_def f'
      'where  p.id_tip_dog=:pram_id_tip_dog'
      'and    p.id_tip_dog=f.id_tip_dog')
    Left = 328
    Top = 48
    poSQLINT64ToBCD = True
  end
