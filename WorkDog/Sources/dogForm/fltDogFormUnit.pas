...
{
<----------------------------------------------------------------------------->
 Процедура формирования запроса по фильтру

 Исправленно: Ошибка выбора людей из справочника физлиц
 при выборке по критерию контрагентов

 Добавлено: Выборка из БД по справочнику классификаторов продукции
