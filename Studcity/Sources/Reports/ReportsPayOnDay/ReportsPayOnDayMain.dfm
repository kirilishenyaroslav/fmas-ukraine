object frmReportsPayOnDayMain: TfrmReportsPayOnDayMain
  Left = 368
  Top = 224
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = #1055#1086#1089#1090#1091#1087#1083#1077#1085#1080#1103' '#1079#1072' '#1087#1088#1086#1078#1080#1074#1072#1085#1080#1077' '#1074' '#1089#1090#1091#1076#1075#1086#1088#1086#1076#1082#1077
  ClientHeight = 460
  ClientWidth = 562
  Color = clBtnFace
  ...
  object GroupBoxDate: TGroupBox
    ...
    object LabelDateRun: TLabel
      ...
      Width = 114
      Height = 13
      Caption = #1055#1077#1088#1080#1086#1076' '#1087#1086#1089#1090#1091#1087#1083#1077#1085#1080#1081' '#1089
    end
    ...
    object DateTimePickerBegin: TDateTimePicker
      ...
      TabOrder = 0
      OnChange = DateTimePickerBeginChange
    end
  ...
  object GroupBox1: TGroupBox
    ...
    object cxCheckBoxSm: TcxCheckBox
      ...
      Height = 21
      Properties.DisplayUnchecked = 'False'
      Properties.Caption = #1047' '#1088#1086#1079#1073#1080#1074#1082#1086#1102' '#1087#1086' '#1073#1102#1076#1078#1077#1090#1072#1093
      TabOrder = 0
    end
    object cxCheckBoxSch: TcxCheckBox
      ...
      Height = 21
      Properties.DisplayUnchecked = 'False'
      Properties.Caption = #1047' '#1088#1086#1079#1073#1080#1074#1082#1086#1102' '#1087#1086' '#1088#1072#1093#1091#1085#1082#1072#1093
      TabOrder = 1
    end
  end
