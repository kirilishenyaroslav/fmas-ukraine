...
type
  TfrmVremInstrTalon = class(TForm)
...
function ReportVremInstr(AOwner:TComponent;DB:TISC_DB_HANDLE;id_people:Int64;type_doc_print:integer):Integer;stdcall;
exports ReportVremInstr;

var
  frmVremInstrTalon: TfrmVremInstrTalon;
  print_page:Integer;
...
function ReportVremInstr(AOwner:TComponent;DB:TISC_DB_HANDLE;id_people:Int64;type_doc_print:integer):Integer;
var
  PrProp:TfrmVremInstrTalon;
begin
  PrProp:=TfrmVremInstrTalon.Create(AOwner,DB,id_people,type_doc_print);
  PrProp.ShowModal;
  PrProp.Free;
end;


constructor  TfrmVremInstrTalon.Create (Aowner:Tcomponent;DBL:TISC_DB_HANDLE;id_people:Int64;type_doc_print:integer);
begin
...
procedure TfrmVremInstrTalon.cxButton2Click(Sender: TObject);
begin
  Close;
end;

procedure TfrmVremInstrTalon.cxButton1Click(Sender: TObject);
begin
if print_page=0 then
  begin
    frxReport.Clear;
    frxReport.LoadFromFile(ExtractFilePath(Application.ExeName)+'Reports\Studcity\'+'ReportVremInstr.fr3');
  ...
  begin
    frxReport.Clear;
    frxReport.LoadFromFile(ExtractFilePath(Application.ExeName)+'Reports\Studcity\'+'ReportVremInstr_Page2.fr3');
    frxReport.Variables.Clear;
    frxReport.Variables['StRep_Stat_N1']:=''''+StRep_Stat_N1+'''';
    frxReport.Variables['StRep_Stat_N2']:=''''+StRep_Stat_N2+'''';
    frxReport.Variables['StRep_StatN1']:=''''+StRep_StatN1+'''';
...
procedure TfrmVremInstrTalon.DesignerExecute(Sender: TObject);
begin
