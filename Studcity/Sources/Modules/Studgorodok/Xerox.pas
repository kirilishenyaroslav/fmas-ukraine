...
type
  Tfrm_Xerox = class(TForm)
    ...
    procedure xrx_DateEndEditKeyPress(Sender: TObject; var Key: Char);
...
procedure Tfrm_Xerox.xrx_DateBegEditKeyPress(Sender: TObject;
  var Key: Char);
begin
if key = #13 then xrx_DateEndEdit.SetFocus;
end;

procedure Tfrm_Xerox.xrx_DateEndEditKeyPress(Sender: TObject;
  var Key: Char);
begin
