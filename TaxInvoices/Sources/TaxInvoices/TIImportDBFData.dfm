object ImportDBFForm: TImportDBFForm
  Left = 412
  Top = 346
  Width = 908
  Height = 783
  Caption = #1044#1072#1085#1110' DBF-'#1092#1072#1081#1083#1091
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    Height = 41
    Align = alTop
    Caption = #1044#1072#1085#1110' '#1079' DBF-'#1092#1072#1081#1083#1091'  ('#1074#1080#1076#1072#1085#1110' '#1085#1072#1082#1083#1072#1076#1085#1110')'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'MS Sans Serif'
  ...
  object DBFDataVidNaklGrid: TcxGrid
    Left = 0
    Top = 41
    Width = 892
    Height = 342
    Align = alClient
    TabOrder = 1
    object DBFDataVidNaklGridTableView1: TcxGridTableView
      DataController.Filter.Criteria = {FFFFFFFF0000000000}
      DataController.Summary.DefaultGroupSummaryItems = <>
      DataController.Summary.FooterSummaryItems = <
        item
          Kind = skSum
          Column = DBFDataVidNaklGridTableView_SUMMA_ALL_PDV
        end
        item
          Kind = skSum
          Column = DBFDataVidNaklGridTableView_SUMMA_TAXABLE_20
        end
        item
          Kind = skSum
          Column = DBFDataVidNaklGridTableView_SUMMA_PDV_20
        end
        item
          Kind = skSum
          Column = DBFDataVidNaklGridTableView_SUMMA_TAXABLE_0
        end
        item
          Kind = skSum
          Column = DBFDataVidNaklGridTableView_SUMMA_EXEMPT
        end
        item
          Kind = skSum
          Column = DBFDataVidNaklGridTableView_SUMMA_EXPORT
        end>
      ...
      object DBFDataVidNaklGridTableView_NUM_ORDER: TcxGridColumn
        Caption = #8470' '#1079'.'#1087'.'
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Width = 48
      end
      object DBFDataVidNaklGridTableView_DATA_VIPISKI: TcxGridColumn
        Caption = #1076#1072#1090#1072' '#1074#1080#1087#1080#1089#1082#1080
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Width = 92
      end
      object DBFDataVidNaklGridTableView_NUM_NAKL: TcxGridColumn
        Caption = #1085#1086#1084#1077#1088
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Width = 61
      end
      object DBFDataVidNaklGridTableView_NAME_TYPE_DOCUMENT: TcxGridColumn
        Caption = #1074#1080#1076' '#1076#1086#1082'.'
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Width = 51
      end
      object DBFDataVidNaklGridTableView_NAME_CUSTOMER: TcxGridColumn
        Caption = #1085#1072#1079#1074#1072' '#1087#1086#1082#1091#1087#1094#1103
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Width = 170
      end
      object DBFDataVidNaklGridTableView_IPN_CUSTOMER: TcxGridColumn
        Caption = #1030#1055#1053' '#1087#1086#1082#1091#1087#1094#1103
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Width = 100
      end
      object DBFDataVidNaklGridTableView_SUMMA_ALL_PDV: TcxGridColumn
        Caption = #1079#1072#1075#1072#1083#1100#1085#1072' '#1089#1091#1084#1072', '#1074#1082#1083'. '#1055#1044#1042
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Width = 99
      end
      object DBFDataVidNaklGridTableView_SUMMA_TAXABLE_20: TcxGridColumn
        Caption = '20%, '#1073#1072#1079#1072' '#1086#1087#1086#1076#1072#1090#1082#1091#1074'.'
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Width = 94
      end
      object DBFDataVidNaklGridTableView_SUMMA_PDV_20: TcxGridColumn
        Caption = '20%, '#1089#1091#1084#1072' '#1055#1044#1042
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Width = 86
      end
      object DBFDataVidNaklGridTableView_SUMMA_TAXABLE_0: TcxGridColumn
        Caption = '0%, '#1073#1072#1079#1072' '#1086#1087#1086#1076#1072#1090#1082#1091#1074'.'
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Width = 91
      end
      object DBFDataVidNaklGridTableView_SUMMA_EXEMPT: TcxGridColumn
      ...
      object DBFDataVidNaklGridTableView_SUMMA_EXPORT: TcxGridColumn
    ...
    object DBFDataVidNaklGridLevel1: TcxGridLevel
      GridView = DBFDataVidNaklGridTableView1
    end
  end
  ...
  object Panel4: TPanel
    ...
    object Panel2: TPanel
      ...
      Height = 40
      Align = alTop
      Caption = #1044#1072#1085#1110' '#1079' DBF-'#1092#1072#1081#1083#1091' ('#1086#1090#1088#1080#1084#1072#1085#1110' '#1085#1072#1082#1083#1072#1076#1085#1110')'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'MS Sans Serif'
    ...
    object DBFDataOtrNaklGrid: TcxGrid
      Left = 1
      Top = 41
      Width = 890
      Height = 263
      Align = alClient
      TabOrder = 1
      object DBFDataOtrNaklGridTableView1: TcxGridTableView
        DataController.Filter.Criteria = {FFFFFFFF0000000000}
        DataController.Summary.DefaultGroupSummaryItems = <>
        DataController.Summary.FooterSummaryItems = <
          item
            Kind = skSum
            Column = DBFDataOtrNaklGridTableView_SUMMA_ALL_PDV
          end
          item
            Kind = skSum
            Column = DBFDataOtrNaklGridTableView_SUMMA_20_0_NOT_PDV
          end
          item
            Kind = skSum
            Column = DBFDataOtrNaklGridTableView_SUMMA_20_0_PDV
          end
          item
            Kind = skSum
            Column = DBFDataOtrNaklGridTableView_SUMMA_EXEMPT_NOT_PDV
          end
          item
            Kind = skSum
            Column = DBFDataOtrNaklGridTableView_SUMMA_EXEMPT_PDV
          end
          item
            Kind = skSum
            Column = DBFDataOtrNaklGridTableView_SUMMA_ECON_ACTIV_NOT_PDV
          end
          item
            Kind = skSum
            Column = DBFDataOtrNaklGridTableView1_SUMMA_ECON_ACTIV_PDV
          end>
        DataController.Summary.SummaryGroups = <>
        NavigatorButtons.ConfirmDelete = False
        OptionsCustomize.ColumnFiltering = False
        ...
        OptionsView.HeaderAutoHeight = True
        Styles.StyleSheet = StyleDM.GridTableViewStyleSheetDevExpress
        object DBFDataOtrNaklGridTableView_DATA_OTR: TcxGridColumn
        ...
        object DBFDataOtrNaklGridTableView_DATA_VIPISKI: TcxGridColumn
        ...
        object DBFDataOtrNaklGridTableView_NUM_NAKL: TcxGridColumn
          Caption = #1085#1086#1084#1077#1088
          FooterAlignmentHorz = taCenter
          HeaderAlignmentHorz = taCenter
          HeaderAlignmentVert = vaCenter
        ...
        object DBFDataOtrNaklGridTableView_NAME_TYPE_DOCUMENT: TcxGridColumn
          Caption = #1074#1080#1076' '#1076#1086#1082'.'
          FooterAlignmentHorz = taCenter
          HeaderAlignmentHorz = taCenter
          HeaderAlignmentVert = vaCenter
        ...
        object DBFDataOtrNaklGridTableView_NAME_PROVIDER: TcxGridColumn
        ...
        object DBFDataOtrNaklGridTableView_IPN_PROVIDER: TcxGridColumn
        ...
        object DBFDataOtrNaklGridTableView_SUMMA_ALL_PDV: TcxGridColumn
        ...
        object DBFDataOtrNaklGridTableView_SUMMA_20_0_NOT_PDV: TcxGridColumn
        ...
        object DBFDataOtrNaklGridTableView_SUMMA_20_0_PDV: TcxGridColumn
        ...
        object DBFDataOtrNaklGridTableView_SUMMA_EXEMPT_NOT_PDV: TcxGridColumn
        ...
        object DBFDataOtrNaklGridTableView_SUMMA_EXEMPT_PDV: TcxGridColumn
        ...
        object DBFDataOtrNaklGridTableView_SUMMA_ECON_ACTIV_NOT_PDV: TcxGridColumn
        ...
        object DBFDataOtrNaklGridTableView1_SUMMA_ECON_ACTIV_PDV: TcxGridColumn
        ...
        object DBFDataOtrNaklGridTableView_SUMMA_DELIVERY_NOT_PDV: TcxGridColumn
        ...
        object DBFDataOtrNaklGridTableView_SUMMA_DELIVERY_PDV: TcxGridColumn
      ...
      object DBFDataOtrNaklGridLevel1: TcxGridLevel
        GridView = DBFDataOtrNaklGridTableView1
      end
    end
  end
end
