...
uses
  ...
  JO5_Types,
  JO5_PackageLoad,
  JO5_MainMenu in 'JO5_MainMenu.pas' {fMainMenu},
  JO5_DataModule in 'JO5_DataModule.pas' {JO5_DM: TDataModule},
  PrintMOParams in 'PrintMOParams.pas' {frmGetMOParams},
  JO5SetFormUch in 'JO5SetFormUch.pas' {frmSetFormUch};
