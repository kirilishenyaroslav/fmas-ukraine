...
begin
     ...
     then begin
               ...
               then begin
                         ...
                         begin
                              TotalDocSum:=TotalDocSum+GetZData.FieldByName('SUMMA').Value;
                              GetZData.Next;
                         end;
               end;
               ...
               then begin
                         ...
                         begin
                               ...
                               AddProvSP.Prepare;
                               AddProvSP.ParamByName('ID_SESSION').asInt64  :=Id_session;
                               AddProvSP.ParamByName('TYPE_COMMENT').Value  :='Сума фонду інвалідів '+VarToStr(TotalDocSum);

                               AddProvSP.ParamByName('TYPE_OPERATION').Value:=255;
                               AddProvSP.ParamByName('DATE_REG').Value      :=DateReg;
                               AddProvSP.ParamByName('COMPUTER').Value      :=GlobalSpr.GetComputerNetName;
                               ...
                               AddProvSP.ParamByName('ATYPE').Value         :=1;
                               AddProvSP.ParamByName('SUMMA').Value         :=GetZData.FieldByName('SUMMA').Value;
                               AddProvSP.ParamByName('ID_SYSTEM').Value     :=FIdSystem;
               ...
               then begin
                         ...
                         begin
                               ...
                               AddProvSP.Prepare;
                               AddProvSP.ParamByName('ID_SESSION').asInt64  :=Id_session;
                               AddProvSP.ParamByName('TYPE_COMMENT').Value  :='Сума фонду інвалідів';
