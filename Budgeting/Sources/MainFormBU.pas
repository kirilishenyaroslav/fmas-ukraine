...
uses
  ...
  Halcn6db, accmgmt, pFibDataSet, AppStruClasses, AppEvnts, fib;
...
uses dmMain_Bookbu, Kernel, About, MDIChildFormsBar{, tagLibUnit}, BaseTypes;
...
begin
    GlobalSPR.GetOtchIntf(self,dmmainbu.MainDatabase.Handle,0,0,fsMdiChild);
end;
...
begin
     GetSmDReestr(self,dmMainbu.MainDatabase.Handle,id_user);
end;
