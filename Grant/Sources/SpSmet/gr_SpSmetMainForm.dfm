object FGr_SmetForm: TFGr_SmetForm
  Left = 265
  Top = 268
  BorderIcons = [biSystemMenu, biMinimize, biHelp]
  BorderStyle = bsSingle
  Caption = 'FGr_SmetForm'
  ClientHeight = 413
  ClientWidth = 704
  Color = clBtnFace
  ...
  object GridSmeta: TcxGrid
    ...
    Align = alClient
    TabOrder = 5
    object GridSmetaDBTableView: TcxGridDBTableView
      OnDblClick = GridSmetaDBTableViewDblClick
      OnKeyPress = GridSmetaDBTableViewKeyPress
      ...
      OptionsBehavior.IncSearchItem = GridSmetaDBTableViewDBSmetaKod
      OptionsCustomize.ColumnFiltering = False
      OptionsSelection.CellSelect = False
      OptionsView.ColumnAutoWidth = True
      OptionsView.GroupByBox = False
      OptionsView.HeaderAutoHeight = True
      object GridSmetaDBTableViewDBCheck: TcxGridDBColumn
        Width = 88
        DataBinding.FieldName = 'CHECK'
        IsCaptionAssigned = True
      end
      object GridSmetaDBTableViewDBSmetaKod: TcxGridDBColumn
        Caption = #1050#1086#1076
        Width = 118
        DataBinding.FieldName = 'SMETA_KOD'
      end
      object GridSmetaDBTableViewDBTitle: TcxGridDBColumn
        Caption = #1053#1072#1081#1084#1077#1085#1091#1074#1072#1085#1085#1103
        Width = 496
        DataBinding.FieldName = 'SMETA_TITLE'
      end
    end
    object cxgrdlvlGridSmetaLevel: TcxGridLevel
      GridView = GridSmetaDBTableView
    end
  end
