...
procedure TFgrCountSheets.Grid1DBTableView1FocusedRecordChanged(
  Sender: TcxCustomGridTableView; APrevFocusedRecord,
  AFocusedRecord: TcxCustomGridRecord;
  ANewItemRecordFocusingChanged: Boolean);
begin
if (AFocusedRecord=nil) or (AFocusedRecord.Expandable) then
  ...
  Grid2DBTableView1.DataController.DataSource:=DSource2;
DeleteBtn.Enabled:= not ((AFocusedRecord=nil) or (AFocusedRecord.Expandable) or (VarToStrDef(DSet1.FieldValues['ID_REESTR'],'0')<>'0'));
end;
