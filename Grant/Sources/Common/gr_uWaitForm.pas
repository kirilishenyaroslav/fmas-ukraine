...
type TWaitFormType = (wfLoadPackage,wfLocateFunction,wfSelectData,wfPrepareData, wfAddData);
...
const wfAddData_Const = 'Чекайте: йде додання записiв!';
...
begin
 ...
 case WaitFormType of
  ...
  wfAddData:  Wf.Memo.Lines.Text:=#13+ wfAddData_Const;
 end;
 Result         := wf;
