...
type
  TDM = class(TDataModule)
    ...
    DSetAlimonyData: TpFIBDataSet;
    ReportDBDSetAlimonyData: TfrxDBDataset;
    Report: TfrxReport;
  ...
  private
    ...
    PLanguageIndex:byte;
  public
    function PrintSpr(AParameter:TReeAlimonyParam):variant;
  end;
...
const NameReport               ='\grReeAlimony.fr3';

function TDM.PrintSpr(AParameter:TReeAlimonyParam):variant;
var DateForm:tdate;
    i: byte;
    wf:TForm;
begin
 ...
 DSetAlimonyData.SQLs.SelectSQL.Text := 'SELECT * FROM GR_REEALIMONY_BYSCH(?ID_SCH,'+VarToStr(AParameter.FoundationParam.Kod_setup)+')';
