...
constructor TFGrAccDep.Create(AOwner:TComponent;AHandle:TISC_DB_HANDLE);
...
procedure TFGrAccDep.FormCreate(Sender: TObject);
begin
...
procedure TFGrAccDep.RefreshBtnClick(Sender: TObject);
var wf:TForm;
begin
...
procedure TFGrAccDep.SelectBtnClick(Sender: TObject);
...
procedure TFGrAccDep.ExitBtnClick(Sender: TObject);
begin
  ModalResult := mrCancel;
end;

procedure TFGrAccDep.DepartmentTreeListFocusedNodeChanged(
...
procedure TFGrAccDep.FormShow(Sender: TObject);
begin
