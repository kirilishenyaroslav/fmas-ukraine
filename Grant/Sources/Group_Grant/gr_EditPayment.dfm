object FEditPayment: TFEditPayment
  Left = 186
  Top = 199
  Width = 870
  Height = 500
  Caption = 'FEditPayment'
  Color = clBtnFace
  ...
  object Grid1: TcxGrid
    ...
    object Grid1DBTableView1: TcxGridDBTableView
      DataController.DataSource = DM_G.DSourceEditPayment
      ...
      object Grid1Kod_Setup: TcxGridDBColumn
      end
      object Grid1Kod_Vidopl: TcxGridDBColumn
      end
      object Grid1Name_Vidopl: TcxGridDBColumn
      end
      object Grid1DBSumma: TcxGridDBColumn
      end
      object Grid1Kod_Smeta: TcxGridDBColumn
      end
      object Grid1Kod_Depatment: TcxGridDBColumn
      end
    end
  ...
  object BarManager: TdxBarManager
    ...
    object RefreshBtn: TdxBarLargeButton
      Caption = #1059#1076#1072#1083#1080#1090#1100' '#1074#1089#1077' '#1074#1099#1087#1083#1072#1090#1099
      Category = 0
      Hint = #1059#1076#1072#1083#1080#1090#1100' '#1074#1089#1077' '#1074#1099#1087#1083#1072#1090#1099
      Visible = ivAlways
      ShortCut = 116
      AutoGrayScale = False
      LargeGlyph.Data = {
    ...
    object DeleteBtn: TdxBarLargeButton
      Caption = #1059#1076#1072#1083#1080#1090#1100' '#1074#1099#1087#1083#1072#1090#1091
      Category = 0
      Hint = #1059#1076#1072#1083#1080#1090#1100' '#1074#1099#1087#1083#1072#1090#1091
      Visible = ivAlways
      ShortCut = 46
      AutoGrayScale = False
      LargeGlyph.Data = {
    ...
    object LBtnUpdate: TdxBarLargeButton
      Caption = #1056#1077#1076#1072#1082#1090#1080#1088#1086#1074#1072#1090#1100' '#1074#1099#1087#1083#1072#1090#1091
      Category = 0
      Hint = #1056#1077#1076#1072#1082#1090#1080#1088#1086#1074#1072#1090#1100' '#1074#1099#1087#1083#1072#1090#1091
      Visible = ivNever
      AutoGrayScale = False
      LargeGlyph.Data = {
