object frmOtpuskOrder: TfrmOtpuskOrder
  ...
  Caption = #1057#1090#1072#1083#1072' '#1076#1086' '#1088#1086#1073#1086#1090#1080
  ClientHeight = 410
  ClientWidth = 492
  Color = clBtnFace
  ...
  object Panel3: TPanel
    ...
    object LblDateBegEdit: TcxLabel
      ...
      Style.Font.Style = []
      TabOrder = 0
      Caption = '* '#1057#1090#1072#1083#1072' '#1076#1086' '#1088#1086#1073#1086#1090#1080' '#1079':'
    end
