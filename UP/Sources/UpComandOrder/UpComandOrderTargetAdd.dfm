object FormTargetAdd: TFormTargetAdd
  Left = 233
  Top = 333
  Width = 641
  Height = 137
  Caption = #1052#1077#1090#1072' '#1074#1110#1076#1088#1103#1076#1078#1077#1085#1085#1103
  Color = clBtnFace
  ...
  object cxLabel2: TcxLabel
    ...
    TabOrder = 0
    Caption = #1058#1077#1082#1089#1090' '#1084#1077#1090#1080':'
  end
