object FormAddSmet: TFormAddSmet
  ...
  object cxGroupBox1: TcxGroupBox
    ...
    object ChangeEdit: TqFFloatControl
      Left = 6
      Top = 89
      Width = 178
      Height = 21
      DisplayName = #1047#1084#1110#1085#1080#1090#1080' '#1085#1072
      Interval = 90
      Value = Null
      LabelColor = clGreen
      Required = True
      ...
      AutoSaveToRegistry = False
      MaxLength = 0
      OnKeyDown = ChangeEditKeyDown
      NegativeAllowed = True
      Precision = 2
      Format = '#########0.00'
    end
    object ResultEdit: TqFFloatControl
      Left = 229
      Top = 89
      Width = 160
      Height = 21
      DisplayName = #1057#1090#1072#1083#1086
      Interval = 64
      Value = Null
      LabelColor = clGreen
      Required = True
    ...
    object AllEdit: TqFFloatControl
      Left = 8
      Top = 59
      Width = 176
      Height = 21
      DisplayName = #1041#1091#1083#1086
      Interval = 88
      Value = Null
      LabelColor = clGreen
      Required = True
