object frmPochasType: TfrmPochasType
  Left = 400
  Top = 148
  Width = 912
  Height = 561
  Caption = #1044#1086#1074#1110#1076#1085#1080#1082' '#1090#1080#1087#1110#1074' '#1087#1086#1075#1086#1076#1080#1085#1085#1086#1111' '#1089#1087#1083#1072#1090#1080
  Color = clBtnFace
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBTableView1: TcxGridDBTableView
      ...
      object cxGrid1DBTableView1POCHAS_TYPE_NAME: TcxGridDBColumn
        Caption = #1053#1072#1079#1074#1072
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        SortOrder = soAscending
        Width = 576
        DataBinding.FieldName = 'POCHAS_TYPE_NAME'
      end
      object cxGrid1DBTableView1ZAV_KAF: TcxGridDBColumn
        Caption = #1054#1079#1085#1072#1082#1072' '#1082#1077#1088#1110#1074#1085#1080#1094#1090#1074#1072' '#1082#1072#1092#1077#1076#1088#1086#1102
        Visible = False
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Width = 129
        DataBinding.FieldName = 'ZAV_KAF'
      end
      object cxGrid1DBTableView1DBColumn1: TcxGridDBColumn
        Caption = #1054#1079#1085#1072#1082#1072' '#1090#1080#1087#1091
        MinWidth = 301
        Options.HorzSizing = False
        Width = 301
        DataBinding.FieldName = 'PRIZNAK_POCHAS_TYPE_S'
      end
    end
  ...
  object DataSet: TpFIBDataSet
    ...
    SelectSQL.Strings = (
      'select * from ASUP_INI_POCHAS_TYPE_S')
    Left = 80
    Top = 104
