...
begin
    ...
    //Параметры специфичные для типа приказа на надбавки
    Input.FieldDefs.Add('ViewKeySession', ftCurrency);
...
begin
    Result := TFrame(TfmBonusOrder.Create(Application.MainForm,
...
begin
    with TfmBonusOrder.Create(Application.MainForm,
        TISC_DB_HANDLE(Integer(Input['DBHandle'])),
        Input['ID_ORDER'],
        Input['ID_ORDER_TYPE'],
        Input['NUM_ITEM'],
