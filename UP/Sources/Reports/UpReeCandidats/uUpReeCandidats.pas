...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text:='select * from UP_REPORT_REE_CANDIDAT(:IN_ID_REPORT_SESSION) Order By display_3, display_2, display_1, fio collate win1251_ua';
