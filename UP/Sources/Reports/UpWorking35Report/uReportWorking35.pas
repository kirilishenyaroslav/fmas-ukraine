...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text        := 'select distinct * from UP_REPORT_PEOPLE_WORK_35(:IN_ID_REPORT_SESSION) Order By DEPARTMANT, NAME_FACULTY, NAME_CAFEDRA, FIO';
        try
