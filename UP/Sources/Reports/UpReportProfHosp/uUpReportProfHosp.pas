...
uses dmReportProfHosp, NagScreenUnit;
...
begin
   ...
   // DateWork:=self.WorkEdit.Date;
    ...
    begin
        ...
        DSetData.SelectSQL.Text:='select distinct * from UP_REPORT_PROF_HOSP(:IN_ID_REPORT_SESSION) Order By NAME_DEPARTMENT_UPPER, FIO';
