...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text        := 'select distinct * from UP_REPORT_VOZRCHILD(:IN_ID_REPORT_SESSION) Order By FIO_REB, FIO_RODIT, BIRTH_DATE, ADR';
        try
