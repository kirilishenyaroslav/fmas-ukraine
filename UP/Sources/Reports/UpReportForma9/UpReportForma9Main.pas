...
begin
  ...
  NameReport.Active:=true;
   ...
   DSetDepartments.SQLs.SelectSQL.Text :='SELECT distinct * FROM UP_REPORT_FORMA9_DEPARTMENTS(null,:IN_ID_REPORT_SESSION)';
   DSetDepartments.ParamByName('IN_ID_REPORT_SESSION').AsInt64:=id_session;
   DSetData.SQLs.SelectSQL.Text :='SELECT distinct * FROM UP_REPORT_FORMA9_REASONS(?OUT_DATE_CHECK,?ID_DEPARTMENT,?USE_REASONS,?USE_DETALISATION,:IN_ID_REPORT_SESSION)';
...
procedure TfrmUpReportForma9Main.FontActionExecute(Sender: TObject);
begin
