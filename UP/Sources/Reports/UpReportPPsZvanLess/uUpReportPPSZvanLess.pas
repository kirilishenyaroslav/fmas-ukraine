...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text:='select distinct * from UP_REPORT_PPS_ZVAN_LESS(:IN_ID_REPORT_SESSION) Order By display_2, display_1, FIO collate win1251_ua';
