...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text        := 'select distinct * from UP_REPORT_PENSIONERS(:IN_ID_REPORT_SESSION) Order By FIO_PENTION Collate Win1251_Ua';
        try
        ...
        Report.LoadFromFile(ExtractFilePath(Application.ExeName)+'Reports\Up\UpReportPensionersP.fr3',True)
        else
