...
uses dmUpReportNumber, NagScreenUnit;
...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text:='select distinct * from UP_REPORT_NUMBER_PEOPLE(:IN_ID_REPORT_SESSION,:ID_Centers) Order By NAME_DEPARTMENT collate win1251_ua';
