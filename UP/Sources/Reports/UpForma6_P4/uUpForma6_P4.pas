...
uses dmForma6_P4 ,NagScreenUnit;
...
begin
    ...
    NameRep:=Dm.DSet.FieldValues['NAME_REPORT'];
...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text:='SELECT * FROM UP_REPORT_FORMA6_P4(:IN_ID_REPORT_SESSION) ORDER BY NAME_DEPARTMENT_UPPER,NAME_DEPARTMENT, ID_PROP';
