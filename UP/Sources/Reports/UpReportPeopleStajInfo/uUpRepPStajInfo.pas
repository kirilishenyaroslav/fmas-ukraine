...
uses
  ...
  FIBDataSet, pFIBDataSet, frxExportHTML, frxExportRTF, ActnList, NagScreenUnit;
...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text:='select distinct * from UP_REPORT_PEOPLE_STAJ_INFO(:IN_ID_REPORT_SESSION) order by display_2, display_1, fio collate win1251_ua';
