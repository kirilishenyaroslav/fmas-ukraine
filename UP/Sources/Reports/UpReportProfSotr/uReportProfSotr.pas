...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text        := 'select distinct * from UP_REPORT_PROF_SOTR(:IN_ID_REPORT_SESSION) Order By NAME_FACULTY, FIO';
        try
