...
uses dmUP_Report_F6_P1, NagScreenUnit;
...
begin
  ...
  {  Precision:=TpFIBDataSet.Create(Self);
    ...
    begin
        ...
        DSetData.SelectSQL.Text:='select distinct * from UP_Report_F6_P1_PRINT(:IN_ID_REPORT_SESSION) Order by DISPLAY_ORDER asc';
