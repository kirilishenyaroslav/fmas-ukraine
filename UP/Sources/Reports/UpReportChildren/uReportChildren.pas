...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text        := 'select distinct * from UP_REPORT_LISTCHILD(:IN_ID_REPORT_SESSION) Order By FIO_RODIT collate win1251_ua';
        try
