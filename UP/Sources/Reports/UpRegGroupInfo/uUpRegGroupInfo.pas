...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text:='select distinct * from UP_REPORT_REGARDS_INFO_PEOPLE(:IN_ID_REPORT_SESSION) Order By ID_REG_GROUP, DISPLAY_1, DISPLAY_2, FIO collate win1251_ua';
