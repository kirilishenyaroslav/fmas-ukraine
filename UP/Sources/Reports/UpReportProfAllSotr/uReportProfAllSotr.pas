...
//    Screen.Cursor := crHourGlass;
    ...
    NagScreen.Show;
    NagScreen.SetStatusText('Чекайте! Йде формавання звіту.');
...
//        DSetGlobalData.Sqls.SelectSQL.Text  := 'select distinct * from UP_REPORT_FUTURE_PENSIONERS_DES('+IntToStr(id_session)+', null)';
        DSetData.Sqls.SelectSQL.Text        := 'select distinct * from UP_REPORT_PROF_ALL_SOTR('+IntToStr(id_session)+') Order By NAME_FACULTY, FIO';
        try
