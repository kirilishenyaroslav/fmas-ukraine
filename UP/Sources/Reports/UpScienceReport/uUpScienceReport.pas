...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text:='select distinct * from UP_REPORT_SCIENCE_REGARDS(:IN_ID_REPORT_SESSION) Order By id_work_reason, display_2, display_1, fio';
        try
        ...
        Report.Variables['NameV']:=QuotedStr(DSetData['FIRM_NAME']);
        Report.Variables['CUR_DATE']:=QuotedStr(DSetData['CUR_DATE']);
        //Report.Variables['PROPERTY_NAME']:= QuotedStr(DSetData['PROPERTY_NAME']);
        //Report.Variables['SCIENCE']:= QuotedStr(DSetData['SCIENCE']);
