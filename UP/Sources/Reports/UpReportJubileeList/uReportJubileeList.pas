...
uses dmReportJubileeList, DateUtils;
...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text        := 'SELECT * FROM  UP_REPORT_JUBILEE_LIST(:IN_ID_REPORT_SESSION) ORDER BY month_sort, day_sort, familiya collate win1251_ua';
        try
