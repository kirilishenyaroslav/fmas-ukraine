...
uses dmStatistics, NagScreenUnit;
...
begin
   ...
   // DateWork:=self.WorkEdit.Date;
    ...
    begin
        ...
        DSetData.SelectSQL.Text:='select distinct * from UP_GET_STATISTICS_BY_HOLIDAY(:IN_ID_REPORT_SESSION) Order By Name_Holiday collate win1251_ua';
