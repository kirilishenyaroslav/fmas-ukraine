...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text:='select distinct * from UP_REPORT_SHTAT_FORMULAR_SOCR(:IN_ID_REPORT_SESSION, :IS_SHOW_POCHAS) order by display_2, display_1, display_work_reason, display_category, display_post, fio collate win1251_ua';

        try
            DSetData.ParamByName('IN_ID_REPORT_SESSION').AsInt64:=id_session;
            DSetData.ParamByName('IS_SHOW_POCHAS').AsShort:=Integer(Boolean(IsShowPochas.Checked));
