...
begin
    ...
    begin
        ...
        WriteTransaction.StartTransaction;
        //DSetGlobalData.SelectSQL.Text  := 'select distinct * from UP_REPORT_FUTURE_PENSIONERS_DES('+IntToStr(id_session)+', null)';
        DSetData.SelectSQL.Text        := 'select distinct * from UP_REPORT_FUTURE_PENSIONERS('+IntToStr(id_session)+') Order By NAME_DEPARTMENT, FIO collate win1251_ua';
        try
...
{        if  DSetData.IsEmpty then
        begin
            ...
            try
                ...
                Dm.StoredProc.StoredProcName                              := 'UP_REPORT_FUTURE_PENSIONERS_DED';
                Dm.StoredProc.Prepare;
                Dm.StoredProc.ParamByName('D_ID_SESSION').AsInt64         := id_session;
                Dm.StoredProc.ExecProc;
