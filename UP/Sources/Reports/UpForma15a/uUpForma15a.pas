...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text:='select * from UP_REPORT_FORMA_15A(:IN_ID_REPORT_SESSION) Order By WORK_REASON_FULL, NAME_DEPARTMENT_UPPER,NAME_DEPARTMENT, fio collate win1251_ua';
