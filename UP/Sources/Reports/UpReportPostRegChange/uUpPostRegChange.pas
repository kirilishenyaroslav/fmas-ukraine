...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text:='select distinct * from UP_REPORT_POST_REGARDS_CHANGE(:IN_ID_REPORT_SESSION) Order By FIO collate win1251_ua';
