...
uses dmReportBirthday, DateUtils;
...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text        := 'SELECT DISTINCT * FROM UP_REPORT_BIRTHDAY(:IN_ID_REPORT_SESSION) ORDER BY  BIRTH_DATE asc, FIO COLLATE WIN1251_UA';
        try
