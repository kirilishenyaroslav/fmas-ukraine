...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text:='select distinct * from UP_REPORT_PEOPLE_LESS_WITH_REG(:IN_ID_REPORT_SESSION) Order By display_3 ,display_2, display_1, fio collate win1251_ua';
