...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text:='select distinct * from UP_REPORT_VACANCIES(:IN_ID_REPORT_SESSION,:WITH_CHILD,:WITH_HIDE) Order By NAME_DEPARTMENT_UPPER,NAME_DEPARTMENT,POST_NAME COLLATE WIN1251_UA,SMETA_TITLE';
        try
