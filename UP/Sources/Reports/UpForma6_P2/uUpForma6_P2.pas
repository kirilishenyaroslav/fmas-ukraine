...
uses dmForma6_P2 ,NagScreenUnit;
...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text:='SELECT * FROM UP_REPORT_FORMA6_P2(:IN_ID_REPORT_SESSION) ORDER BY NAME_DEPARTMENT_UPPER,NAME_DEPARTMENT';
