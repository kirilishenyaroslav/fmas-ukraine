...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text:='select distinct * from UP_REPORT_REGARDS_COMMON(:IN_ID_REPORT_SESSION) Order By WORK_REASON_FULL DESC, DEPARTMENT_NAME_UPPER, FIO collate win1251_ua';
        ...
        Report.Variables['REGARD_NAME']:=QuotedStr(' звання або нагороди');
