...
uses
  ...
  cxGridCustomView, cxGrid;
    ...
    type
    TUP_UP_REPORT_LEADERS= class(TSprav)
    public
        constructor Create;
...
uses dmUP_REPORT_LEADERS, NagScreenUnit, BaseTypes, Sp_leaders;
...
destructor TUP_UP_REPORT_LEADERS.Destroy;
begin
    inherited Destroy;
end;
...
function CreateSprav: TSprav;stdcall;
begin
    Result := TUP_UP_REPORT_LEADERS.Create;
end;

constructor TUP_UP_REPORT_LEADERS.Create;
begin
    inherited Create;
...
procedure TUP_UP_REPORT_LEADERS.Show;
var
    hnd: Integer;
    Print: TfmMain;
begin
...
var
      T:TfmSp_Leaders;
begin
     T := TfmSp_Leaders.Create(Self,DM.DB.Handle);
     T.ShowModal;
     T.Free;
end;
