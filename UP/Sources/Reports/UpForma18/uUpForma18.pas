...
begin
   ...
   // DateWork:=self.WorkEdit.Date;
    ...
    begin
        ...
        DSetData.SelectSQL.Text:='select distinct * from UP_REPORT_FORMA_18(:IN_ID_REPORT_SESSION) Order By NAME_DEPARTMENT_UPPER, NAME_DEPARTMENT, FIO collate win1251_ua';
