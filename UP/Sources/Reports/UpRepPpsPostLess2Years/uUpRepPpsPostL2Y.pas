...
destructor TUP_PpsPost.Destroy;
begin
    inherited Destroy;
end;
...
function CreateSprav: TSprav;stdcall;
begin
    Result := TUP_PpsPost.Create;
end;

constructor TUP_PpsPost.Create;
begin
    inherited Create;
...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text:='select distinct * from UP_REPORT_PPS_POST_LESS_2YEARS(:IN_ID_REPORT_SESSION) order by display_2, display_1, fio collate win1251_ua';
