unit uReportWorkingPensioners2;
...
uses dmReportWorkingPensioners2,
     NagScreenUnit;
...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text        := 'select distinct * from UP_REPORT_WORKING_PENSIONERS_2(:IN_ID_REPORT_SESSION) Order By FIO_PENTION Collate Win1251_Ua';
        try
