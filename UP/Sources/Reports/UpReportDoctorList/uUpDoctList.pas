...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text:='select distinct * from UP_REPORT_DOCTOR_LIST(:IN_ID_REPORT_SESSION) order by familiya collate win1251_ua, imya collate win1251_ua, otchestvo collate win1251_ua';
