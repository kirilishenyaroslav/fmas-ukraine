...
uses dmReportWithPensienceWork,
     NagScreenUnit;
...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text        := 'select distinct * from UP_REPORT_WITH_PEN_SCIENCE_WORK(:IN_ID_REPORT_SESSION) Order By NAME_FACULTY, NAME_CAFEDRA, FIO';
        try
