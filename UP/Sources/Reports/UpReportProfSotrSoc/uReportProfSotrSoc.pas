...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text        := 'select distinct * from UP_REPORT_PROF_SOTR_SOC(:IN_ID_REPORT_SESSION) Order By NAME_FACULTY, CAFEDRA_POST, FIO';
        try
