...
destructor TUP_CandList.Destroy;
begin
    inherited Destroy;
end;
...
function CreateSprav: TSprav;stdcall;
begin
    Result := TUP_CandList.Create;
end;

constructor TUP_CandList.Create;
begin
    inherited Create;
...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text:='select distinct * from UP_REPORT_CANDIDATE_LIST(:IN_ID_REPORT_SESSION) order by familiya collate win1251_ua, imya collate win1251_ua, otchestvo collate win1251_ua';
