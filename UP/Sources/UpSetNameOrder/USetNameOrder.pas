...
begin
     Result := TUP_SetNameOrder.Create;
end;

constructor TUP_SetNameOrder.Create;
begin
    inherited Create;
...
destructor TUP_SetNameOrder.Destroy;
begin
     if assigned(form) then Form.Free;
     inherited;
end;

function TUP_SetNameOrder.GetFrame: TFrame;
begin
