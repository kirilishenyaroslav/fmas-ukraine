object HP_RecalcForm: THP_RecalcForm
  Left = 396
  Top = 247
  BorderStyle = bsDialog
  Caption = #1056#1086#1079#1088#1072#1093#1091#1085#1086#1082' '#1087#1083#1072#1085#1086#1074#1080#1093' '#1074#1110#1076#1087#1091#1089#1090#1086#1082
  ClientHeight = 102
  ClientWidth = 294
  Color = clBtnFace
  ...
  object qFEC_Interval: TqFEnumControl
    Left = 8
    Top = 8
    Width = 225
    Height = 21
  ...
  object qFEC_Level: TqFEnumControl
    Left = 8
    Top = 40
    Width = 225
    Height = 21
    DisplayName = #1056#1110#1074#1077#1085#1100
    Interval = 50
    Value = Null
    LabelColor = clGreen
    Required = True
  ...
  object pFIBDS_FillPeriod: TpFIBDataSet
    SelectSQL.Strings = (
      'select * from HL_GET_ACT_PERIOD;')
    Left = 240
    poSQLINT64ToBCD = True
  end
  object pFIBDS_FillLevel: TpFIBDataSet
    SelectSQL.Strings = (
      'select * from UP_GET_LEVELS_EXT;')
    Left = 240
    Top = 40
    poSQLINT64ToBCD = True
  end
