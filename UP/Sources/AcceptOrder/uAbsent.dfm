object fmAbsentForm: TfmAbsentForm
  Left = 449
  Top = 228
  BorderIcons = [biSystemMenu]
  BorderStyle = bsDialog
  Caption = #1055#1088#1080#1081#1086#1084' '#1085#1072' '#1095#1072#1089#1090#1100' '#1074#1110#1076#1089#1091#1090#1085#1100#1086#1075#1086' '#1087#1088#1072#1094#1110#1074#1085#1080#1082#1072
  ClientHeight = 181
  ClientWidth = 620
  Color = clBtnFace
