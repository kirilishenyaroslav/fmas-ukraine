object fmAcceptCond: TfmAcceptCond
  Left = 264
  Top = 110
  BorderStyle = bsSingle
  Caption = #1059#1084#1086#1074#1080' '#1074#1089#1090#1091#1087#1091' '#1076#1086' '#1087#1086#1089#1072#1076#1080
  ClientHeight = 566
  ClientWidth = 792
  Color = clBtnFace
  ...
  object cxGrid1: TcxGrid
    ...
    Align = alClient
    TabOrder = 0
    object AcceptCondView: TcxGridDBTableView
      OnDblClick = AcceptCondViewDblClick
      DataController.DataSource = AcceptDataSource
      ...
      object AcceptCondViewID_ACCEPT_COND: TcxGridDBColumn
        Visible = False
        DataBinding.FieldName = 'ID_ACCEPT_COND'
      end
      object AcceptCondViewNAME_ACCEPT_COND: TcxGridDBColumn
        Width = 302
        DataBinding.FieldName = 'NAME_ACCEPT_COND'
      end
      object AcceptCondViewNAME_ACCEPT_COND_PRINT: TcxGridDBColumn
        Width = 558
        DataBinding.FieldName = 'NAME_ACCEPT_COND_PRINT'
      end
    end
    object cxGrid1Level1: TcxGridLevel
      GridView = AcceptCondView
    end
  end
  ...
  object AcceptCondSelect: TpFIBDataSet
    Database = DB
    Transaction = ReadTransaction
    SelectSQL.Strings = (
      'SELECT * FROM ASUP_ORDERS_ACCEPT_COND_SEL')
    Left = 616
    Top = 208
    poSQLINT64ToBCD = True
    object AcceptCondSelectID_ACCEPT_COND: TFIBIntegerField
      FieldName = 'ID_ACCEPT_COND'
      Visible = False
    end
    object AcceptCondSelectNAME_ACCEPT_COND: TFIBStringField
      DisplayLabel = #1053#1072#1079#1074#1072' '#1091#1084#1086#1074' '#1074#1089#1090#1091#1087#1091
      FieldName = 'NAME_ACCEPT_COND'
      Size = 255
      EmptyStrToNull = True
    end
    object AcceptCondSelectNAME_ACCEPT_COND_PRINT: TFIBStringField
      DisplayLabel = #1053#1072#1079#1074#1072' '#1076#1083#1103' '#1076#1088#1091#1082#1091
      FieldName = 'NAME_ACCEPT_COND_PRINT'
      Size = 255
      EmptyStrToNull = True
    end
  end
  object AcceptDataSource: TDataSource
    DataSet = AcceptCondSelect
    Left = 688
    Top = 232
  end
  object ActionControl: TqFActionControl
    DeleteSQL.Strings = (
      'EXECUTE PROCEDURE ASUP_ORDERS_ACCEPT_COND_DEL :where')
    SelectDataSet = AcceptCondSelect
    KeyFields = 'Id_Accept_Cond'
    RefreshAction = RefreshAction
    DeleteAction = DeleteAction
    AddFormClass = 'TfmAcceptCondEdit'
    AddAction = AddAction
