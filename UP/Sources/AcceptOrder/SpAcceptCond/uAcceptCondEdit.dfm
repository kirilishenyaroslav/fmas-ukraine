object fmAcceptCondEdit: TfmAcceptCondEdit
  Left = 374
  Top = 273
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = #1059#1084#1086#1074#1072' '#1074#1089#1090#1091#1087#1091' '#1076#1086' '#1087#1086#1089#1072#1076#1080
  ClientHeight = 173
  ClientWidth = 430
  Color = clBtnFace
  ...
  object FormControl: TqFFormControl
    ...
    InsertSQL.Strings = (
        ...
        'SELECT Id_Accept_Cond FROM ASUP_ORDERS_ACCEPT_COND_INS(:Name_Acc' +
        'ept_Cond,'
      ':Name_Accept_Cond_Print)')
    UpdateSQL.Strings = (
      
        'EXECUTE PROCEDURE ASUP_ORDERS_ACCEPT_COND_UPD :where, :Name_Acce' +
        'pt_Cond,'
      ':Name_Accept_Cond_Print')
    SelectSQL.Strings = (
      'SELECT * FROM ASUP_ORDERS_ACCEPT_COND_DET(:where)')
    Mode = fmAdd
    CheckWhere = True
    CloseForm = True
  ...
  object qFCharControl1: TqFCharControl
    ...
    DisplayName = #1053#1072#1079#1074#1072' '#1091#1084#1086#1074' '#1074#1089#1090#1091#1087#1091
    Interval = 150
    Value = ''
    LabelColor = clGreen
    Required = True
  ...
  object qFCharControl2: TqFCharControl
    Left = 24
    Top = 72
    Width = 385
    Height = 21
    FieldName = 'Name_Accept_Cond_Print'
    DisplayName = #1053#1072#1079#1074#1072' '#1076#1083#1103' '#1076#1088#1091#1082#1091
    Interval = 150
    Value = ''
    LabelColor = clGreen
    Required = True
