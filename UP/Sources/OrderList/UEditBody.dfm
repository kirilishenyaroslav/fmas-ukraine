object frmEditBody: TfrmEditBody
  Left = 349
  Top = 230
  BorderStyle = bsDialog
  Caption = #1056#1077#1076#1072#1082#1090#1080#1088#1086#1074#1072#1085#1080#1103' '#1090#1077#1083#1072' '#1087#1088#1080#1082#1072#1079#1072
  ClientHeight = 232
  ClientWidth = 481
  Color = clBtnFace
