...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text:='select distinct * from UP_DT_SH_FORMULAR_PPS(:IN_ID_REPORT_SESSION) Order By display_order_tp,NAME_FACULTY,NAME_CAFEDRA, '+SORT_FIELD;
