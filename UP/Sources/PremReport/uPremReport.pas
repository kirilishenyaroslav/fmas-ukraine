...
begin
    ...
    frm.SizeFont.Text:='12';
    frm.pFIBDataSet1.Close;
    frm.pFIBDataSet1.SQLs.SelectSQL.Text:='select * from UP_DT_PRINT_PREM_ORD(:ID_ORDER) order by DISPLAY2, DISPLAY1, fio collate win1251_ua';
...
begin
    ...
    begin
        ...
        frxReport1.LoadFromFile(ExtractFilePath(Application.ExeName) + '\Reports\Up\PremReport.fr3', true);
