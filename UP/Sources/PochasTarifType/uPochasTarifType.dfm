object frmPochasType: TfrmPochasType
  ...
  Width = 630
  Height = 509
  Caption = #1044#1086#1074#1110#1076#1085#1080#1082' '#1090#1080#1087#1110#1074' '#1090#1072#1088#1080#1092#1110#1074' '#1087#1086#1075#1086#1076#1080#1085#1085#1086#1081' '#1089#1087#1083#1072#1090#1080
  Color = clBtnFace
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBTableView1: TcxGridDBTableView
      ...
      OptionsBehavior.IncSearchItem = cxGrid1DBTableView1TARIF_TYPE_NAME
  ...
  object DataSet: TpFIBDataSet
    ...
    SelectSQL.Strings = (
      'select * from ASUP_INI_POCHAS_TARIF_TYPE_S')
    Left = 80
    Top = 104
