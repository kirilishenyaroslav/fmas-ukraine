object FormComandFactEdit: TFormComandFactEdit
  Left = 405
  Top = 187
  BorderStyle = bsDialog
  Caption = #1092#1072#1082#1090' '#1074#1110#1076#1088#1103#1076#1078#1077#1085#1085#1103
  ClientHeight = 401
  ClientWidth = 591
  Color = clBtnFace
  ...
  object PanelFact: TPanel
    ...
    object cxDateBeg: TcxDateEdit
      ...
      Width = 121
      Height = 21
      Properties.OnEditValueChanged = cxDateBegPropertiesEditValueChanged
      Style.Color = clInfoBk
      TabOrder = 0
    end
    object cxDateEnd: TcxDateEdit
      ...
      Width = 121
      Height = 21
      Properties.OnEditValueChanged = cxDateEndPropertiesEditValueChanged
      Style.Color = clInfoBk
      TabOrder = 1
    end
    object cxLabelDateBeg: TcxLabel
      ...
      Style.Font.Style = []
      TabOrder = 2
      Caption = #1044#1072#1090#1072' '#1087#1086#1095#1072#1090#1082#1091' '#1074#1110#1076#1088#1103#1076#1078#1077#1085#1085#1103':'
    end
    object cxLabelDateEnd: TcxLabel
      ...
      Style.Font.Style = []
      TabOrder = 3
      Caption = #1044#1072#1090#1072' '#1082#1110#1085#1094#1103' '#1074#1110#1076#1088#1103#1076#1078#1077#1085#1085#1103':'
    end
    object cxLabelDaysCount: TcxLabel
      ...
      Style.Font.Style = []
      TabOrder = 4
      Caption = #1050#1110#1083#1100#1082#1110#1089#1090#1100' '#1076#1085#1110#1074' '#1074#1110#1076#1088#1103#1076#1078#1077#1085#1085#1103':'
    end
    ...
    object GBSmet: TGroupBox
      ...
      object cxGridSmet: TcxGrid
        ...
        object cxGridSmetTableView: TcxGridTableView
          ...
          Styles.StyleSheet = FormComandFactMain.qizzStyle
