object fmUpAbsentForm: TfmUpAbsentForm
  Left = 271
  Top = 231
  BorderIcons = [biSystemMenu]
  BorderStyle = bsDialog
  Caption = #1055#1077#1088#1077#1074#1077#1076#1077#1085#1085#1103'/'#1087#1086#1076#1086#1074#1078#1077#1085#1085#1103' '#1088#1086#1073#1086#1090#1080' '#1085#1072' '#1095#1072#1089' '#1074#1110#1076#1089#1091#1090#1085#1100#1086#1075#1086' '#1089#1087#1110#1074#1088#1086#1073#1110#1090#1085#1080#1082#1072
  ClientHeight = 181
  ClientWidth = 620
  Color = clBtnFace
  ...
  object Id_Away_Type: TqFEnumControl
    Left = 16
    Top = 24
    Width = 585
    Height = 21
    FieldName = 'Id_Away_Type'
    DisplayName = #1058#1080#1087' '#1074#1110#1076#1089#1091#1090#1085#1086#1089#1090#1110
    Interval = 180
    Value = Null
    LabelColor = clGreen
    Required = True
    ...
    Asterisk = True
    Enabled = True
    OnChange = Id_Away_TypeChange
    Blocked = False
    TabOrder = 0
    AutoSaveToRegistry = False
  end
  object Id_PCard_Away: TqFSpravControl
    Left = 16
    Top = 101
    Width = 585
    Height = 21
    FieldName = 'Id_PCard_Away'
    DisplayName = #1042#1110#1076#1089#1091#1090#1085#1103' '#1083#1102#1076#1080#1085#1072
    Interval = 180
    Value = Null
    LabelColor = clGreen
    Required = True
    ...
    TabOrder = 2
    AutoSaveToRegistry = False
    OnOpenSprav = Id_PCard_AwayOpenSprav
    DisplayText = ''
  end
  object Id_Key: TqFSpravControl
    Left = 15
    Top = 62
    Width = 586
    Height = 21
    FieldName = 'Id_Key'
    DisplayName = #1044#1086#1082#1091#1084#1077#1085#1090
    Interval = 180
    Value = Null
    LabelColor = clGreen
    Required = True
