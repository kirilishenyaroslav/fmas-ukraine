object fmWarnDismission: TfmWarnDismission
  Left = 293
  Top = 221
  Width = 887
  Height = 516
  Caption = #1056#1077#1108#1089#1090#1088' '#1079#1074#1110#1083#1100#1085#1077#1085#1080#1093' '#1089#1087#1110#1074#1088#1086#1073#1110#1090#1085#1080#1082#1110#1074' '#1091' '#1085#1072#1082#1072#1079#1110
  Color = clBtnFace
  ...
  object WarningsGrid: TcxGrid
    ...
    object WarningsView: TcxGridDBTableView
      ...
      object NAME_DateColumn: TcxGridDBColumn
      ...
      object ORDERColumn: TcxGridDBColumn
        Caption = #1053#1072#1082#1072#1079
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Width = 449
        DataBinding.FieldName = 'ORDER_INFO'
      end
    end
