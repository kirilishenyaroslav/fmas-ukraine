object frmGetErrors: TfrmGetErrors
  ...
  Caption = #1055#1110#1076' '#1095#1072#1089' '#1087#1088#1086#1074#1077#1076#1077#1085#1085#1103' '#1085#1072#1082#1072#1079#1072' '#1074#1080#1085#1080#1082#1083#1080' '#1087#1086#1084#1080#1083#1082#1080
  ClientHeight = 264
  ClientWidth = 521
  Color = clBtnFace
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGridDBTableView1: TcxGridDBTableView
      ...
      object cxGridDBTableView1DBColumn1: TcxGridDBColumn
        ...
        Width = 68
        DataBinding.FieldName = 'ERROR_CODE'
      end
      object cxGridDBColumn1: TcxGridDBColumn
        Caption = #1058#1077#1082#1089#1090' '#1087#1086#1084#1080#1083#1082#1080
  ...
  object ErrorTextsMemoryData: TRxMemoryData
    FieldDefs = <>
    Left = 8
    Top = 40
  end
  object ErrorTextDataSource: TDataSource
    DataSet = ErrorTextsMemoryData
    Left = 40
    Top = 40
  end
