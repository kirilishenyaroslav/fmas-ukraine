object frmPochasPerc: TfrmPochasPerc
  Left = 526
  Top = 239
  Width = 595
  Height = 445
  Caption = #1044#1086#1074#1110#1076#1085#1080#1082' '#1087#1088#1086#1094#1077#1085#1090#1110#1074' '#1087#1086#1075#1086#1076#1080#1085#1085#1086#1081' '#1089#1087#1083#1072#1090#1080
  Color = clBtnFace
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBTableView1: TcxGridDBTableView
      ...
      object cxGrid1DBTableView1ID_POCHAS_PERC: TcxGridDBColumn
        ...
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        DataBinding.FieldName = 'ID_POCHAS_PERC'
      end
  ...
  object DataSet: TpFIBDataSet
    ...
    SelectSQL.Strings = (
      'select * from UP_SP_POCHAS_TARIF_PERC_S')
    Left = 88
    Top = 160
