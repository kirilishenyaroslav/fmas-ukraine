object frmOtpuskKompens: TfrmOtpuskKompens
  Left = 192
  Top = 103
  ...
  object Panel3: TPanel
    ...
    object KompensEdit: TqFSpravControl
      Left = 16
      Top = 48
      Width = 377
      Height = 21
      DisplayName = #1050#1086#1084#1087#1077#1085#1089#1091#1074#1072#1090#1080
      Interval = 132
      Value = Null
      LabelColor = clGreen
      Required = True
      ...
      TabOrder = 1
      AutoSaveToRegistry = False
      OnOpenSprav = KompensEditOpenSprav
      DisplayText = ''
    end
  ...
  object ReasonDSet: TpFIBDataSet
    Database = Database
    Transaction = ReadTransaction
