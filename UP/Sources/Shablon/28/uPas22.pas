unit uPas22; {Тимчасове переведення на інше місце роботи}
...
var
    ...
    IsInSovm, AddInfo, BonusSumma, BonusSummaPps: string;
...
//    func : function(hConnection: TISC_DB_HANDLE; id_session, id_item : Int64): String; stdcall;
    ...
    d_inf: TDateTime;
    flag_bonus, flag_name_cond, flagok, flR: boolean;
                                ...
                                begin
                                    ...
                                    begin
                                        ...
                                        begin
                                            ...
                                            BonusSummaPps := BonusSummaPps + ' грн. ';
