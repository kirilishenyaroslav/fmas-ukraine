unit uPas4; {Переведення на інше місце роботи}
...
var szResult, stavka_str, hours_str: string; //  Строка для формирования результирующей строки
    ...
    PayForm, iR, IdAwayType, ending: Integer;
...
//        szResult := szResult + DS.FBN('PARAMETR_VALUE').AsString + ', ';
        ...
        for iTemp := 1 to iLength do begin
            ...
            begin
                ...
                begin
                    DS.Locate('PARAMETR_NAME', 'TO_KOEFF_PPS_1_1_' + IntToStr(iTemp), []);
                    KoeffPps := DS.FBN('PARAMETR_VALUE').AsString;
        ...
        begin
          ...
          //начало вставки
            ...
            begin
                ...
                begin
                   ending := DS.FBN('PARAMETR_VALUE').AsInteger;
            ...
            begin
                ...
                begin
                    if DS.Locate('PARAMETR_NAME', 'INST_WITH_RETURN_1_1', []) then
                        if DS.FBN('PARAMETR_VALUE').AsInteger = 1 then
                        begin
                            szResult := szResult + ' основний трудовий договір по ' + DateToStr(d) + ', ';
