unit uTemplateReceipt24; {Змінити джерела фінансування}
...
var szResult, stavka_str : String;            //  Строка для формирования результирующей строки
    ...
    is_b_p, UseDigit, iR : Integer;  //Печатать расшифровку по сметам в надбавках
...
{        else
        begin
            ...
            if UseDigit=2 then szResult := szResult + 'з тарифом '+ FormatFloat('0.00', fTemp) + ' грн. <b><i>встановити оплату</i></b> з '
            else szResult := szResult + 'з окладом '+FormatFloat('0.00', fTemp) + ' грн. на місяць <b><i>встановити оплату</i></b> з ';
