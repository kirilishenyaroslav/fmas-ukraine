unit uTemplateReceipt4; {Переведення на інше місце роботи}
...
var szResult, stavka_str, hours_str: string; //  Строка для формирования результирующей строки
    ...
    iTemp, k, i, j, m, iT, iR: Integer; //  Переменная для хранения значения целого типа
...
begin
    ...
    //  Формирование шаблона
        ...
        IdServer := DS.fbn('ID_SERVER').AsInteger;
        DS.Close;
