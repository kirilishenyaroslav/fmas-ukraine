...
type
  TfmMain = class(TForm)
    ...
    procedure UP_REPORT_F6_PRINTUP_REPORT_F6_PRINTUP_REPORT_F6_PRINT(Sender: TObject);
...
procedure TfmMain.UP_REPORT_F6_PRINTUP_REPORT_F6_PRINTUP_REPORT_F6_PRINT(Sender: TObject);
var
...
begin
    ...
    begin
        ...
        DSetData.SelectSQL.Text:='select distinct * from UP_REPORT_F6_PRINT(:IN_ID_REPORT_SESSION) Order by NAME_DEPARTMENT, STAVKA desc';
