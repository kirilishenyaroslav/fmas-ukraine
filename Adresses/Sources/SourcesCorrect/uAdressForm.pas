...
uses uUnivSprav, uAddCountry,uFormControl,uAddRegion, uAddPlace, uAddStreetForm,
     uAddDistrict, qFTools, AdrSp_Types;
...
begin
  ACF:=TAdd_Country_Form.Create(Self,AdressDM.pFIBDB_Adr.Handle,-1);
...
begin
  ARF:=TAdd_Region_Form.Create(Self,AdressDM.pFIBDB_Adr.Handle,-1);
  ARF.pIdCountry:=AdressDM.pFIBDS_SelectCountry['id_country'];
  ARF.CountryBE.Text:=AdressDM.pFIBDS_SelectCountry['name_country'];
  if ARF.ShowModal=mrOk then
   begin
     with AdressDM do
     begin
       id_region:=ARF.ResultId;
       id_district:=pFIBDS_SelectDistrict['id_district'];
       id_place:=pFIBDS_SelectPlace['id_place'];
...
begin
  ADF:=TAdd_District_Form.Create(Self,AdressDM.pFIBDB_Adr.Handle,-1);
  ADF.pIdRegion:=AdressDM.pFIBDS_SelectRegion['id_region'];
  ADF.RegionBE.Text:=AdressDM.pFIBDS_SelectRegion['name_region'];
  if ADF.ShowModal=mrOk then
   begin
     with AdressDM do
     begin
       id_region:=ADF.pIdRegion;
       id_district:=ADF.ResultId;
       id_place:=pFIBDS_SelectPlace['id_place'];
       id_street:=pFIBDS_SelectStreet['id_street'];
     end;
     RefreshAExecute(Sender);
...
begin
  APF:=TAdd_Place_Form.Create(Self,AdressDM.pFIBDB_Adr.Handle,-1);
  APF.pIdRegion:=AdressDM.pFIBDS_SelectRegion['id_region'];
  APF.RegionBE.Text:=AdressDM.pFIBDS_SelectRegion['name_region'];
  APF.pIdDistrict:=AdressDM.pFIBDS_SelectDistrict['id_district'];
  APF.DistrictBE.Text:=AdressDM.pFIBDS_SelectDistrict['name_district'];
  if APF.ShowModal=mrOk then
   begin
     with AdressDM do
     begin
       id_region:=APF.pIdRegion;
       id_district:=APF.pIdDistrict;
       id_place:=APF.ResultId;
       id_street:=pFIBDS_SelectStreet['id_street'];
     end;
     RefreshAExecute(Sender);
   end;
...
begin
  ASF:=TAdd_Street_Form.Create(Self,AdressDM.pFIBDB_Adr.Handle,-1);
  ASF.pIdPlace:=AdressDM.pFIBDS_SelectPlace['id_place'];
  ASF.PlaceBE.Text:=AdressDM.pFIBDS_SelectPlace['name_place'];
  if ASF.ShowModal=mrOk then
   begin
     ...
     begin
       id_region:=pFIBDS_SelectRegion['id_region'];
       id_district:=pFIBDS_SelectDistrict['id_district'];
       id_place:=ASF.pIdPlace;
       id_street:=ASF.ResultId;
     end;
     RefreshAExecute(Sender);
   end;
end;
...
begin
  MCF:=TAdd_Country_Form.Create(Self,AdressDM.pFIBDB_Adr.Handle,AdressDM.pFIBDS_SelectCountry['id_country']);
  with AdressDM do
  begin
    id_region:=pFIBDS_SelectRegion['id_region'];
    id_district:=pFIBDS_SelectDistrict['id_district'];
...
begin
  ...
  MRF:=TAdd_Region_Form.Create(Self,AdressDM.pFIBDB_Adr.Handle,AdressDM.pFIBDS_SelectRegion['id_region']);
  with AdressDM do
  begin
    id_region:=pFIBDS_SelectRegion['id_region'];
    id_district:=pFIBDS_SelectDistrict['id_district'];
...
begin
  ...
  MDF:=TAdd_District_Form.Create(Self,AdressDM.pFIBDB_Adr.Handle,AdressDM.pFIBDS_SelectDistrict['id_district']);
...
begin
  ...
  MPF:=TAdd_Place_Form.Create(Self,AdressDM.pFIBDB_Adr.Handle,AdressDM.pFIBDS_SelectPlace['id_place']);
...
begin
  ...
  MSF:=TAdd_Street_Form.Create(Self,AdressDM.pFIBDB_Adr.Handle,AdressDM.pFIBDS_SelectStreet['id_street']);
