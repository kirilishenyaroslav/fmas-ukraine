object Add_Place_Form: TAdd_Place_Form
  Left = 299
  Top = 181
  ...
  object RegionBE: TcxButtonEdit
    ...
    Properties.ReadOnly = True
    Properties.OnButtonClick = RegionBEPropertiesButtonClick
    Properties.OnChange = RegionBEPropertiesChange
    TabOrder = 7
  end
  ...
  object DistrictBE: TcxButtonEdit
    Left = 88
    Top = 80
    Width = 273
    Height = 21
    ...
    Properties.ReadOnly = True
    Properties.OnButtonClick = DistrictBEPropertiesButtonClick
    TabOrder = 14
  end
