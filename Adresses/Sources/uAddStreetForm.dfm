object Add_Street_Form: TAdd_Street_Form
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object qFFC_Street: TqFFormControl
    Left = 216
    Top = 88
    Width = 60
    Height = 21
    ...
    InsertSQL.Strings = (
        ...
        'select id_street from ADR_STREET_IU(:where,:ID_PLACE,:ID_TYPE_ST' +
        'REET,:NAME_STREET);')
    UpdateSQL.Strings = (
        ...
        'REET,:NAME_STREET);')
    SelectSQL.Strings = (
      'select * from ADR_STREET_S(:where);')
    AddCaption = #1044#1086#1076#1072#1090#1080' '#1074#1091#1083#1080#1094#1102
    ModifyCaption = #1047#1084#1110#1085#1080#1090#1080' '#1074#1091#1083#1080#1094#1102
    InfoCaption = #1042#1091#1083#1080#1094#1103
    Mode = fmAdd
    CheckWhere = True
    CloseForm = True
  end
