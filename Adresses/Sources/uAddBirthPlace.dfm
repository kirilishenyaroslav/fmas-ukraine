object AddBirthPlace: TAddBirthPlace
  Left = 436
  Top = 243
  ...
  object qFFC_Adress: TqFFormControl
    ...
    ControlsOwner = Owner
    InsertSQL.Strings = (
      'select * from ADR_ADRESS_BPLACE_IU(:id_place,:where);')
    UpdateSQL.Strings = (
      'select * from ADR_ADRESS_BPLACE_IU(:id_place,:where);')
    SelectSQL.Strings = (
      'select * from ADR_ADRESS_BPLACE_SELECT(:where);')
    AddCaption = #1044#1086#1076#1072#1090#1080' '#1084#1110#1089#1094#1077' '#1085#1072#1088#1086#1076#1078#1077#1085#1085#1103
    ModifyCaption = #1047#1084#1110#1085#1080#1090#1080' '#1084#1110#1089#1094#1077' '#1085#1072#1088#1086#1076#1078#1077#1085#1085#1103
    InfoCaption = #1052#1110#1089#1094#1077' '#1085#1072#1088#1086#1076#1078#1077#1085#1085#1103
    Mode = fmAdd
    CheckWhere = True
    CloseForm = True
  end
  ...
  object qFSC_Coutry: TqFSpravControl
    Left = 8
    Top = 8
    Width = 401
    Height = 21
    ...
    Asterisk = True
    Enabled = True
    OnChange = qFSC_CoutryChange
    Blocked = False
    TabOrder = 2
    AutoSaveToRegistry = False
    OnOpenSprav = qFSC_CoutryOpenSprav
    DisplayText = ''
  ...
  object qFSC_City: TqFSpravControl
    Left = 8
    Top = 56
    Width = 401
    Height = 21
    ...
    TabOrder = 4
    AutoSaveToRegistry = False
    OnOpenSprav = qFSC_CityOpenSprav
    DisplayText = ''
