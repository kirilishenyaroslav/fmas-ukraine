object Add_Region_Form: TAdd_Region_Form
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object qFFC_Region: TqFFormControl
    Left = 168
    Top = 88
    Width = 60
    Height = 21
    ...
    InsertSQL.Strings = (
        ...
        'select id_region from ADR_REGION_IU(:where,:NAME_REGION,:ID_COUN' +
        'TRY,:ID_REGION_TYPE);')
    UpdateSQL.Strings = (
        ...
        'TRY,:ID_REGION_TYPE);')
    SelectSQL.Strings = (
      'select * from ADR_REGION_S(:where);')
    AddCaption = #1044#1086#1076#1072#1090#1080' '#1088#1077#1075#1110#1086#1085
    ModifyCaption = #1047#1084#1110#1085#1080#1090#1080' '#1088#1077#1075#1110#1086#1085
    InfoCaption = #1056#1077#1075#1110#1086#1085
    Mode = fmAdd
    CheckWhere = True
    CloseForm = True
  end
