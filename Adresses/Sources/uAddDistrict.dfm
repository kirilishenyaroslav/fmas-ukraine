object Add_District_Form: TAdd_District_Form
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object qFFC_District: TqFFormControl
    Left = 168
    Top = 64
    Width = 60
    Height = 17
    ...
    InsertSQL.Strings = (
        ...
        'select id_district from ADR_DISTRICT_IU(:where,:id_region,:name_' +
        'district);')
    UpdateSQL.Strings = (
        ...
        'district);')
    SelectSQL.Strings = (
      'select * from ADR_DISTRICT_S(:where);')
    AddCaption = #1044#1086#1076#1072#1090#1080' '#1088#1072#1081#1086#1085
    ModifyCaption = #1047#1084#1110#1085#1080#1090#1080' '#1088#1072#1081#1086#1085
    InfoCaption = #1056#1072#1081#1086#1085
    Mode = fmAdd
    CheckWhere = True
    CloseForm = True
  end
