object Add_Country_Form: TAdd_Country_Form
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object qFFC_Country: TqFFormControl
    Left = 168
    Top = 40
    Width = 60
    Height = 21
    ControlsOwner = Owner
    InsertSQL.Strings = (
      'select id_country from ADR_COUNTRY_IU(:where,:NAME_COUNTRY);')
    UpdateSQL.Strings = (
      'select id_country from ADR_COUNTRY_IU(:where,:NAME_COUNTRY);')
    SelectSQL.Strings = (
      'select * from ADR_COUNTRY_S(:where);')
    AddCaption = #1044#1086#1076#1072#1090#1080' '#1082#1088#1072#1111#1085#1091
    ModifyCaption = #1047#1084#1110#1085#1080#1090#1080' '#1082#1088#1072#1111#1085#1091
    InfoCaption = #1050#1088#1072#1111#1085#1072
    Mode = fmAdd
    CheckWhere = True
    CloseForm = True
  end
