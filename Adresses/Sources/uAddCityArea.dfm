object AddCityArea: TAddCityArea
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object qFFC_CArea: TqFFormControl
    Left = 216
    Top = 64
    Width = 60
    Height = 21
    ...
    InsertSQL.Strings = (
        ...
        'select id_CITY_AREA from ADR_CITY_AREA_IU(:where,:ID_PLACE,:NAME' +
        '_CITY_AREA);'
      '')
    UpdateSQL.Strings = (
      ...
      '')
    SelectSQL.Strings = (
      'select * from ADR_CITY_AREA_S(where:);')
    AddCaption = #1044#1086#1076#1072#1090#1080' '#1084#1110#1089#1100#1082#1080#1081' '#1088#1072#1081#1086#1085
    ModifyCaption = #1047#1084#1110#1085#1080#1090#1080' '#1084#1110#1089#1100#1082#1080#1081' '#1088#1072#1081#1086#1085
    InfoCaption = #1052#1110#1089#1100#1082#1080#1081' '#1088#1072#1081#1086#1085
    Mode = fmAdd
    CheckWhere = True
    CloseForm = True
  end
