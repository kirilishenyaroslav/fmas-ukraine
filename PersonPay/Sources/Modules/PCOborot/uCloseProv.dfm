object CloseProvForm: TCloseProvForm
  Left = 371
  Top = 398
  Width = 362
  Height = 166
  ...
  object lbl1: TLabel
    ...
    Width = 317
    Height = 19
    Caption = #1041#1072#1078#1072#1108#1090#1077' '#1087#1088#1086#1110#1085#1076#1077#1082#1089#1091#1074#1072#1090#1080' '#1076#1077#1073#1077#1090#1086#1074#1110' '#1079#1072#1083#1080#1096#1082#1080'?'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -16
  ...
  object lbl2: TLabel
    ...
    Width = 109
    Height = 19
    Caption = #1044#1072#1090#1072' '#1110#1085#1076#1077#1082#1089#1072#1094#1110#1111
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -16
    Font.Name = 'Times New Roman'
  ...
  object cxDateEdit: TcxDateEdit
    ...
    Properties.OnChange = cxDateEditPropertiesChange
    TabOrder = 2
  end
end
