object OborotFormValute: TOborotFormValute
  Left = 169
  Top = 242
  Width = 1050
  Height = 477
  Caption = 'OborotFormValute'
  Color = clBtnFace
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBBandedTableView1: TcxGridDBBandedTableView
      ...
      object cxGridIN_DB_SUMMA_VAL: TcxGridDBBandedColumn
        Caption = #1044#1077#1073#1077#1090' ('#1074#1072#1083'.)'
        Options.Editing = False
        Options.Filtering = False
        Styles.Content = cxStyle7
        Width = 66
        ...
        Position.ColIndex = 1
        Position.RowIndex = 0
        DataBinding.FieldName = 'IN_DB_SUMMA_VAL'
      end
      ...
      object cxGridIN_KR_SUMMA_VAL: TcxGridDBBandedColumn
        Caption = #1050#1088#1077#1076#1080#1090'('#1074#1072#1083'.)'
        Options.Editing = False
        Options.Filtering = False
        Styles.Content = cxStyle12
        Width = 75
        ...
        Position.ColIndex = 3
        Position.RowIndex = 0
        DataBinding.FieldName = 'IN_KR_SUMMA_VAL'
      end
      ...
      object cxGridOUT_DB_SUMMA_VAL: TcxGridDBBandedColumn
        Caption = #1044#1077#1073#1077#1090'('#1074#1072#1083'.)'
        Options.Editing = False
        Options.Filtering = False
        Styles.Content = cxStyle7
        ...
        Position.ColIndex = 1
        Position.RowIndex = 0
        DataBinding.FieldName = 'OUT_DB_SUMMA_VAL'
      end
      ...
      object cxGridOUT_KR_SUMMA_VAL: TcxGridDBBandedColumn
        Caption = #1050#1088#1077#1076#1080#1090'('#1074#1072#1083'.)'
        Options.Editing = False
        Options.Filtering = False
        Styles.Content = cxStyle12
        ...
        Position.ColIndex = 3
        Position.RowIndex = 0
        DataBinding.FieldName = 'OUT_KR_SUMMA_VAL'
      end
      ...
      object cxGridVALUTE: TcxGridDBBandedColumn
        Options.Editing = False
        Options.Filtering = False
        Position.BandIndex = 4
        Position.ColIndex = 0
        Position.RowIndex = 0
        DataBinding.FieldName = 'NAME_VALUTE'
        IsCaptionAssigned = True
      end
    end
  ...
  object DataSetForGrid: TpFIBDataSet
    ...
    SelectSQL.Strings = (
        ...
        'SELECT * FROM PC_TMP_OBOROT_SELECT_VAL_2(:ID_SESSION, :DATE_REG,' +
        ' :ID_REG)')
    ...
    object DataSetForGridDATE_OST_MOOVE: TFIBStringField
      FieldName = 'DATE_OST_MOOVE'
      Size = 10
      EmptyStrToNull = True
    end
    object DataSetForGridDATE_EXEC_DOLG: TFIBStringField
    ...
    object DataSetForGridIN_DB_SUMMA_VAL: TFIBBCDField
      FieldName = 'IN_DB_SUMMA_VAL'
      OnGetText = DataSetForGridIN_DB_SUMMA_VALGetText
      DisplayFormat = ',0.00;-,0.00'
      Size = 2
      RoundByScale = True
    end
    object DataSetForGridIN_KR_SUMMA_VAL: TFIBBCDField
      FieldName = 'IN_KR_SUMMA_VAL'
      OnGetText = DataSetForGridIN_KR_SUMMA_VALGetText
      DisplayFormat = ',0.00;-,0.00'
      Size = 2
      RoundByScale = True
    end
    object DataSetForGridOUT_DB_SUMMA_VAL: TFIBBCDField
      FieldName = 'OUT_DB_SUMMA_VAL'
      OnGetText = DataSetForGridOUT_DB_SUMMA_VALGetText
      DisplayFormat = ',0.00;-,0.00'
      Size = 2
      RoundByScale = True
    end
    object DataSetForGridOUT_KR_SUMMA_VAL: TFIBBCDField
      FieldName = 'OUT_KR_SUMMA_VAL'
      OnGetText = DataSetForGridOUT_KR_SUMMA_VALGetText
      DisplayFormat = ',0.00;-,0.00'
      Size = 2
      RoundByScale = True
    end
    object DataSetForGridDB_SUMMA_VAL: TFIBBCDField
      FieldName = 'DB_SUMMA_VAL'
      OnGetText = DataSetForGridDB_SUMMA_VALGetText
      DisplayFormat = ',0.00;-,0.00'
      Size = 2
      RoundByScale = True
    end
    object DataSetForGridKR_SUMMA_VAL: TFIBBCDField
      FieldName = 'KR_SUMMA_VAL'
      OnGetText = DataSetForGridKR_SUMMA_VALGetText
      DisplayFormat = ',0.00;-,0.00'
      Size = 2
      RoundByScale = True
    end
    object DataSetForGridID_VALUTE: TFIBBCDField
      FieldName = 'ID_VALUTE'
      Size = 0
      RoundByScale = True
    end
    object DataSetForGridNAME_VALUTE: TFIBStringField
      FieldName = 'NAME_VALUTE'
      Size = 10
      EmptyStrToNull = True
    end
    object DataSetForGridDATE_OST: TStringField
      FieldKind = fkCalculated
      FieldName = 'DATE_OST'
      Calculated = True
    end
    object DataSetForGridDATE_EXEC: TStringField
      FieldKind = fkCalculated
      FieldName = 'DATE_EXEC'
      Calculated = True
    end
    ...
    object DataSetForGridSYMBOL: TFIBStringField
      FieldName = 'SYMBOL'
      Size = 5
      EmptyStrToNull = True
    end
    object DataSetForGridFIO_1: TStringField
      FieldKind = fkCalculated
      FieldName = 'FIO_1'
      Size = 100
      Calculated = True
  ...
  object StPr_CloseProv: TpFIBStoredProc
    Database = DatabaseWork
    Transaction = ReadTr
    Left = 580
    Top = 193
  end
  object TR_VAL: TpFIBTransaction
    DefaultDatabase = DatabaseWork
    TimeoutAction = TARollback
    Left = 613
    Top = 193
  end
  object ds_utv: TpFIBDataSet
    Database = DatabaseWork
    Transaction = ReadTr
    SelectSQL.Strings = (
      'select result from pc_dt_is_utv_doc(:date_beg, :date_end)')
    Left = 449
    Top = 126
    poSQLINT64ToBCD = True
    object ds_utvRESULT: TFIBIntegerField
      FieldName = 'RESULT'
    end
  end
  object ds_tmp_valute: TpFIBDataSet
    Database = DatabaseWork
    Transaction = ReadTr
    Left = 476
    Top = 269
