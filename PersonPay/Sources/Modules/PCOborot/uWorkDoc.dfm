object WorkDocForm: TWorkDocForm
  Left = 353
  Top = 225
  Width = 764
  Height = 706
  ...
  object pnlMainPanel: TPanel
    ...
    object pnlDogPanel: TPanel
      ...
      object Grid: TcxGrid
        ...
        object TableView: TcxGridTableView
          ...
          object Summa_Doc_val: TcxGridColumn
            ...
            Properties.UseLeftAlignmentOnEditing = False
            OnGetDisplayText = Summa_Doc_valGetDisplayText
            FooterAlignmentHorz = taRightJustify
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
          end
    ...
    object pnlInfoPanel: TPanel
      ...
      object lblSch1_Label: TLabel
        Left = 71
        Top = 7
        Width = 315
        Height = 13
        AutoSize = False
        Caption = 'lblSch1_Label'
        ParentShowHint = False
        ShowHint = True
      end
      object lbl5: TLabel
      ...
      object lblSch2_Label: TLabel
        Left = 69
        Top = 21
        Width = 315
        Height = 13
        AutoSize = False
        Caption = 'lblSch2_Label'
        ParentShowHint = False
        ShowHint = True
      end
      object lbl10: TLabel
      ...
      object lblKekv_Label: TLabel
        Left = 70
        Top = 91
        Width = 316
        Height = 13
        AutoSize = False
        Caption = 'lblKekv_Label'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
    ...
    object pnlProvPanel: TPanel
      ...
      object ProvGrid: TcxGrid
        ...
        object ProvTableView: TcxGridTableView
          ...
          object Summa_Prov_Val: TcxGridColumn
            Caption = #1057#1091#1084#1072' ('#1074#1072#1083'.)'
            PropertiesClassName = 'TcxCurrencyEditProperties'
            Properties.Alignment.Horz = taRightJustify
            Properties.DisplayFormat = ',0.00;-,0.00'
            Properties.UseLeftAlignmentOnEditing = False
            OnGetDisplayText = Summa_Prov_ValGetDisplayText
            FooterAlignmentHorz = taRightJustify
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
          end
      ...
      object SecGrid: TcxGrid
        ...
        object SecTableView: TcxGridTableView
          ...
          object Summa_Prov_Val1: TcxGridColumn
            Caption = #1057#1091#1084#1072' ('#1074#1072#1083'.)'
            FooterAlignmentHorz = taRightJustify
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
    ...
    object cxKurs: TcxCurrencyEdit
      ...
      Properties.OnEditValueChanged = cxKursPropertiesEditValueChanged
      Style.Color = 16247513
      TabOrder = 8
      OnExit = cxKursExit
    end
    object cxValute: TcxButtonEdit
      Left = 63
      Top = 84
      Width = 79
      Height = 21
      ...
      Properties.OnButtonClick = cxValutePropertiesButtonClick
      Style.Color = 16247513
      TabOrder = 9
      OnExit = cxValuteExit
    end
  ...
  object DataSet: TpFIBDataSet
    Database = DocValForm.DB_MAIN
    Transaction = DocValForm.TR_DB_PROV
    Left = 605
    Top = 23
  ...
  object tmrFlashTimer: TTimer
    Enabled = False
    Interval = 100
    OnTimer = tmrFlashTimerTimer
    Left = 241
    Top = 188
  end
  ...
  object DS_VAL: TpFIBDataSet
    ...
    Transaction = DocValForm.TR_DB_PROV
    SelectSQL.Strings = (
      'Select * from pub_sp_valute  order by valute_title'
      '')
    Left = 518
    Top = 11
    poSQLINT64ToBCD = True
